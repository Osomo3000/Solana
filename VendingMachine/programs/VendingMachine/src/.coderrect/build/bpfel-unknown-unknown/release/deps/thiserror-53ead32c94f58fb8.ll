; ModuleID = 'thiserror.b665962d-cgu.0'
source_filename = "thiserror.b665962d-cgu.0"
target datalayout = "e-m:e-p:64:64-i64:64-n32:64-S128"
target triple = "bpfel"

%"std::ffi::OsStr" = type { %"std::sys::bpf::os_str::Slice" }
%"std::sys::bpf::os_str::Slice" = type { [0 x i8] }
%"std::ffi::OsString" = type { %"std::sys::bpf::os_str::Buf" }
%"std::sys::bpf::os_str::Buf" = type { %"std::vec::Vec<u8>" }
...
define internal { %"std::ffi::OsStr"*, i64 } @"_ZN105_$LT$std..ffi..os_str..OsString$u20$as$u20$core..ops..index..Index$LT$core..ops..range..RangeFull$GT$$GT$5index17hbfaebbe64911fc7cE"(%"std::ffi::OsString"* align 8 dereferenceable(24) %self, %"std::panic::Location"* align 8 dereferenceable(24) %0) unnamed_addr #0 !dbg !5 {
start:
  ...
  %_5 = bitcast %"std::ffi::OsString"* %self to %"std::sys::bpf::os_str::Buf"*, !dbg !85
; call std::sys::bpf::os_str::Buf::as_slice
  %1 = call { %"std::sys::bpf::os_str::Slice"*, i64 } @_ZN3std3sys3bpf6os_str3Buf8as_slice17hd3e98dd0b87e305aE(%"std::sys::bpf::os_str::Buf"* align 8 dereferenceable(24) %_5), !dbg !85
  %_4.0 = extractvalue { %"std::sys::bpf::os_str::Slice"*, i64 } %1, 0, !dbg !85
  %_4.1 = extractvalue { %"std::sys::bpf::os_str::Slice"*, i64 } %1, 1, !dbg !85
  br label %bb1, !dbg !85

bb1:                                              ; preds = %start
; call std::ffi::os_str::OsStr::from_inner
  %2 = call { %"std::ffi::OsStr"*, i64 } @_ZN3std3ffi6os_str5OsStr10from_inner17h3211a025ac0fcc30E(%"std::sys::bpf::os_str::Slice"* nonnull align 1 %_4.0, i64 %_4.1), !dbg !86
...
; Function Attrs: inlinehint nounwind
define internal { %"std::ffi::OsStr"*, i64 } @_ZN3std3ffi6os_str5OsStr10from_inner17h3211a025ac0fcc30E(%"std::sys::bpf::os_str::Slice"* nonnull align 1 %inner.0, i64 %inner.1) unnamed_addr #0 !dbg !88 {
start:
  %inner.dbg.spill = alloca { %"std::sys::bpf::os_str::Slice"*, i64 }, align 8
  %0 = getelementptr inbounds { %"std::sys::bpf::os_str::Slice"*, i64 }, { %"std::sys::bpf::os_str::Slice"*, i64 }* %inner.dbg.spill, i32 0, i32 0
  store %"std::sys::bpf::os_str::Slice"* %inner.0, %"std::sys::bpf::os_str::Slice"** %0, align 8
  %1 = getelementptr inbounds { %"std::sys::bpf::os_str::Slice"*, i64 }, { %"std::sys::bpf::os_str::Slice"*, i64 }* %inner.dbg.spill, i32 0, i32 1
  store i64 %inner.1, i64* %1, align 8
  call void @llvm.dbg.declare(metadata { %"std::sys::bpf::os_str::Slice"*, i64 }* %inner.dbg.spill, metadata !93, metadata !DIExpression()), !dbg !94
  %_2.0 = bitcast %"std::sys::bpf::os_str::Slice"* %inner.0 to %"std::ffi::OsStr"*, !dbg !95
...
; std::sys::bpf::os_str::Buf::as_slice
; Function Attrs: inlinehint nounwind
define internal { %"std::sys::bpf::os_str::Slice"*, i64 } @_ZN3std3sys3bpf6os_str3Buf8as_slice17hd3e98dd0b87e305aE(%"std::sys::bpf::os_str::Buf"* align 8 dereferenceable(24) %self) unnamed_addr #0 !dbg !97 {
start:
  %0 = alloca { %"std::sys::bpf::os_str::Slice"*, i64 }, align 8
  %self.dbg.spill = alloca %"std::sys::bpf::os_str::Buf"*, align 8
  store %"std::sys::bpf::os_str::Buf"* %self, %"std::sys::bpf::os_str::Buf"** %self.dbg.spill, align 8
  call void @llvm.dbg.declare(metadata %"std::sys::bpf::os_str::Buf"** %self.dbg.spill, metadata !103, metadata !DIExpression()), !dbg !104
  %_4 = bitcast %"std::sys::bpf::os_str::Buf"* %self to %"std::vec::Vec<u8>"*, !dbg !105
; call <alloc::vec::Vec<T,A> as core::ops::deref::Deref>::deref
  %1 = call { [0 x i8]*, i64 } @"_ZN72_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..deref..Deref$GT$5deref17hfed99960d6cd2ca2E"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %_4), !dbg !106
  %_3.0 = extractvalue { [0 x i8]*, i64 } %1, 0, !dbg !106
  %_3.1 = extractvalue { [0 x i8]*, i64 } %1, 1, !dbg !106
  br label %bb1, !dbg !106

bb1:                                              ; preds = %start
  %2 = bitcast { %"std::sys::bpf::os_str::Slice"*, i64 }* %0 to { [0 x i8]*, i64 }*, !dbg !107
  ...
  %5 = getelementptr inbounds { %"std::sys::bpf::os_str::Slice"*, i64 }, { %"std::sys::bpf::os_str::Slice"*, i64 }* %0, i32 0, i32 0, !dbg !107
  %6 = load %"std::sys::bpf::os_str::Slice"*, %"std::sys::bpf::os_str::Slice"** %5, align 8, !dbg !107, !nonnull !4
  %7 = getelementptr inbounds { %"std::sys::bpf::os_str::Slice"*, i64 }, { %"std::sys::bpf::os_str::Slice"*, i64 }* %0, i32 0, i32 1, !dbg !107
  %8 = load i64, i64* %7, align 8, !dbg !107
  br label %bb2, !dbg !107

bb2:                                              ; preds = %bb1
  %9 = insertvalue { %"std::sys::bpf::os_str::Slice"*, i64 } undef, %"std::sys::bpf::os_str::Slice"* %6, 0, !dbg !108
  %10 = insertvalue { %"std::sys::bpf::os_str::Slice"*, i64 } %9, i64 %8, 1, !dbg !108
  ret { %"std::sys::bpf::os_str::Slice"*, i64 } %10, !dbg !108
}

; std::path::Path::new
; Function Attrs: nounwind
define { %"std::path::Path"*, i64 } @_ZN3std4path4Path3new17hb2a71fdde00f0078E(%"std::ffi::OsString"* align 8 dereferenceable(24) %s) unnamed_addr #1 !dbg !109 {
start:
...
; call <std::ffi::os_str::OsString as core::convert::AsRef<std::ffi::os_str::OsStr>>::as_ref
  %0 = call { %"std::ffi::OsStr"*, i64 } @"_ZN98_$LT$std..ffi..os_str..OsString$u20$as$u20$core..convert..AsRef$LT$std..ffi..os_str..OsStr$GT$$GT$6as_ref17he70c3cf4042a3760E"(%"std::ffi::OsString"* align 8 dereferenceable(24) %s), !dbg !123
...
; Function Attrs: inlinehint nounwind
define internal { i8*, i64 } @_ZN3std4path4Path7display17h7dac5e9f41a87159E(%"std::path::Path"* nonnull align 1 %self.0, i64 %self.1) unnamed_addr #0 !dbg !126 {
start:
...
; Function Attrs: inlinehint nounwind
define { [0 x i8]*, i64 } @_ZN4core3ptr20slice_from_raw_parts17hf5f66de20845fbf4E(i8* %data, i64 %len) unnamed_addr #0 !dbg !137 {
start:
...
; call core::ptr::const_ptr::<impl *const T>::cast
  %_3 = call {}* @"_ZN4core3ptr9const_ptr33_$LT$impl$u20$$BP$const$u20$T$GT$4cast17h41458bcd5dfbd49aE"(i8* %data), !dbg !150
  br label %bb1, !dbg !150

bb1:                                              ; preds = %start
; call core::ptr::metadata::from_raw_parts
  %0 = call { [0 x i8]*, i64 } @_ZN4core3ptr8metadata14from_raw_parts17h4a52518b7081d5ebE({}* %_3, i64 %len), !dbg !151
...
; Function Attrs: inlinehint nounwind
define i8* @"_ZN4core3ptr6unique15Unique$LT$T$GT$6as_ptr17h701090a2b88e74c1E"(i8* nonnull %self) unnamed_addr #0 !dbg !153 {
start:
...
; Function Attrs: inlinehint nounwind
define zeroext i1 @"_ZN4core3ptr7mut_ptr31_$LT$impl$u20$$BP$mut$u20$T$GT$13guaranteed_eq17hbd7ea37058ce2a2bE"(i8* %self, i8* %other) unnamed_addr #0 !dbg !162 {
start:
  %0 = alloca i8, align 1
...
; Function Attrs: inlinehint nounwind
define zeroext i1 @"_ZN4core3ptr7mut_ptr31_$LT$impl$u20$$BP$mut$u20$T$GT$7is_null17he77f3fbf62e882b2E"(i8* %self) unnamed_addr #0 !dbg !177 {
start:
  %self.dbg.spill = alloca i8*, align 8
  store i8* %self, i8** %self.dbg.spill, align 8
...
; call core::ptr::mut_ptr::<impl *mut T>::guaranteed_eq
  %0 = call zeroext i1 @"_ZN4core3ptr7mut_ptr31_$LT$impl$u20$$BP$mut$u20$T$GT$13guaranteed_eq17hbd7ea37058ce2a2bE"(i8* %self, i8* null), !dbg !184
...
; Function Attrs: inlinehint nounwind
define { [0 x i8]*, i64 } @_ZN4core3ptr8metadata14from_raw_parts17h4a52518b7081d5ebE({}* %data_address, i64 %metadata) unnamed_addr #0 !dbg !186 {
start:
...
; Function Attrs: inlinehint nounwind
define {}* @"_ZN4core3ptr9const_ptr33_$LT$impl$u20$$BP$const$u20$T$GT$4cast17h41458bcd5dfbd49aE"(i8* %self) unnamed_addr #0 !dbg !203 {
start:
  %self.dbg.spill = alloca i8*, align 8
  store i8* %self, i8** %self.dbg.spill, align 8
...
; Function Attrs: inlinehint nounwind
define { [0 x i8]*, i64 } @_ZN4core5slice3raw14from_raw_parts17hff848ff6492abaf0E(i8* %data, i64 %len) unnamed_addr #0 !dbg !216 {
start:
  %len.dbg.spill = alloca i64, align 8
  %data.dbg.spill = alloca i8*, align 8
  store i8* %data, i8** %data.dbg.spill, align 8
...
; call core::ptr::slice_from_raw_parts
  %0 = call { [0 x i8]*, i64 } @_ZN4core3ptr20slice_from_raw_parts17hf5f66de20845fbf4E(i8* %data, i64 %len), !dbg !231
...
; Function Attrs: inlinehint nounwind
define i8* @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$6as_ptr17ha08a32cb78dbb629E"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %self) unnamed_addr #0 !dbg !233 {
start:
...
; call alloc::raw_vec::RawVec<T,A>::ptr
  %ptr = call i8* @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$3ptr17h9e1532ad0217c414E"({ i8*, i64 }* align 8 dereferenceable(16) %_3), !dbg !243
...
; call core::ptr::mut_ptr::<impl *mut T>::is_null
  %_6 = call zeroext i1 @"_ZN4core3ptr7mut_ptr31_$LT$impl$u20$$BP$mut$u20$T$GT$7is_null17he77f3fbf62e882b2E"(i8* %ptr), !dbg !245
...
; Function Attrs: inlinehint nounwind
define i8* @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$3ptr17h9e1532ad0217c414E"({ i8*, i64 }* align 8 dereferenceable(16) %self) unnamed_addr #0 !dbg !249 {
start:
...
; call core::ptr::unique::Unique<T>::as_ptr
  %1 = call i8* @"_ZN4core3ptr6unique15Unique$LT$T$GT$6as_ptr17h701090a2b88e74c1E"(i8* nonnull %_2), !dbg !257
...
; Function Attrs: inlinehint nounwind
define internal { %"std::path::Path"*, i64 } @"_ZN62_$LT$std..path..PathBuf$u20$as$u20$core..ops..deref..Deref$GT$5deref17hc461bbd316f72447E"(%"std::path::PathBuf"* align 8 dereferenceable(24) %self) unnamed_addr #0 !dbg !259 {
start:
...
; call std::path::Path::new
  %0 = call { %"std::path::Path"*, i64 } @_ZN3std4path4Path3new17hb2a71fdde00f0078E(%"std::ffi::OsString"* align 8 dereferenceable(24) %_3), !dbg !271
...
; Function Attrs: inlinehint nounwind
define internal { %"std::ffi::OsStr"*, i64 } @"_ZN70_$LT$std..ffi..os_str..OsString$u20$as$u20$core..ops..deref..Deref$GT$5deref17h9d9c2117a19aecaaE"(%"std::ffi::OsString"* align 8 dereferenceable(24) %self) unnamed_addr #0 !dbg !273 {
start:
  %self.dbg.spill = alloca %"std::ffi::OsString"*, align 8
  store %"std::ffi::OsString"* %self, %"std::ffi::OsString"** %self.dbg.spill, align 8
...
; call <std::ffi::os_str::OsString as core::ops::index::Index<core::ops::range::RangeFull>>::index
  %0 = call { %"std::ffi::OsStr"*, i64 } @"_ZN105_$LT$std..ffi..os_str..OsString$u20$as$u20$core..ops..index..Index$LT$core..ops..range..RangeFull$GT$$GT$5index17hbfaebbe64911fc7cE"(%"std::ffi::OsString"* align 8 dereferenceable(24) %self, %"std::panic::Location"* align 8 dereferenceable(24) bitcast (<{ i8*, [16 x i8] }>* @alloc13 to %"std::panic::Location"*)), !dbg !280
...
; Function Attrs: nounwind
define { [0 x i8]*, i64 } @"_ZN72_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..deref..Deref$GT$5deref17hfed99960d6cd2ca2E"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %self) unnamed_addr #1 !dbg !282 {
start:
  %self.dbg.spill = alloca %"std::vec::Vec<u8>"*, align 8
  store %"std::vec::Vec<u8>"* %self, %"std::vec::Vec<u8>"** %self.dbg.spill, align 8
...
; call alloc::vec::Vec<T,A>::as_ptr
  %_2 = call i8* @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$6as_ptr17ha08a32cb78dbb629E"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %self), !dbg !289
...
; call core::slice::raw::from_raw_parts
  %1 = call { [0 x i8]*, i64 } @_ZN4core5slice3raw14from_raw_parts17hff848ff6492abaf0E(i8* %_2, i64 %_4), !dbg !291
...
; Function Attrs: inlinehint nounwind
define internal { %"std::ffi::OsStr"*, i64 } @"_ZN98_$LT$std..ffi..os_str..OsString$u20$as$u20$core..convert..AsRef$LT$std..ffi..os_str..OsStr$GT$$GT$6as_ref17he70c3cf4042a3760E"(%"std::ffi::OsString"* align 8 dereferenceable(24) %self) unnamed_addr #0 !dbg !293 {
start:
  %self.dbg.spill = alloca %"std::ffi::OsString"*, align 8
  store %"std::ffi::OsString"* %self, %"std::ffi::OsString"** %self.dbg.spill, align 8
...
; call <std::ffi::os_str::OsString as core::ops::deref::Deref>::deref
  %0 = call { %"std::ffi::OsStr"*, i64 } @"_ZN70_$LT$std..ffi..os_str..OsString$u20$as$u20$core..ops..deref..Deref$GT$5deref17h9d9c2117a19aecaaE"(%"std::ffi::OsString"* align 8 dereferenceable(24) %self), !dbg !298
...
; Function Attrs: nounwind
define { i8*, i64 } @"_ZN69_$LT$std..path..Path$u20$as$u20$thiserror..display..PathAsDisplay$GT$10as_display17h05fbfd6cacf38ec6E"(%"std::path::Path"* nonnull align 1 %self.0, i64 %self.1) unnamed_addr #1 !dbg !300 {
start:
  %self.dbg.spill = alloca { %"std::path::Path"*, i64 }, align 8
...
; call std::path::Path::display
  %2 = call { i8*, i64 } @_ZN3std4path4Path7display17h7dac5e9f41a87159E(%"std::path::Path"* nonnull align 1 %self.0, i64 %self.1), !dbg !308
...
; Function Attrs: nounwind
define { i8*, i64 } @"_ZN72_$LT$std..path..PathBuf$u20$as$u20$thiserror..display..PathAsDisplay$GT$10as_display17h27f00d1299c13ea7E"(%"std::path::PathBuf"* align 8 dereferenceable(24) %self) unnamed_addr #1 !dbg !310 {
start:
  %self.dbg.spill = alloca %"std::path::PathBuf"*, align 8
  store %"std::path::PathBuf"* %self, %"std::path::PathBuf"** %self.dbg.spill, align 8
...
; call <std::path::PathBuf as core::ops::deref::Deref>::deref
  %0 = call { %"std::path::Path"*, i64 } @"_ZN62_$LT$std..path..PathBuf$u20$as$u20$core..ops..deref..Deref$GT$5deref17hc461bbd316f72447E"(%"std::path::PathBuf"* align 8 dereferenceable(24) %self), !dbg !317
...
bb1:                                              ; preds = %start
; call std::path::Path::display
  %1 = call { i8*, i64 } @_ZN3std4path4Path7display17h7dac5e9f41a87159E(%"std::path::Path"* nonnull align 1 %_3.0, i64 %_3.1), !dbg !317
...
!3 = !DIFile(filename: "/home/osboxes/.cargo/registry/src/github.com-1ecc6299db9ec823/thiserror-1.0.30/src/lib.rs", directory: "/home/osboxes/.cargo/registry/src/github.com-1ecc6299db9ec823/thiserror-1.0.30")
!4 = !{}
!5 = distinct !DISubprogram(name: "index", linkageName: "_ZN105_$LT$std..ffi..os_str..OsString$u20$as$u20$core..ops..index..Index$LT$core..ops..range..RangeFull$GT$$GT$5index17hbfaebbe64911fc7cE", scope: !7, file: !6, line: 383, type: !11, scopeLine: 383, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !4, retainedNodes: !80)
...
!14 = !DICompositeType(tag: DW_TAG_structure_type, name: "OsStr", scope: !8, file: !15, align: 8, elements: !16, templateParams: !4, identifier: "92f6f09e32337f9dab09d2469962a9d")
!15 = !DIFile(filename: "<unknown>", directory: "")
!16 = !{!17}
!17 = !DIDerivedType(tag: DW_TAG_member, name: "inner", scope: !14, file: !15, baseType: !18, align: 8)
!18 = !DICompositeType(tag: DW_TAG_structure_type, name: "Slice", scope: !19, file: !15, align: 8, elements: !22, templateParams: !4, identifier: "96492475397b07a47eb192982bfb8ac8")
!19 = !DINamespace(name: "os_str", scope: !20)
!20 = !DINamespace(name: "bpf", scope: !21)
...
!29 = !DICompositeType(tag: DW_TAG_structure_type, name: "OsString", scope: !8, file: !15, size: 192, align: 64, elements: !30, templateParams: !4, identifier: "176b8830ec03066d182ed439cce7149c")
!30 = !{!31}
!31 = !DIDerivedType(tag: DW_TAG_member, name: "inner", scope: !29, file: !15, baseType: !32, size: 192, align: 64)
!32 = !DICompositeType(tag: DW_TAG_structure_type, name: "Buf", scope: !19, file: !15, size: 192, align: 64, elements: !33, templateParams: !4, identifier: "75c4a914eec415bcb8426996c1a3a8e8")
!33 = !{!34}
!34 = !DIDerivedType(tag: DW_TAG_member, name: "inner", scope: !32, file: !15, baseType: !35, size: 192, align: 64)
!35 = !DICompositeType(tag: DW_TAG_structure_type, name: "Vec<u8, alloc::alloc::Global>", scope: !36, file: !15, size: 192, align: 64, elements: !38, templateParams: !61, identifier: "544e509f8e0a7b1cb9be9709b6e26fb")
...
!40 = !DICompositeType(tag: DW_TAG_structure_type, name: "RawVec<u8, alloc::alloc::Global>", scope: !41, file: !15, size: 128, align: 64, elements: !42, templateParams: !61, identifier: "5d8bbd1a5ea5acae1c690e544499445a")
...
!59 = !DICompositeType(tag: DW_TAG_structure_type, name: "Global", scope: !60, file: !15, align: 8, elements: !4, templateParams: !4, identifier: "4ea658df9108d173874181de92fdae66")
...
!88 = distinct !DISubprogram(name: "from_inner", linkageName: "_ZN3std3ffi6os_str5OsStr10from_inner17h3211a025ac0fcc30E", scope: !14, file: !6, line: 551, type: !89, scopeLine: 551, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !4, retainedNodes: !92)
...
!97 = distinct !DISubprogram(name: "as_slice", linkageName: "_ZN3std3sys3bpf6os_str3Buf8as_slice17hd3e98dd0b87e305aE", scope: !32, file: !98, line: 131, type: !99, scopeLine: 131, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !4, retainedNodes: !102)
!98 = !DIFile(filename: "/home/runner/work/bpf-tools/bpf-tools/out/rust/library/std/src/sys/bpf/../unix/os_str.rs", directory: "", checksumkind: CSK_MD5, checksum: "34ef55fe74bcd597b300423b558e78ed")
...
!109 = distinct !DISubprogram(name: "new<std::ffi::os_str::OsString>", linkageName: "_ZN3std4path4Path3new17hb2a71fdde00f0078E", scope: !111, file: !110, line: 1867, type: !115, scopeLine: 1867, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !120, retainedNodes: !118)
...
!111 = !DICompositeType(tag: DW_TAG_structure_type, name: "Path", scope: !112, file: !15, align: 8, elements: !113, templateParams: !4, identifier: "b577f386817513f742571a565c242fad")
...
!126 = distinct !DISubprogram(name: "display", linkageName: "_ZN3std4path4Path7display17h7dac5e9f41a87159E", scope: !111, file: !110, line: 2471, type: !127, scopeLine: 2471, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !4, retainedNodes: !132)
!127 = !DISubroutineType(types: !128)
!128 = !{!129, !117}
!129 = !DICompositeType(tag: DW_TAG_structure_type, name: "Display", scope: !112, file: !15, size: 128, align: 64, elements: !130, templateParams: !4, identifier: "90b5cf4bba284c9caa7030185049d3b1")
!130 = !{!131}
...
!137 = distinct !DISubprogram(name: "slice_from_raw_parts<u8>", linkageName: "_ZN4core3ptr20slice_from_raw_parts17hf5f66de20845fbf4E", scope: !46, file: !138, line: 257, type: !139, scopeLine: 257, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !54, retainedNodes: !145)
...
!153 = distinct !DISubprogram(name: "as_ptr<u8>", linkageName: "_ZN4core3ptr6unique15Unique$LT$T$GT$6as_ptr17h701090a2b88e74c1E", scope: !44, file: !154, line: 105, type: !155, scopeLine: 105, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !54, retainedNodes: !158)
...
!162 = distinct !DISubprogram(name: "guaranteed_eq<u8>", linkageName: "_ZN4core3ptr7mut_ptr31_$LT$impl$u20$$BP$mut$u20$T$GT$13guaranteed_eq17hbd7ea37058ce2a2bE", scope: !164, file: !163, line: 433, type: !166, scopeLine: 433, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !54, retainedNodes: !169)
...
!177 = distinct !DISubprogram(name: "is_null<u8>", linkageName: "_ZN4core3ptr7mut_ptr31_$LT$impl$u20$$BP$mut$u20$T$GT$7is_null17he77f3fbf62e882b2E", scope: !164, file: !163, line: 36, type: !178, scopeLine: 36, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !54, retainedNodes: !180)
...
!186 = distinct !DISubprogram(name: "from_raw_parts<[u8]>", linkageName: "_ZN4core3ptr8metadata14from_raw_parts17h4a52518b7081d5ebE", scope: !188, file: !187, line: 110, type: !189, scopeLine: 110, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !196, retainedNodes: !193)
...
!203 = distinct !DISubprogram(name: "cast<u8, ()>", linkageName: "_ZN4core3ptr9const_ptr33_$LT$impl$u20$$BP$const$u20$T$GT$4cast17h41458bcd5dfbd49aE", scope: !205, file: !204, line: 47, type: !207, scopeLine: 47, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !211, retainedNodes: !209)
...
!216 = distinct !DISubprogram(name: "from_raw_parts<u8>", linkageName: "_ZN4core5slice3raw14from_raw_parts17hff848ff6492abaf0E", scope: !218, file: !217, line: 88, type: !220, scopeLine: 88, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !54, retainedNodes: !226)
...
!233 = distinct !DISubprogram(name: "as_ptr<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc3vec16Vec$LT$T$C$A$GT$6as_ptr17ha08a32cb78dbb629E", scope: !35, file: !234, line: 1129, type: !235, scopeLine: 1129, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !61, retainedNodes: !238)
...
!249 = distinct !DISubprogram(name: "ptr<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$3ptr17h9e1532ad0217c414E", scope: !40, file: !250, line: 239, type: !251, scopeLine: 239, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !61, retainedNodes: !254)
...
!259 = distinct !DISubprogram(name: "deref", linkageName: "_ZN62_$LT$std..path..PathBuf$u20$as$u20$core..ops..deref..Deref$GT$5deref17hc461bbd316f72447E", scope: !260, file: !110, line: 1616, type: !261, scopeLine: 1616, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !4, retainedNodes: !267)
...
!264 = !DICompositeType(tag: DW_TAG_structure_type, name: "PathBuf", scope: !112, file: !15, size: 192, align: 64, elements: !265, templateParams: !4, identifier: "666baabd15ac1eb79d2acb11dc0b101a")
!265 = !{!266}
...
!273 = distinct !DISubprogram(name: "deref", linkageName: "_ZN70_$LT$std..ffi..os_str..OsString$u20$as$u20$core..ops..deref..Deref$GT$5deref17h9d9c2117a19aecaaE", scope: !274, file: !6, line: 401, type: !275, scopeLine: 401, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !4, retainedNodes: !277)
...
!293 = distinct !DISubprogram(name: "as_ref", linkageName: "_ZN98_$LT$std..ffi..os_str..OsString$u20$as$u20$core..convert..AsRef$LT$std..ffi..os_str..OsStr$GT$$GT$6as_ref17he70c3cf4042a3760E", scope: !294, file: !6, line: 1151, type: !275, scopeLine: 1151, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !4, retainedNodes: !295)
...
!300 = distinct !DISubprogram(name: "as_display", linkageName: "_ZN69_$LT$std..path..Path$u20$as$u20$thiserror..display..PathAsDisplay$GT$10as_display17h05fbfd6cacf38ec6E", scope: !302, file: !301, line: 19, type: !127, scopeLine: 19, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, templateParams: !4, retainedNodes: !305)
!301 = !DIFile(filename: "/home/osboxes/.cargo/registry/src/github.com-1ecc6299db9ec823/thiserror-1.0.30/src/display.rs", directory: "/home/osboxes/.cargo/registry/src/github.com-1ecc6299db9ec823/thiserror-1.0.30", checksumkind: CSK_MD5, checksum: "adc085f99662fa50187113a5cb19ab0c")
...
!310 = distinct !DISubprogram(name: "as_display", linkageName: "_ZN72_$LT$std..path..PathBuf$u20$as$u20$thiserror..display..PathAsDisplay$GT$10as_display17h27f00d1299c13ea7E", scope: !311, file: !301, line: 25, type: !312, scopeLine: 25, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, templateParams: !4, retainedNodes: !314)
