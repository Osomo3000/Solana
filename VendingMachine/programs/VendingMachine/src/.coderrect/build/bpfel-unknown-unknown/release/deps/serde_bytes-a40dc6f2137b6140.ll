...
define internal { i64, i64 } @"_ZN122_$LT$alloc..collections..TryReserveError$u20$as$u20$core..convert..From$LT$alloc..collections..TryReserveErrorKind$GT$$GT$4from17h13a30f0ef06ff347E"(i64 %kind.0, i64 %kind.1) unnamed_addr #0 !dbg !42 {
start:
...
start:
  ...
  call void @llvm.dbg.declare(metadata { i64, i64 }* %residual, metadata !156, metadata !DIExpression()), !dbg !161
  %5 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %residual, i32 0, i32 0, !dbg !162
  %e.0 = load i64, i64* %5, align 8, !dbg !162
  %6 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %residual, i32 0, i32 1, !dbg !162
  %e.1 = load i64, i64* %6, align 8, !dbg !162
  %7 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %e.dbg.spill, i32 0, i32 0, !dbg !162
  store i64 %e.0, i64* %7, align 8, !dbg !162
  %8 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %e.dbg.spill, i32 0, i32 1, !dbg !162
  store i64 %e.1, i64* %8, align 8, !dbg !162
  call void @llvm.dbg.declare(metadata { i64, i64 }* %e.dbg.spill, metadata !157, metadata !DIExpression()), !dbg !163
; call <alloc::collections::TryReserveError as core::convert::From<alloc::collections::TryReserveErrorKind>>::from
  %9 = call { i64, i64 } @"_ZN122_$LT$alloc..collections..TryReserveError$u20$as$u20$core..convert..From$LT$alloc..collections..TryReserveErrorKind$GT$$GT$4from17h13a30f0ef06ff347E"(i64 %e.0, i64 %e.1), !dbg !164
  %_3.0 = extractvalue { i64, i64 } %9, 0, !dbg !164
  %_3.1 = extractvalue { i64, i64 } %9, 1, !dbg !164
  br label %bb1, !dbg !164

bb1:                                              ; preds = %start
  %10 = bitcast %"std::result::Result<(), std::collections::TryReserveError>"* %0 to %"std::result::Result<(), std::collections::TryReserveError>::Err"*, !dbg !165
  %11 = getelementptr inbounds %"std::result::Result<(), std::collections::TryReserveError>::Err", %"std::result::Result<(), std::collections::TryReserveError>::Err"* %10, i32 0, i32 1, !dbg !165
  %12 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %11, i32 0, i32 0, !dbg !165
  store i64 %_3.0, i64* %12, align 8, !dbg !165
  %13 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %11, i32 0, i32 1, !dbg !165
  store i64 %_3.1, i64* %13, align 8, !dbg !165
  %14 = bitcast %"std::result::Result<(), std::collections::TryReserveError>"* %0 to i64*, !dbg !165
  store i64 1, i64* %14, align 8, !dbg !165
  ret void, !dbg !166
}
...
start:
  %e.dbg.spill = alloca %"std::alloc::LayoutError", align 1
  %residual.dbg.spill = alloca %"std::result::Result<std::convert::Infallible, std::alloc::LayoutError>::Err", align 1
  call void @llvm.dbg.declare(metadata %"std::result::Result<std::convert::Infallible, std::alloc::LayoutError>::Err"* %residual.dbg.spill, metadata !189, metadata !DIExpression()), !dbg !193
  call void @llvm.dbg.declare(metadata %"std::alloc::LayoutError"* %e.dbg.spill, metadata !190, metadata !DIExpression()), !dbg !194
; call <T as core::convert::From<T>>::from
  call void @"_ZN50_$LT$T$u20$as$u20$core..convert..From$LT$T$GT$$GT$4from17he06985843b40aa16E"(), !dbg !195
  br label %bb1, !dbg !195

bb1:                                              ; preds = %start
  %1 = bitcast %"std::result::Result<(std::alloc::Layout, usize), std::alloc::LayoutError>"* %0 to %"std::result::Result<(std::alloc::Layout, usize), std::alloc::LayoutError>::Err"*, !dbg !196
  %2 = bitcast %"std::result::Result<(std::alloc::Layout, usize), std::alloc::LayoutError>::Err"* %1 to %"std::alloc::LayoutError"*, !dbg !196
  %3 = getelementptr inbounds %"std::result::Result<(std::alloc::Layout, usize), std::alloc::LayoutError>", %"std::result::Result<(std::alloc::Layout, usize), std::alloc::LayoutError>"* %0, i32 0, i32 1, !dbg !196
  store i64 0, i64* %3, align 8, !dbg !196
  ret void, !dbg !197
}
...
; core::ptr::read
; Function Attrs: inlinehint nounwind
define { i8*, i64 } @_ZN4core3ptr4read17ha33ca5a2aadea3f9E({ i8*, i64 }* %src) unnamed_addr #0 !dbg !378 {
start:
...
; core::ptr::read
; Function Attrs: inlinehint nounwind
define void @_ZN4core3ptr4read17hffcafd9cac2a9e09E(%"std::alloc::Global"* %src) unnamed_addr #0 !dbg !464 {
start:
...
; call alloc::raw_vec::handle_reserve::{{closure}}
  %17 = call { i64, i64 } @"_ZN5alloc7raw_vec14handle_reserve28_$u7b$$u7b$closure$u7d$$u7d$17h5225469680ddb458E"(i64 %14, i64 %16), !dbg !1233
...
; call alloc::raw_vec::RawVec<T,A>::shrink::{{closure}}
  %18 = call { i64, i64 } @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$6shrink28_$u7b$$u7b$closure$u7d$$u7d$17ha961cf18273ce991E"(i64* align 8 dereferenceable(16) %op), !dbg !1277
...
; Function Attrs: nounwind
define void @"_ZN50_$LT$T$u20$as$u20$core..convert..From$LT$T$GT$$GT$4from17h9a39afee859a6c76E"(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %0, %"std::vec::Vec<u8>"* noalias nocapture dereferenceable(24) %t) unnamed_addr #1 !dbg !1282 {
start:
  call void @llvm.dbg.declare(metadata %"std::vec::Vec<u8>"* %t, metadata !1293, metadata !DIExpression()), !dbg !1296
  %1 = bitcast %"std::vec::Vec<u8>"* %0 to i8*, !dbg !1297
  %2 = bitcast %"std::vec::Vec<u8>"* %t to i8*, !dbg !1297
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %1, i8* align 8 %2, i64 24, i1 false), !dbg !1297
  ret void, !dbg !1298
}

; <T as core::convert::From<T>>::from
; Function Attrs: nounwind
define void @"_ZN50_$LT$T$u20$as$u20$core..convert..From$LT$T$GT$$GT$4from17hd24db5c6eec3db82E"() unnamed_addr #1 !dbg !1299 {
start:
  %t.dbg.spill = alloca %"std::alloc::AllocError", align 1
  call void @llvm.dbg.declare(metadata %"std::alloc::AllocError"* %t.dbg.spill, metadata !1303, metadata !DIExpression()), !dbg !1306
  ret void, !dbg !1307
}

; <T as core::convert::From<T>>::from
; Function Attrs: nounwind
define void @"_ZN50_$LT$T$u20$as$u20$core..convert..From$LT$T$GT$$GT$4from17he06985843b40aa16E"() unnamed_addr #1 !dbg !1308 {
start:
  %t.dbg.spill = alloca %"std::alloc::LayoutError", align 1
  call void @llvm.dbg.declare(metadata %"std::alloc::LayoutError"* %t.dbg.spill, metadata !1312, metadata !DIExpression()), !dbg !1313
  ret void, !dbg !1314
}

; <T as core::convert::Into<U>>::into
; Function Attrs: nounwind
define void @"_ZN50_$LT$T$u20$as$u20$core..convert..Into$LT$U$GT$$GT$4into17h1e403698c40b47adE"(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %0, %"std::vec::Vec<u8>"* noalias nocapture dereferenceable(24) %self) unnamed_addr #1 !dbg !1315 {
start:
...
; call <T as core::convert::From<T>>::from
  call void @"_ZN50_$LT$T$u20$as$u20$core..convert..From$LT$T$GT$$GT$4from17h9a39afee859a6c76E"(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %0, %"std::vec::Vec<u8>"* noalias nocapture dereferenceable(24) %_2), !dbg !1323
...
; <T as core::convert::Into<U>>::into
; Function Attrs: nounwind
define { i64, i64 } @"_ZN50_$LT$T$u20$as$u20$core..convert..Into$LT$U$GT$$GT$4into17h5a422270cc9cb962E"(i64 %self.0, i64 %self.1) unnamed_addr #1 !dbg !1325 {
start:
  %self.dbg.spill = alloca { i64, i64 }, align 8
...
; call <alloc::collections::TryReserveError as core::convert::From<alloc::collections::TryReserveErrorKind>>::from
  %2 = call { i64, i64 } @"_ZN122_$LT$alloc..collections..TryReserveError$u20$as$u20$core..convert..From$LT$alloc..collections..TryReserveErrorKind$GT$$GT$4from17h13a30f0ef06ff347E"(i64 %self.0, i64 %self.1), !dbg !1332
...
; <T as core::convert::Into<U>>::into
; Function Attrs: nounwind
define { %"bytes::Bytes"*, i64 } @"_ZN50_$LT$T$u20$as$u20$core..convert..Into$LT$U$GT$$GT$4into17h96277047e4dd8be5E"([0 x i8]* noalias nonnull align 1 %self.0, i64 %self.1) unnamed_addr #1 !dbg !1334 {
start:
  %self.dbg.spill = alloca { [0 x i8]*, i64 }, align 8
  %0 = getelementptr inbounds { [0 x i8]*, i64 }, { [0 x i8]*, i64 }* %self.dbg.spill, i32 0, i32 0
  store [0 x i8]* %self.0, [0 x i8]** %0, align 8
...
; call serde_bytes::bytes::<impl core::convert::From<alloc::boxed::Box<[u8]>> for alloc::boxed::Box<serde_bytes::bytes::Bytes>>::from
  %2 = call { %"bytes::Bytes"*, i64 } @"_ZN11serde_bytes5bytes145_$LT$impl$u20$core..convert..From$LT$alloc..boxed..Box$LT$$u5b$u8$u5d$$GT$$GT$$u20$for$u20$alloc..boxed..Box$LT$serde_bytes..bytes..Bytes$GT$$GT$4from17hf9b8a7ff9281f9d3E"([0 x i8]* noalias nonnull align 1 %self.0, i64 %self.1), !dbg !1349
...
; <T as core::convert::Into<U>>::into
; Function Attrs: nounwind
define void @"_ZN50_$LT$T$u20$as$u20$core..convert..Into$LT$U$GT$$GT$4into17hd86cd5548db0e1f3E"(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %0, [0 x i8]* nonnull align 1 %self.0, i64 %self.1) unnamed_addr #1 !dbg !1351 {
start:
  %self.dbg.spill = alloca { [0 x i8]*, i64 }, align 8
...
; call <alloc::vec::Vec<T> as core::convert::From<&[T]>>::from
  call void @"_ZN87_$LT$alloc..vec..Vec$LT$T$GT$$u20$as$u20$core..convert..From$LT$$RF$$u5b$T$u5d$$GT$$GT$4from17h4536af5ff42434e3E"(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %0, [0 x i8]* nonnull align 1 %self.0, i64 %self.1), !dbg !1363
...
; Function Attrs: inlinehint nounwind
define void @"_ZN52_$LT$T$u20$as$u20$alloc..slice..hack..ConvertVec$GT$6to_vec17h93636afd59cfe5c0E"(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %v, [0 x i8]* nonnull align 1 %s.0, i64 %s.1) unnamed_addr #0 !dbg !1365 {
start:
...
; call alloc::vec::Vec<T,A>::with_capacity_in
  call void @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$16with_capacity_in17h7cbc81ba001bc760E"(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %v, i64 %s.1), !dbg !1380
...
; call alloc::vec::Vec<T,A>::as_mut_ptr
  %_9 = call i8* @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$10as_mut_ptr17hef8b9e381d6be68aE"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %v), !dbg !1382
...
; call alloc::vec::Vec<T,A>::set_len
  call void @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$7set_len17h5c5e279753daeffaE"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %v, i64 %s.1), !dbg !1383
...
; Function Attrs: inlinehint nounwind
define internal { i64, i64 } @_ZN5alloc11collections15TryReserveError4kind17h542610ee98112c92E({ i64, i64 }* align 8 dereferenceable(16) %self) unnamed_addr #0 !dbg !1385 {
start:
  %self.dbg.spill = alloca { i64, i64 }*, align 8
  store { i64, i64 }* %self, { i64, i64 }** %self.dbg.spill, align 8
...
; call <alloc::collections::TryReserveErrorKind as core::clone::Clone>::clone
  %0 = call { i64, i64 } @"_ZN78_$LT$alloc..collections..TryReserveErrorKind$u20$as$u20$core..clone..Clone$GT$5clone17h9383e4cb9cc74d24E"({ i64, i64 }* align 8 dereferenceable(16) %self), !dbg !1392
...
; Function Attrs: inlinehint nounwind
define void @"_ZN5alloc3vec12Vec$LT$T$GT$13with_capacity17h3eb10f21229156fdE"(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %0, i64 %capacity) unnamed_addr #0 !dbg !1394 {
start:
...
; call alloc::vec::Vec<T,A>::with_capacity_in
  call void @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$16with_capacity_in17h7cbc81ba001bc760E"(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %0, i64 %capacity), !dbg !1401
...
; alloc::vec::Vec<T>::new
; Function Attrs: inlinehint nounwind
define void @"_ZN5alloc3vec12Vec$LT$T$GT$3new17hefe365ed66da8ba5E"(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %0) unnamed_addr #0 !dbg !1403 {
start:
...
; Function Attrs: inlinehint nounwind
define i8* @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$10as_mut_ptr17hef8b9e381d6be68aE"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %self) unnamed_addr #0 !dbg !1408 {
start:
  %ptr.dbg.spill = alloca i8*, align 8
...
; call alloc::raw_vec::RawVec<T,A>::ptr
  %ptr = call i8* @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$3ptr17hf552780662d2e5faE"({ i8*, i64 }* align 8 dereferenceable(16) %_2), !dbg !1417
...
; Function Attrs: nounwind
define void @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$13shrink_to_fit17h55fe6316e478fa83E"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %self) unnamed_addr #1 !dbg !1423 {
start:
  %self.dbg.spill = alloca %"std::vec::Vec<u8>"*, align 8
  store %"std::vec::Vec<u8>"* %self, %"std::vec::Vec<u8>"** %self.dbg.spill, align 8
...
; call alloc::vec::Vec<T,A>::capacity
  %_3 = call i64 @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$8capacity17h63af2cbd5fda959cE"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %self), !dbg !1429
...
; call alloc::raw_vec::RawVec<T,A>::shrink_to_fit
  call void @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$13shrink_to_fit17h0539a9151bb499d6E"({ i8*, i64 }* align 8 dereferenceable(16) %_7, i64 %_8), !dbg !1432
...
; Function Attrs: nounwind
define { [0 x i8]*, i64 } @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$16into_boxed_slice17h807fed230504c601E"(%"std::vec::Vec<u8>"* noalias nocapture dereferenceable(24) %self) unnamed_addr #1 !dbg !1435 {
start:
...
; call alloc::vec::Vec<T,A>::shrink_to_fit
  call void @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$13shrink_to_fit17h55fe6316e478fa83E"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %self), !dbg !1451
...
; call core::ptr::read
  %8 = call { i8*, i64 } @_ZN4core3ptr4read17ha33ca5a2aadea3f9E({ i8*, i64 }* %_8), !dbg !1481
...
; call alloc::vec::Vec<T,A>::len
  %len = call i64 @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$3len17h4ede26e8656e7d6fE"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %11), !dbg !1486
...
; call alloc::raw_vec::RawVec<T,A>::into_box
  %12 = call { [0 x i8]*, i64 } @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8into_box17h20474ec24aa43325E"(i8* nonnull %buf.0, i64 %buf.1, i64 %len), !dbg !1488
...
; call alloc::boxed::Box<[core::mem::maybe_uninit::MaybeUninit<T>],A>::assume_init
  %13 = call { [0 x i8]*, i64 } @"_ZN5alloc5boxed70Box$LT$$u5b$core..mem..maybe_uninit..MaybeUninit$LT$T$GT$$u5d$$C$A$GT$11assume_init17h0d332405f7d44a26E"([0 x i8]* noalias nonnull align 1 %_15.0, i64 %_15.1), !dbg !1488
...
; Function Attrs: inlinehint nounwind
define void @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$16with_capacity_in17h7cbc81ba001bc760E"(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %0, i64 %capacity) unnamed_addr #0 !dbg !1490 {
start:
...
; call alloc::raw_vec::RawVec<T,A>::with_capacity_in
  %1 = call { i8*, i64 } @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$16with_capacity_in17h056650fc96f1c7d8E"(i64 %capacity), !dbg !1498
...
; Function Attrs: inlinehint nounwind
define i64 @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$3len17h4ede26e8656e7d6fE"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %self) unnamed_addr #0 !dbg !1501 {
start:
  %self.dbg.spill = alloca %"std::vec::Vec<u8>"*, align 8
  store %"std::vec::Vec<u8>"* %self, %"std::vec::Vec<u8>"** %self.dbg.spill, align 8
...
; Function Attrs: inlinehint nounwind
define void @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$7set_len17h5c5e279753daeffaE"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %self, i64 %new_len) unnamed_addr #0 !dbg !1509 {
start:
...
; Function Attrs: inlinehint nounwind
define i64 @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$8capacity17h63af2cbd5fda959cE"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %self) unnamed_addr #0 !dbg !1519 {
start:
  %self.dbg.spill.i = alloca { i8*, i64 }*, align 8
  %0 = alloca i64, align 8
  %self.dbg.spill = alloca %"std::vec::Vec<u8>"*, align 8
...
; Function Attrs: inlinehint nounwind
define nonnull align 1 %"std::alloc::Global"* @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$9allocator17h745e0b6277b12a05E"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %self) unnamed_addr #0 !dbg !1536 {
start:
  %self.dbg.spill = alloca %"std::vec::Vec<u8>"*, align 8
  store %"std::vec::Vec<u8>"* %self, %"std::vec::Vec<u8>"** %self.dbg.spill, align 8
...
; call alloc::raw_vec::RawVec<T,A>::allocator
  %0 = call nonnull align 1 %"std::alloc::Global"* @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$9allocator17h4fcc1fc7fad1adefE"({ i8*, i64 }* align 8 dereferenceable(16) %_2), !dbg !1543
...
; Function Attrs: inlinehint nounwind
define internal i8* @_ZN5alloc5alloc12alloc_zeroed17h163c07586afe7e6cE(i64 %0, i64 %1) unnamed_addr #0 !dbg !1545 {
start:
  %layout = alloca { i64, i64 }, align 8
...
; alloc::alloc::alloc
; Function Attrs: inlinehint nounwind
define internal i8* @_ZN5alloc5alloc5alloc17h531f34b4e51c75acE(i64 %0, i64 %1) unnamed_addr #0 !dbg !1556 {
start:
  %layout = alloca { i64, i64 }, align 8
  %2 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %layout, i32 0, i32 0
  store i64 %0, i64* %2, align 8
...
; Function Attrs: inlinehint nounwind
define internal { i8*, i64 } @_ZN5alloc5alloc6Global10alloc_impl17h37506d444022bee7E(%"std::alloc::Global"* nonnull align 1 %self, i64 %0, i64 %1, i1 zeroext %zeroed) unnamed_addr #0 !dbg !1564 {
start:
  %ptr.dbg.spill = alloca i8*, align 8
...
; call alloc::alloc::alloc
  %9 = call i8* @_ZN5alloc5alloc5alloc17h531f34b4e51c75acE(i64 %_13.0, i64 %_13.1), !dbg !1593
...
; call alloc::alloc::alloc_zeroed
  %12 = call i8* @_ZN5alloc5alloc12alloc_zeroed17h163c07586afe7e6cE(i64 %_12.0, i64 %_12.1), !dbg !1595
...
; alloc::alloc::dealloc
; Function Attrs: inlinehint nounwind
define internal void @_ZN5alloc5alloc7dealloc17heb496285ea544346E(i8* %ptr, i64 %0, i64 %1) unnamed_addr #0 !dbg !1609 {
start:
  %ptr.dbg.spill = alloca i8*, align 8
  %layout = alloca { i64, i64 }, align 8
  %2 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %layout, i32 0, i32 0
...
; alloc::alloc::realloc
; Function Attrs: inlinehint nounwind
define internal i8* @_ZN5alloc5alloc7realloc17hc9bea0e8ca0e73beE(i8* %ptr, i64 %0, i64 %1, i64 %new_size) unnamed_addr #0 !dbg !1621 {
start:
  %new_size.dbg.spill = alloca i64, align 8
  %ptr.dbg.spill = alloca i8*, align 8
  %layout = alloca { i64, i64 }, align 8
...
; Function Attrs: inlinehint nounwind
define { %"bytes::Bytes"*, i64 } @"_ZN5alloc5boxed12Box$LT$T$GT$8from_raw17hdc50017ec18538c1E"(%"bytes::Bytes"* %raw.0, i64 %raw.1) unnamed_addr #0 !dbg !1635 {
start:
...
; call alloc::boxed::Box<T,A>::from_raw_in
  %2 = call { %"bytes::Bytes"*, i64 } @"_ZN5alloc5boxed16Box$LT$T$C$A$GT$11from_raw_in17heb47f329e2acedd5E"(%"bytes::Bytes"* %raw.0, i64 %raw.1), !dbg !1644
...
; Function Attrs: inlinehint nounwind
define { [0 x i8]*, i64 } @"_ZN5alloc5boxed16Box$LT$T$C$A$GT$11from_raw_in17h221854dc1830fb58E"([0 x i8]* %raw.0, i64 %raw.1) unnamed_addr #0 !dbg !1646 {
start:
  %alloc.dbg.spill = alloca %"std::alloc::Global", align 1
...
; call core::ptr::unique::Unique<T>::new_unchecked
  %3 = call { i8*, i64 } @"_ZN4core3ptr6unique15Unique$LT$T$GT$13new_unchecked17h2b507e704cf27becE"([0 x i8]* %raw.0, i64 %raw.1), !dbg !1660
...
; alloc::boxed::Box<T,A>::from_raw_in
; Function Attrs: inlinehint nounwind
define { [0 x i8]*, i64 } @"_ZN5alloc5boxed16Box$LT$T$C$A$GT$11from_raw_in17h71f94a77aa3cf878E"([0 x i8]* %raw.0, i64 %raw.1) unnamed_addr #0 !dbg !1663 {
start:
  %alloc.dbg.spill = alloca %"std::alloc::Global", align 1
  %raw.dbg.spill = alloca { [0 x i8]*, i64 }, align 8
  %0 = alloca { [0 x i8]*, i64 }, align 8
  ...
  %2 = getelementptr inbounds { [0 x i8]*, i64 }, { [0 x i8]*, i64 }* %raw.dbg.spill, i32 0, i32 1
  store i64 %raw.1, i64* %2, align 8
  call void @llvm.dbg.declare(metadata { [0 x i8]*, i64 }* %raw.dbg.spill, metadata !1667, metadata !DIExpression()), !dbg !1669
  call void @llvm.dbg.declare(metadata %"std::alloc::Global"* %alloc.dbg.spill, metadata !1668, metadata !DIExpression()), !dbg !1670
; call core::ptr::unique::Unique<T>::new_unchecked
  %3 = call { i8*, i64 } @"_ZN4core3ptr6unique15Unique$LT$T$GT$13new_unchecked17heb026d9dcfda23d0E"([0 x i8]* %raw.0, i64 %raw.1), !dbg !1671
  %_3.0 = extractvalue { i8*, i64 } %3, 0, !dbg !1671
  %_3.1 = extractvalue { i8*, i64 } %3, 1, !dbg !1671
  br label %bb1, !dbg !1671

bb1:                                              ; preds = %start
  %4 = bitcast { [0 x i8]*, i64 }* %0 to { i8*, i64 }*, !dbg !1672
  %5 = getelementptr inbounds { i8*, i64 }, { i8*, i64 }* %4, i32 0, i32 0, !dbg !1672
  store i8* %_3.0, i8** %5, align 8, !dbg !1672
  %6 = getelementptr inbounds { i8*, i64 }, { i8*, i64 }* %4, i32 0, i32 1, !dbg !1672
  store i64 %_3.1, i64* %6, align 8, !dbg !1672
  %7 = bitcast { [0 x i8]*, i64 }* %0 to %"std::alloc::Global"*, !dbg !1672
  %8 = getelementptr inbounds { [0 x i8]*, i64 }, { [0 x i8]*, i64 }* %0, i32 0, i32 0, !dbg !1673
  %9 = load [0 x i8]*, [0 x i8]** %8, align 8, !dbg !1673, !nonnull !4
  %10 = getelementptr inbounds { [0 x i8]*, i64 }, { [0 x i8]*, i64 }* %0, i32 0, i32 1, !dbg !1673
  %11 = load i64, i64* %10, align 8, !dbg !1673
  %12 = insertvalue { [0 x i8]*, i64 } undef, [0 x i8]* %9, 0, !dbg !1673
  %13 = insertvalue { [0 x i8]*, i64 } %12, i64 %11, 1, !dbg !1673
  ret { [0 x i8]*, i64 } %13, !dbg !1673
}

; alloc::boxed::Box<T,A>::from_raw_in
; Function Attrs: inlinehint nounwind
define { %"bytes::Bytes"*, i64 } @"_ZN5alloc5boxed16Box$LT$T$C$A$GT$11from_raw_in17heb47f329e2acedd5E"(%"bytes::Bytes"* %raw.0, i64 %raw.1) unnamed_addr #0 !dbg !1674 {
start:
  %alloc.dbg.spill = alloca %"std::alloc::Global", align 1
  %raw.dbg.spill = alloca { %"bytes::Bytes"*, i64 }, align 8
  ...
  store i64 %raw.1, i64* %2, align 8
  call void @llvm.dbg.declare(metadata { %"bytes::Bytes"*, i64 }* %raw.dbg.spill, metadata !1678, metadata !DIExpression()), !dbg !1681
  call void @llvm.dbg.declare(metadata %"std::alloc::Global"* %alloc.dbg.spill, metadata !1679, metadata !DIExpression()), !dbg !1682
; call core::ptr::unique::Unique<T>::new_unchecked
  %3 = call { i8*, i64 } @"_ZN4core3ptr6unique15Unique$LT$T$GT$13new_unchecked17ha6da3d90511a045bE"(%"bytes::Bytes"* %raw.0, i64 %raw.1), !dbg !1683
  %_3.0 = extractvalue { i8*, i64 } %3, 0, !dbg !1683
  %_3.1 = extractvalue { i8*, i64 } %3, 1, !dbg !1683
  br label %bb1, !dbg !1683

bb1:                                              ; preds = %start
  %4 = bitcast { %"bytes::Bytes"*, i64 }* %0 to { i8*, i64 }*, !dbg !1684
  ...
  %7 = bitcast { %"bytes::Bytes"*, i64 }* %0 to %"std::alloc::Global"*, !dbg !1684
  %8 = getelementptr inbounds { %"bytes::Bytes"*, i64 }, { %"bytes::Bytes"*, i64 }* %0, i32 0, i32 0, !dbg !1685
  %9 = load %"bytes::Bytes"*, %"bytes::Bytes"** %8, align 8, !dbg !1685, !nonnull !4
  %10 = getelementptr inbounds { %"bytes::Bytes"*, i64 }, { %"bytes::Bytes"*, i64 }* %0, i32 0, i32 1, !dbg !1685
  %11 = load i64, i64* %10, align 8, !dbg !1685
  %12 = insertvalue { %"bytes::Bytes"*, i64 } undef, %"bytes::Bytes"* %9, 0, !dbg !1685
  %13 = insertvalue { %"bytes::Bytes"*, i64 } %12, i64 %11, 1, !dbg !1685
  ret { %"bytes::Bytes"*, i64 } %13, !dbg !1685
}

; alloc::boxed::Box<T,A>::into_unique
; Function Attrs: inlinehint nounwind
define { i8*, i64 } @"_ZN5alloc5boxed16Box$LT$T$C$A$GT$11into_unique17h2b57dcad8b053316E"([0 x i8]* noalias nonnull align 1 %0, i64 %1) unnamed_addr #0 !dbg !1686 {
start:
  %alloc.dbg.spill = alloca %"std::alloc::Global", align 1
  %2 = alloca { i8*, i64 }, align 8
...
; call core::ptr::read
  call void @_ZN4core3ptr4read17hffcafd9cac2a9e09E(%"std::alloc::Global"* %_4), !dbg !1700
...
; call alloc::boxed::Box<T,A>::leak
  %7 = call { [0 x i8]*, i64 } @"_ZN5alloc5boxed16Box$LT$T$C$A$GT$4leak17h501aa30dfdbb7e1eE"([0 x i8]* noalias nonnull align 1 %_7.0, i64 %_7.1), !dbg !1702
...
; alloc::boxed::Box<T,A>::into_unique
; Function Attrs: inlinehint nounwind
define { i8*, i64 } @"_ZN5alloc5boxed16Box$LT$T$C$A$GT$11into_unique17h4d1f1013a2c139d0E"([0 x i8]* noalias nonnull align 1 %0, i64 %1) unnamed_addr #0 !dbg !1706 {
start:
  %alloc.dbg.spill = alloca %"std::alloc::Global", align 1
  %2 = alloca { i8*, i64 }, align 8
  %b = alloca { [0 x i8]*, i64 }, align 8
...
; call core::ptr::read
  call void @_ZN4core3ptr4read17hffcafd9cac2a9e09E(%"std::alloc::Global"* %_4), !dbg !1720
...
; call alloc::boxed::Box<T,A>::leak
  %7 = call { [0 x i8]*, i64 } @"_ZN5alloc5boxed16Box$LT$T$C$A$GT$4leak17h217d1dddeda8cd9fE"([0 x i8]* noalias nonnull align 1 %_7.0, i64 %_7.1), !dbg !1722
...
; Function Attrs: inlinehint nounwind
define { i8*, i64 } @"_ZN5alloc5boxed16Box$LT$T$C$A$GT$23into_raw_with_allocator17h76f1215e63fb11d6E"([0 x i8]* noalias nonnull align 1 %b.0, i64 %b.1) unnamed_addr #0 !dbg !1726 {
start:
...
; call alloc::boxed::Box<T,A>::into_unique
  %3 = call { i8*, i64 } @"_ZN5alloc5boxed16Box$LT$T$C$A$GT$11into_unique17h2b57dcad8b053316E"([0 x i8]* noalias nonnull align 1 %b.0, i64 %b.1), !dbg !1740
...
; call core::ptr::unique::Unique<T>::as_ptr
  %6 = call { [0 x i8]*, i64 } @"_ZN4core3ptr6unique15Unique$LT$T$GT$6as_ptr17h1462c21755637065E"(i8* nonnull %_4.0, i64 %_4.1), !dbg !1743
...
; alloc::boxed::Box<T,A>::into_raw_with_allocator
; Function Attrs: inlinehint nounwind
define { i8*, i64 } @"_ZN5alloc5boxed16Box$LT$T$C$A$GT$23into_raw_with_allocator17haed076f07206abe5E"([0 x i8]* noalias nonnull align 1 %b.0, i64 %b.1) unnamed_addr #0 !dbg !1746 {
start:
  %leaked.dbg.spill = alloca { i8*, i64 }, align 8
  %alloc.dbg.spill = alloca %"std::alloc::Global", align 1
  %b.dbg.spill = alloca { [0 x i8]*, i64 }, align 8
...
; call alloc::boxed::Box<T,A>::into_unique
  %3 = call { i8*, i64 } @"_ZN5alloc5boxed16Box$LT$T$C$A$GT$11into_unique17h4d1f1013a2c139d0E"([0 x i8]* noalias nonnull align 1 %b.0, i64 %b.1), !dbg !1760
...
; call core::ptr::unique::Unique<T>::as_ptr
  %6 = call { [0 x i8]*, i64 } @"_ZN4core3ptr6unique15Unique$LT$T$GT$6as_ptr17hbd873807706205deE"(i8* nonnull %_4.0, i64 %_4.1), !dbg !1763
...
; Function Attrs: inlinehint nounwind
define { [0 x i8]*, i64 } @"_ZN5alloc5boxed16Box$LT$T$C$A$GT$4leak17h217d1dddeda8cd9fE"([0 x i8]* noalias nonnull align 1 %b.0, i64 %b.1) unnamed_addr #0 !dbg !1766 {
start:
  %self.dbg.spill.i = alloca { i8*, i64 }*, align 8
  ...
  call void @llvm.dbg.declare(metadata { [0 x i8]*, i64 }* %value.dbg.spill.i, metadata !1776, metadata !DIExpression()), !dbg !1786
  %5 = bitcast { i8*, i64 }* %0 to { [0 x i8]*, i64 }*, !dbg !1788
  %6 = getelementptr inbounds { [0 x i8]*, i64 }, { [0 x i8]*, i64 }* %5, i32 0, i32 0, !dbg !1788
  store [0 x i8]* %b.0, [0 x i8]** %6, align 8, !dbg !1788, !noalias !1772
  %7 = getelementptr inbounds { [0 x i8]*, i64 }, { [0 x i8]*, i64 }* %5, i32 0, i32 1, !dbg !1788
  store i64 %b.1, i64* %7, align 8, !dbg !1788, !noalias !1772
  %8 = getelementptr inbounds { i8*, i64 }, { i8*, i64 }* %0, i32 0, i32 0, !dbg !1789
  %9 = load i8*, i8** %8, align 8, !dbg !1789, !noalias !1772, !nonnull !4
  %10 = getelementptr inbounds { i8*, i64 }, { i8*, i64 }* %0, i32 0, i32 1, !dbg !1789
  %11 = load i64, i64* %10, align 8, !dbg !1789, !noalias !1772
  %12 = insertvalue { i8*, i64 } undef, i8* %9, 0, !dbg !1789
  %13 = insertvalue { i8*, i64 } %12, i64 %11, 1, !dbg !1789
  store { i8*, i64 } %13, { i8*, i64 }* %_9, align 8, !dbg !1775
  br label %bb1, !dbg !1775

bb1:                                              ; preds = %start
  store { i8*, i64 }* %_9, { i8*, i64 }** %self.dbg.spill.i, align 8
  call void @llvm.dbg.declare(metadata { i8*, i64 }** %self.dbg.spill.i, metadata !1790, metadata !DIExpression()), !dbg !1797
  %14 = bitcast { i8*, i64 }* %_9 to { [0 x i8]*, i64 }*, !dbg !1799
...
; call core::ptr::unique::Unique<T>::as_ptr
  %18 = call { [0 x i8]*, i64 } @"_ZN4core3ptr6unique15Unique$LT$T$GT$6as_ptr17hbd873807706205deE"(i8* nonnull %_6.0, i64 %_6.1), !dbg !1775
  %_5.0 = extractvalue { [0 x i8]*, i64 } %18, 0, !dbg !1775
  %_5.1 = extractvalue { [0 x i8]*, i64 } %18, 1, !dbg !1775
  br label %bb3, !dbg !1775

bb3:                                              ; preds = %bb2
  %19 = insertvalue { [0 x i8]*, i64 } undef, [0 x i8]* %_5.0, 0, !dbg !1800
  %20 = insertvalue { [0 x i8]*, i64 } %19, i64 %_5.1, 1, !dbg !1800
  ret { [0 x i8]*, i64 } %20, !dbg !1800
}

; alloc::boxed::Box<T,A>::leak
; Function Attrs: inlinehint nounwind
define { [0 x i8]*, i64 } @"_ZN5alloc5boxed16Box$LT$T$C$A$GT$4leak17h501aa30dfdbb7e1eE"([0 x i8]* noalias nonnull align 1 %b.0, i64 %b.1) unnamed_addr #0 !dbg !1801 {
start:
  %self.dbg.spill.i = alloca { i8*, i64 }*, align 8
  %value.dbg.spill.i = alloca { [0 x i8]*, i64 }, align 8
  %0 = alloca { i8*, i64 }, align 8
  ...
  %2 = getelementptr inbounds { [0 x i8]*, i64 }, { [0 x i8]*, i64 }* %b.dbg.spill, i32 0, i32 1
  store i64 %b.1, i64* %2, align 8
  call void @llvm.dbg.declare(metadata { [0 x i8]*, i64 }* %b.dbg.spill, metadata !1805, metadata !DIExpression()), !dbg !1806
  call void @llvm.experimental.noalias.scope.decl(metadata !1807), !dbg !1810
  %3 = getelementptr inbounds { [0 x i8]*, i64 }, { [0 x i8]*, i64 }* %value.dbg.spill.i, i32 0, i32 0
  store [0 x i8]* %b.0, [0 x i8]** %3, align 8, !noalias !1807
  %4 = getelementptr inbounds { [0 x i8]*, i64 }, { [0 x i8]*, i64 }* %value.dbg.spill.i, i32 0, i32 1
  store i64 %b.1, i64* %4, align 8, !noalias !1807
  call void @llvm.dbg.declare(metadata { [0 x i8]*, i64 }* %value.dbg.spill.i, metadata !1811, metadata !DIExpression()), !dbg !1820
  %5 = bitcast { i8*, i64 }* %0 to { [0 x i8]*, i64 }*, !dbg !1822
  %6 = getelementptr inbounds { [0 x i8]*, i64 }, { [0 x i8]*, i64 }* %5, i32 0, i32 0, !dbg !1822
  store [0 x i8]* %b.0, [0 x i8]** %6, align 8, !dbg !1822, !noalias !1807
  %7 = getelementptr inbounds { [0 x i8]*, i64 }, { [0 x i8]*, i64 }* %5, i32 0, i32 1, !dbg !1822
  store i64 %b.1, i64* %7, align 8, !dbg !1822, !noalias !1807
  %8 = getelementptr inbounds { i8*, i64 }, { i8*, i64 }* %0, i32 0, i32 0, !dbg !1823
  %9 = load i8*, i8** %8, align 8, !dbg !1823, !noalias !1807, !nonnull !4
  %10 = getelementptr inbounds { i8*, i64 }, { i8*, i64 }* %0, i32 0, i32 1, !dbg !1823
  %11 = load i64, i64* %10, align 8, !dbg !1823, !noalias !1807
  %12 = insertvalue { i8*, i64 } undef, i8* %9, 0, !dbg !1823
  %13 = insertvalue { i8*, i64 } %12, i64 %11, 1, !dbg !1823
  store { i8*, i64 } %13, { i8*, i64 }* %_9, align 8, !dbg !1810
...
bb1:                                              ; preds = %start
  ...
  br label %bb2, !dbg !1810

bb2:                                              ; preds = %bb1
  %15 = bitcast { [0 x i8]*, i64 }* %14 to { i8*, i64 }*, !dbg !1810
  %16 = getelementptr inbounds { i8*, i64 }, { i8*, i64 }* %15, i32 0, i32 0, !dbg !1810
  %_6.0 = load i8*, i8** %16, align 8, !dbg !1810, !nonnull !4
  %17 = getelementptr inbounds { i8*, i64 }, { i8*, i64 }* %15, i32 0, i32 1, !dbg !1810
  %_6.1 = load i64, i64* %17, align 8, !dbg !1810
; call core::ptr::unique::Unique<T>::as_ptr
  %18 = call { [0 x i8]*, i64 } @"_ZN4core3ptr6unique15Unique$LT$T$GT$6as_ptr17h1462c21755637065E"(i8* nonnull %_6.0, i64 %_6.1), !dbg !1810
  %_5.0 = extractvalue { [0 x i8]*, i64 } %18, 0, !dbg !1810
  %_5.1 = extractvalue { [0 x i8]*, i64 } %18, 1, !dbg !1810
  br label %bb3, !dbg !1810
...
; Function Attrs: inlinehint nounwind
define { [0 x i8]*, i64 } @"_ZN5alloc5boxed16Box$LT$T$C$A$GT$8into_raw17hdb3319f8adb27c3eE"([0 x i8]* noalias nonnull align 1 %b.0, i64 %b.1) unnamed_addr #0 !dbg !1835 {
start:
  %b.dbg.spill = alloca { [0 x i8]*, i64 }, align 8
...
; call alloc::boxed::Box<T,A>::into_raw_with_allocator
  %2 = call { i8*, i64 } @"_ZN5alloc5boxed16Box$LT$T$C$A$GT$23into_raw_with_allocator17h76f1215e63fb11d6E"([0 x i8]* noalias nonnull align 1 %b.0, i64 %b.1), !dbg !1841
...
; Function Attrs: inlinehint nounwind
define { [0 x i8]*, i64 } @"_ZN5alloc5boxed70Box$LT$$u5b$core..mem..maybe_uninit..MaybeUninit$LT$T$GT$$u5d$$C$A$GT$11assume_init17h0d332405f7d44a26E"([0 x i8]* noalias nonnull align 1 %self.0, i64 %self.1) unnamed_addr #0 !dbg !1844 {
start:
  %raw.dbg.spill = alloca { [0 x i8]*, i64 }, align 8
  %alloc.dbg.spill = alloca %"std::alloc::Global", align 1
  %self.dbg.spill = alloca { [0 x i8]*, i64 }, align 8
...
; call alloc::boxed::Box<T,A>::into_raw_with_allocator
  %2 = call { i8*, i64 } @"_ZN5alloc5boxed16Box$LT$T$C$A$GT$23into_raw_with_allocator17haed076f07206abe5E"([0 x i8]* noalias nonnull align 1 %self.0, i64 %self.1), !dbg !1855
...
; call alloc::boxed::Box<T,A>::from_raw_in
  %5 = call { [0 x i8]*, i64 } @"_ZN5alloc5boxed16Box$LT$T$C$A$GT$11from_raw_in17h71f94a77aa3cf878E"([0 x i8]* %raw.0, i64 %_4.1), !dbg !1858
...
; Function Attrs: inlinehint nounwind
define void @"_ZN5alloc5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$6to_vec17he16d27598cce6e04E"(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %0, [0 x i8]* nonnull align 1 %self.0, i64 %self.1) unnamed_addr #0 !dbg !1860 {
start:
  %self.dbg.spill = alloca { [0 x i8]*, i64 }, align 8
  %1 = getelementptr inbounds { [0 x i8]*, i64 }, { [0 x i8]*, i64 }* %self.dbg.spill, i32 0, i32 0
  store [0 x i8]* %self.0, [0 x i8]** %1, align 8
...
; call alloc::slice::<impl [T]>::to_vec_in
  call void @"_ZN5alloc5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$9to_vec_in17h993bf30210d38008E"(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %0, [0 x i8]* nonnull align 1 %self.0, i64 %self.1), !dbg !1865
...
; Function Attrs: inlinehint nounwind
define void @"_ZN5alloc5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$9to_vec_in17h993bf30210d38008E"(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %0, [0 x i8]* nonnull align 1 %self.0, i64 %self.1) unnamed_addr #0 !dbg !1867 {
start:
  %alloc.dbg.spill = alloca %"std::alloc::Global", align 1
  %self.dbg.spill = alloca { [0 x i8]*, i64 }, align 8
  %1 = getelementptr inbounds { [0 x i8]*, i64 }, { [0 x i8]*, i64 }* %self.dbg.spill, i32 0, i32 0
...
; call alloc::slice::hack::to_vec
  call void @_ZN5alloc5slice4hack6to_vec17hbe00f9b67875a45fE(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %0, [0 x i8]* nonnull align 1 %self.0, i64 %self.1), !dbg !1873
...
; Function Attrs: inlinehint nounwind
define void @_ZN5alloc5slice4hack6to_vec17hbe00f9b67875a45fE(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %0, [0 x i8]* nonnull align 1 %s.0, i64 %s.1) unnamed_addr #0 !dbg !1875 {
start:
  %alloc.dbg.spill = alloca %"std::alloc::Global", align 1
...
; call <T as alloc::slice::hack::ConvertVec>::to_vec
  call void @"_ZN52_$LT$T$u20$as$u20$alloc..slice..hack..ConvertVec$GT$6to_vec17h93636afd59cfe5c0E"(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %0, [0 x i8]* nonnull align 1 %s.0, i64 %s.1), !dbg !1881
...
; Function Attrs: inlinehint nounwind
define internal void @_ZN5alloc7raw_vec11alloc_guard17hf3b3afcf1bd07e96E(%"std::result::Result<(), std::collections::TryReserveError>"* noalias nocapture sret(%"std::result::Result<(), std::collections::TryReserveError>") dereferenceable(24) %0, i64 %alloc_size) unnamed_addr #0 !dbg !1883 {
start:
  %alloc_size.dbg.spill = alloca i64, align 8
...
; call <T as core::convert::Into<U>>::into
  %7 = call { i64, i64 } @"_ZN50_$LT$T$u20$as$u20$core..convert..Into$LT$U$GT$$GT$4into17h5a422270cc9cb962E"(i64 %4, i64 %6), !dbg !1892
...
; Function Attrs: inlinehint nounwind
define internal void @_ZN5alloc7raw_vec14handle_reserve17h72b1ffa6ce4371dcE(%"std::result::Result<(), std::collections::TryReserveError>"* noalias nocapture dereferenceable(24) %result) unnamed_addr #0 !dbg !1895 {
start:
...
; call alloc::raw_vec::capacity_overflow
  call void @_ZN5alloc7raw_vec17capacity_overflow17he8700ca29a42fb1cE(), !dbg !1906
...
; call alloc::alloc::handle_alloc_error
  call void @_ZN5alloc5alloc18handle_alloc_error17hba238f19242600cdE(i64 %layout.0, i64 %layout.1), !dbg !1909
  unreachable, !dbg !1909
}

; alloc::raw_vec::handle_reserve::{{closure}}
; Function Attrs: inlinehint nounwind
define { i64, i64 } @"_ZN5alloc7raw_vec14handle_reserve28_$u7b$$u7b$closure$u7d$$u7d$17h5225469680ddb458E"(i64 %0, i64 %1) unnamed_addr #0 !dbg !1910 {
start:
...
; call alloc::collections::TryReserveError::kind
  %4 = call { i64, i64 } @_ZN5alloc11collections15TryReserveError4kind17h542610ee98112c92E({ i64, i64 }* align 8 dereferenceable(16) %e), !dbg !1918
...
; Function Attrs: nounwind
define { i8*, i64 } @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$11allocate_in17h18cc795a475c4153E"(i64 %capacity, i1 zeroext %0) unnamed_addr #1 !dbg !1920 {
start:
...
; call alloc::raw_vec::RawVec<T,A>::new_in
  %4 = call { i8*, i64 } @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$6new_in17h80e1e20a4fb8b053E"(), !dbg !1943
...
bb6:                                              ; preds = %bb5
; call alloc::raw_vec::capacity_overflow
  call void @_ZN5alloc7raw_vec17capacity_overflow17he8700ca29a42fb1cE(), !dbg !1950
  unreachable, !dbg !1950

bb9:                                              ; preds = %bb8
; call alloc::raw_vec::alloc_guard
  call void @_ZN5alloc7raw_vec11alloc_guard17hf3b3afcf1bd07e96E(%"std::result::Result<(), std::collections::TryReserveError>"* noalias nocapture sret(%"std::result::Result<(), std::collections::TryReserveError>") dereferenceable(24) %_11, i64 %_12), !dbg !1951
...
bb11:                                             ; preds = %bb10
; call alloc::raw_vec::capacity_overflow
  call void @_ZN5alloc7raw_vec17capacity_overflow17he8700ca29a42fb1cE(), !dbg !1955
...
; call <alloc::alloc::Global as core::alloc::Allocator>::allocate
  %20 = call { i8*, i64 } @"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$8allocate17h39c1fd32459205ccE"(%"std::alloc::Global"* nonnull align 1 %alloc, i64 %_18.0, i64 %_18.1), !dbg !1957
...
; call <alloc::alloc::Global as core::alloc::Allocator>::allocate_zeroed
  %23 = call { i8*, i64 } @"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$15allocate_zeroed17ha2edb85b79b89d6dE"(%"std::alloc::Global"* nonnull align 1 %alloc, i64 %_20.0, i64 %_20.1), !dbg !1959
...
; call alloc::alloc::handle_alloc_error
  call void @_ZN5alloc5alloc18handle_alloc_error17hba238f19242600cdE(i64 %_24.0, i64 %_24.1), !dbg !1970
...
; call alloc::raw_vec::RawVec<T,A>::capacity_from_bytes
  %_29 = call i64 @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$19capacity_from_bytes17h8ee1e5bbbd324bdaE"(i64 %_30), !dbg !1973
...
; Function Attrs: nounwind
define void @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$13shrink_to_fit17h0539a9151bb499d6E"({ i8*, i64 }* align 8 dereferenceable(16) %self, i64 %amount) unnamed_addr #1 !dbg !1977 {
start:
...
; call alloc::raw_vec::RawVec<T,A>::shrink
  call void @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$6shrink17hac1a7bc0a4df594dE"(%"std::result::Result<(), std::collections::TryReserveError>"* noalias nocapture sret(%"std::result::Result<(), std::collections::TryReserveError>") dereferenceable(24) %_4, { i8*, i64 }* align 8 dereferenceable(16) %self, i64 %amount), !dbg !1986
  br label %bb1, !dbg !1986

bb1:                                              ; preds = %start
; call alloc::raw_vec::handle_reserve
  call void @_ZN5alloc7raw_vec14handle_reserve17h72b1ffa6ce4371dcE(%"std::result::Result<(), std::collections::TryReserveError>"* noalias nocapture dereferenceable(24) %_4), !dbg !1987
...
; Function Attrs: nounwind
define void @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$14current_memory17h5e0a1c85a6a17d16E"(%"std::option::Option<(std::ptr::NonNull<u8>, std::alloc::Layout)>"* noalias nocapture sret(%"std::option::Option<(std::ptr::NonNull<u8>, std::alloc::Layout)>") dereferenceable(24) %0, { i8*, i64 }* align 8 dereferenceable(16) %self) unnamed_addr #1 !dbg !1989 {
start:
...
; Function Attrs: inlinehint nounwind
define { i8*, i64 } @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$16with_capacity_in17h056650fc96f1c7d8E"(i64 %capacity) unnamed_addr #0 !dbg !2034 {
start:
  %alloc.dbg.spill = alloca %"std::alloc::Global", align 1
  %capacity.dbg.spill = alloca i64, align 8
...
; call alloc::raw_vec::RawVec<T,A>::allocate_in
  %2 = call { i8*, i64 } @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$11allocate_in17h18cc795a475c4153E"(i64 %capacity, i1 zeroext %1), !dbg !2043
...
; Function Attrs: nounwind
define i64 @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$19capacity_from_bytes17h8ee1e5bbbd324bdaE"(i64 %excess) unnamed_addr #1 !dbg !2045 {
start:
...
; Function Attrs: nounwind
define { i8*, i64 } @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$6new_in17h80e1e20a4fb8b053E"() unnamed_addr #1 !dbg !2061 {
start:
  %alloc.dbg.spill = alloca %"std::alloc::Global", align 1
  %0 = alloca { i8*, i64 }, align 8
...
; Function Attrs: nounwind
define void @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$6shrink17hac1a7bc0a4df594dE"(%"std::result::Result<(), std::collections::TryReserveError>"* noalias nocapture sret(%"std::result::Result<(), std::collections::TryReserveError>") dereferenceable(24) %0, { i8*, i64 }* align 8 dereferenceable(16) %self, i64 %amount) unnamed_addr #1 !dbg !2070 {
start:
  %self.dbg.spill.i = alloca { i8*, i64 }*, align 8
  %1 = alloca i64, align 8
  %ptr.dbg.spill1 = alloca { i8*, i64 }, align 8
...
; call alloc::raw_vec::RawVec<T,A>::current_memory
  call void @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$14current_memory17h5e0a1c85a6a17d16E"(%"std::option::Option<(std::ptr::NonNull<u8>, std::alloc::Layout)>"* noalias nocapture sret(%"std::option::Option<(std::ptr::NonNull<u8>, std::alloc::Layout)>") dereferenceable(24) %_11, { i8*, i64 }* align 8 dereferenceable(16) %self), !dbg !2103
...
; call <alloc::alloc::Global as core::alloc::Allocator>::shrink
  %29 = call { i8*, i64 } @"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$6shrink17h47e85cf1b266ec4aE"(%"std::alloc::Global"* nonnull align 1 %_26, i8* nonnull %ptr, i64 %_28.0, i64 %_28.1, i64 %_29.0, i64 %_29.1), !dbg !2119
...
; call alloc::raw_vec::RawVec<T,A>::set_ptr
  call void @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$7set_ptr17h88133d18b1bea256E"({ i8*, i64 }* align 8 dereferenceable(16) %self, i8* nonnull %val.0, i64 %val.1), !dbg !2125
...
; Function Attrs: inlinehint nounwind
define { i64, i64 } @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$6shrink28_$u7b$$u7b$closure$u7d$$u7d$17ha961cf18273ce991E"(i64* align 8 dereferenceable(16) %_1) unnamed_addr #0 !dbg !2130 {
start:
...
; Function Attrs: nounwind
define void @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$7set_ptr17h88133d18b1bea256E"({ i8*, i64 }* align 8 dereferenceable(16) %self, i8* nonnull %ptr.0, i64 %ptr.1) unnamed_addr #1 !dbg !2141 {
start:
  %ptr.dbg.spill = alloca { i8*, i64 }, align 8
  %self.dbg.spill = alloca { i8*, i64 }*, align 8
  store { i8*, i64 }* %self, { i8*, i64 }** %self.dbg.spill, align 8
...
bb4:                                              ; preds = %bb3
; call alloc::raw_vec::RawVec<T,A>::capacity_from_bytes
  %_7 = call i64 @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$19capacity_from_bytes17h8ee1e5bbbd324bdaE"(i64 %_8), !dbg !2153
...
; Function Attrs: nounwind
define { [0 x i8]*, i64 } @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8into_box17h20474ec24aa43325E"(i8* nonnull %self.0, i64 %self.1, i64 %len) unnamed_addr #1 !dbg !2156 {
start:
  %self.dbg.spill.i1 = alloca { i8*, i64 }*, align 8
  %self.dbg.spill.i = alloca { i8*, i64 }*, align 8
...
bb2:                                              ; preds = %bb1
; call alloc::raw_vec::RawVec<T,A>::ptr
  %_7 = call i8* @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$3ptr17hf552780662d2e5faE"({ i8*, i64 }* align 8 dereferenceable(16) %me), !dbg !2187
...
; call core::ptr::read
  call void @_ZN4core3ptr4read17hffcafd9cac2a9e09E(%"std::alloc::Global"* %_15), !dbg !2194
  br label %bb6, !dbg !2194

bb6:                                              ; preds = %bb5
; call alloc::boxed::Box<T,A>::from_raw_in
  %16 = call { [0 x i8]*, i64 } @"_ZN5alloc5boxed16Box$LT$T$C$A$GT$11from_raw_in17h221854dc1830fb58E"([0 x i8]* %slice.0, i64 %slice.1), !dbg !2195
...
; Function Attrs: nounwind
define nonnull align 1 %"std::alloc::Global"* @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$9allocator17h4fcc1fc7fad1adefE"({ i8*, i64 }* align 8 dereferenceable(16) %self) unnamed_addr #1 !dbg !2197 {
start:
  %self.dbg.spill = alloca { i8*, i64 }*, align 8
  store { i8*, i64 }* %self, { i8*, i64 }** %self.dbg.spill, align 8
...
; Function Attrs: inlinehint nounwind
define internal void @"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1a2788c0295c25c2E"(%"std::alloc::Global"* nonnull align 1 %self, i8* nonnull %ptr, i64 %0, i64 %1) unnamed_addr #0 !dbg !2205 {
start:
  %ptr.dbg.spill = alloca i8*, align 8
  %self.dbg.spill = alloca %"std::alloc::Global"*, align 8
  %layout = alloca { i64, i64 }, align 8
...
; call alloc::alloc::dealloc
  call void @_ZN5alloc5alloc7dealloc17heb496285ea544346E(i8* %_6, i64 %_8.0, i64 %_8.1), !dbg !2220
...
; Function Attrs: inlinehint nounwind
define internal { i8*, i64 } @"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$15allocate_zeroed17ha2edb85b79b89d6dE"(%"std::alloc::Global"* nonnull align 1 %self, i64 %layout.0, i64 %layout.1) unnamed_addr #0 !dbg !2222 {
start:
  %layout.dbg.spill = alloca { i64, i64 }, align 8
  %self.dbg.spill = alloca %"std::alloc::Global"*, align 8
  store %"std::alloc::Global"* %self, %"std::alloc::Global"** %self.dbg.spill, align 8
...
; call alloc::alloc::Global::alloc_impl
  %2 = call { i8*, i64 } @_ZN5alloc5alloc6Global10alloc_impl17h37506d444022bee7E(%"std::alloc::Global"* nonnull align 1 %self, i64 %layout.0, i64 %layout.1, i1 zeroext true), !dbg !2230
...
; Function Attrs: inlinehint nounwind
define internal { i8*, i64 } @"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$6shrink17h47e85cf1b266ec4aE"(%"std::alloc::Global"* nonnull align 1 %self, i8* nonnull %ptr, i64 %0, i64 %1, i64 %2, i64 %3) unnamed_addr #0 !dbg !2232 {
start:
...
; call <alloc::alloc::Global as core::alloc::Allocator>::deallocate
  call void @"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1a2788c0295c25c2E"(%"std::alloc::Global"* nonnull align 1 %self, i8* nonnull %ptr, i64 %_10.0, i64 %_10.1), !dbg !2268
...
; call <alloc::alloc::Global as core::alloc::Allocator>::allocate
  %16 = call { i8*, i64 } @"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$8allocate17h39c1fd32459205ccE"(%"std::alloc::Global"* nonnull align 1 %self, i64 %_49.0, i64 %_49.1), !dbg !2276
...
; call alloc::alloc::realloc
  %raw_ptr = call i8* @_ZN5alloc5alloc7realloc17hc9bea0e8ca0e73beE(i8* %_27, i64 %_29.0, i64 %_29.1, i64 %new_size), !dbg !2282
...
; call <alloc::alloc::Global as core::alloc::Allocator>::deallocate
  call void @"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1a2788c0295c25c2E"(%"std::alloc::Global"* nonnull align 1 %self, i8* nonnull %ptr, i64 %_64.0, i64 %_64.1), !dbg !2301
...
; Function Attrs: inlinehint nounwind
define internal { i8*, i64 } @"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$8allocate17h39c1fd32459205ccE"(%"std::alloc::Global"* nonnull align 1 %self, i64 %layout.0, i64 %layout.1) unnamed_addr #0 !dbg !2308 {
start:
  %layout.dbg.spill = alloca { i64, i64 }, align 8
  %self.dbg.spill = alloca %"std::alloc::Global"*, align 8
  store %"std::alloc::Global"* %self, %"std::alloc::Global"** %self.dbg.spill, align 8
...
; call alloc::alloc::Global::alloc_impl
  %2 = call { i8*, i64 } @_ZN5alloc5alloc6Global10alloc_impl17h37506d444022bee7E(%"std::alloc::Global"* nonnull align 1 %self, i64 %layout.0, i64 %layout.1, i1 zeroext false), !dbg !2314
...
; Function Attrs: nounwind
define { [0 x i8]*, i64 } @"_ZN75_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..deref..DerefMut$GT$9deref_mut17h1c4c309e5028a8e7E"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %self) unnamed_addr #1 !dbg !2322 {
start:
  %self.dbg.spill = alloca %"std::vec::Vec<u8>"*, align 8
  store %"std::vec::Vec<u8>"* %self, %"std::vec::Vec<u8>"** %self.dbg.spill, align 8
  call void @llvm.dbg.declare(metadata %"std::vec::Vec<u8>"** %self.dbg.spill, metadata !2327, metadata !DIExpression()), !dbg !2328
; call alloc::vec::Vec<T,A>::as_mut_ptr
  %_5 = call i8* @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$10as_mut_ptr17hef8b9e381d6be68aE"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %self), !dbg !2329
...
; Function Attrs: inlinehint nounwind
define internal { i64, i64 } @"_ZN78_$LT$alloc..collections..TryReserveErrorKind$u20$as$u20$core..clone..Clone$GT$5clone17h9383e4cb9cc74d24E"({ i64, i64 }* align 8 dereferenceable(16) %self) unnamed_addr #0 !dbg !2333 {
start:
...
start:
  ...
  call void @llvm.dbg.declare(metadata %"std::result::Result<(std::alloc::Layout, usize), std::alloc::LayoutError>"* %self, metadata !2374, metadata !DIExpression()), !dbg !2379
  call void @llvm.dbg.declare(metadata { { i64, i64 }, i64 }* %v, metadata !2375, metadata !DIExpression()), !dbg !2380
  call void @llvm.dbg.declare(metadata %"std::alloc::LayoutError"* %e.dbg.spill, metadata !2377, metadata !DIExpression()), !dbg !2381
  %1 = getelementptr inbounds %"std::result::Result<(std::alloc::Layout, usize), std::alloc::LayoutError>", %"std::result::Result<(std::alloc::Layout, usize), std::alloc::LayoutError>"* %self, i32 0, i32 1, !dbg !2382
  %2 = load i64, i64* %1, align 8, !dbg !2382
  %3 = icmp eq i64 %2, 0, !dbg !2382
  %_2 = select i1 %3, i64 1, i64 0, !dbg !2382
  switch i64 %_2, label %bb2 [
    i64 0, label %bb3
    i64 1, label %bb1
  ], !dbg !2383
...
bb3:                                              ; preds = %start
  %4 = bitcast %"std::result::Result<(std::alloc::Layout, usize), std::alloc::LayoutError>"* %self to %"std::result::Result<(std::alloc::Layout, usize), std::alloc::LayoutError>::Ok"*, !dbg !2384
  %5 = bitcast %"std::result::Result<(std::alloc::Layout, usize), std::alloc::LayoutError>::Ok"* %4 to { { i64, i64 }, i64 }*, !dbg !2384
  %6 = bitcast { { i64, i64 }, i64 }* %v to i8*, !dbg !2384
  %7 = bitcast { { i64, i64 }, i64 }* %5 to i8*, !dbg !2384
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %6, i8* align 8 %7, i64 24, i1 false), !dbg !2384
  %8 = bitcast { { i64, i64 }, i64 }* %_4 to i8*, !dbg !2385
  %9 = bitcast { { i64, i64 }, i64 }* %v to i8*, !dbg !2385
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %8, i8* align 8 %9, i64 24, i1 false), !dbg !2385
  %10 = bitcast %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::alloc::LayoutError>, (std::alloc::Layout, usize)>"* %0 to %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::alloc::LayoutError>, (std::alloc::Layout, usize)>::Continue"*, !dbg !2386
  %11 = bitcast %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::alloc::LayoutError>, (std::alloc::Layout, usize)>::Continue"* %10 to { { i64, i64 }, i64 }*, !dbg !2386
  %12 = bitcast { { i64, i64 }, i64 }* %11 to i8*, !dbg !2386
  %13 = bitcast { { i64, i64 }, i64 }* %_4 to i8*, !dbg !2386
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %12, i8* align 8 %13, i64 24, i1 false), !dbg !2386
  br label %bb4, !dbg !2387

bb1:                                              ; preds = %start
  %14 = bitcast %"std::result::Result<std::convert::Infallible, std::alloc::LayoutError>::Err"* %_6 to %"std::alloc::LayoutError"*, !dbg !2388
  %15 = bitcast %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::alloc::LayoutError>, (std::alloc::Layout, usize)>"* %0 to %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::alloc::LayoutError>, (std::alloc::Layout, usize)>::Break"*, !dbg !2389
  %16 = bitcast %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::alloc::LayoutError>, (std::alloc::Layout, usize)>::Break"* %15 to %"std::result::Result<std::convert::Infallible, std::alloc::LayoutError>::Err"*, !dbg !2389
  %17 = getelementptr inbounds %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::alloc::LayoutError>, (std::alloc::Layout, usize)>", %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::alloc::LayoutError>, (std::alloc::Layout, usize)>"* %0, i32 0, i32 1, !dbg !2389
  store i64 0, i64* %17, align 8, !dbg !2389
...
; <core::result::Result<T,E> as core::ops::try_trait::Try>::branch
; Function Attrs: inlinehint nounwind
define { i64, i64 } @"_ZN79_$LT$core..result..Result$LT$T$C$E$GT$$u20$as$u20$core..ops..try_trait..Try$GT$6branch17h74f3caba8a20a7f4E"(i64 %0, i64 %1) unnamed_addr #0 !dbg !2392 {
start:
  %v.dbg.spill = alloca i64, align 8
  %e.dbg.spill = alloca %"std::alloc::LayoutError", align 1
  %_6 = alloca %"std::result::Result<std::convert::Infallible, std::alloc::LayoutError>::Err", align 1
  ...
  %4 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %self, i32 0, i32 1
  store i64 %1, i64* %4, align 8
  call void @llvm.dbg.declare(metadata { i64, i64 }* %self, metadata !2411, metadata !DIExpression()), !dbg !2416
  call void @llvm.dbg.declare(metadata %"std::alloc::LayoutError"* %e.dbg.spill, metadata !2414, metadata !DIExpression()), !dbg !2417
  %5 = bitcast { i64, i64 }* %self to i64*, !dbg !2418
  %_2 = load i64, i64* %5, align 8, !dbg !2418, !range !314
  switch i64 %_2, label %bb2 [
    i64 0, label %bb3
    i64 1, label %bb1
  ], !dbg !2419
...
bb3:                                              ; preds = %start
  %6 = bitcast { i64, i64 }* %self to %"std::result::Result<usize, std::alloc::LayoutError>::Ok"*, !dbg !2420
  %7 = getelementptr inbounds %"std::result::Result<usize, std::alloc::LayoutError>::Ok", %"std::result::Result<usize, std::alloc::LayoutError>::Ok"* %6, i32 0, i32 1, !dbg !2420
  %v = load i64, i64* %7, align 8, !dbg !2420
  store i64 %v, i64* %v.dbg.spill, align 8, !dbg !2420
  call void @llvm.dbg.declare(metadata i64* %v.dbg.spill, metadata !2412, metadata !DIExpression()), !dbg !2421
  %8 = bitcast { i64, i64 }* %2 to %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::alloc::LayoutError>, usize>::Continue"*, !dbg !2422
  %9 = getelementptr inbounds %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::alloc::LayoutError>, usize>::Continue", %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::alloc::LayoutError>, usize>::Continue"* %8, i32 0, i32 1, !dbg !2422
  store i64 %v, i64* %9, align 8, !dbg !2422
  %10 = bitcast { i64, i64 }* %2 to i64*, !dbg !2422
  store i64 0, i64* %10, align 8, !dbg !2422
  br label %bb4, !dbg !2423

bb1:                                              ; preds = %start
  %11 = bitcast %"std::result::Result<std::convert::Infallible, std::alloc::LayoutError>::Err"* %_6 to %"std::alloc::LayoutError"*, !dbg !2424
  %12 = bitcast { i64, i64 }* %2 to %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::alloc::LayoutError>, usize>::Break"*, !dbg !2425
  %13 = getelementptr inbounds %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::alloc::LayoutError>, usize>::Break", %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::alloc::LayoutError>, usize>::Break"* %12, i32 0, i32 1, !dbg !2425
  %14 = bitcast { i64, i64 }* %2 to i64*, !dbg !2425
  store i64 1, i64* %14, align 8, !dbg !2425
  br label %bb4, !dbg !2426

bb4:                                              ; preds = %bb3, %bb1
  %15 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %2, i32 0, i32 0, !dbg !2427
  %16 = load i64, i64* %15, align 8, !dbg !2427, !range !314
  %17 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %2, i32 0, i32 1, !dbg !2427
  %18 = load i64, i64* %17, align 8, !dbg !2427
  %19 = insertvalue { i64, i64 } undef, i64 %16, 0, !dbg !2427
  %20 = insertvalue { i64, i64 } %19, i64 %18, 1, !dbg !2427
  ret { i64, i64 } %20, !dbg !2427
}
...
start:
  ...
  call void @llvm.dbg.declare(metadata %"std::result::Result<std::ptr::NonNull<[u8]>, std::collections::TryReserveErrorKind>"* %self, metadata !2447, metadata !DIExpression()), !dbg !2452
  %1 = bitcast %"std::result::Result<std::ptr::NonNull<[u8]>, std::collections::TryReserveErrorKind>"* %self to i64*, !dbg !2453
  %_2 = load i64, i64* %1, align 8, !dbg !2453, !range !314
  switch i64 %_2, label %bb2 [
    i64 0, label %bb3
    i64 1, label %bb1
  ], !dbg !2454
...
bb3:                                              ; preds = %start
  %2 = bitcast %"std::result::Result<std::ptr::NonNull<[u8]>, std::collections::TryReserveErrorKind>"* %self to %"std::result::Result<std::ptr::NonNull<[u8]>, std::collections::TryReserveErrorKind>::Ok"*, !dbg !2455
  %3 = getelementptr inbounds %"std::result::Result<std::ptr::NonNull<[u8]>, std::collections::TryReserveErrorKind>::Ok", %"std::result::Result<std::ptr::NonNull<[u8]>, std::collections::TryReserveErrorKind>::Ok"* %2, i32 0, i32 1, !dbg !2455
  %4 = getelementptr inbounds { i8*, i64 }, { i8*, i64 }* %3, i32 0, i32 0, !dbg !2455
  %v.0 = load i8*, i8** %4, align 8, !dbg !2455, !nonnull !4
  %5 = getelementptr inbounds { i8*, i64 }, { i8*, i64 }* %3, i32 0, i32 1, !dbg !2455
  %v.1 = load i64, i64* %5, align 8, !dbg !2455
  %6 = getelementptr inbounds { i8*, i64 }, { i8*, i64 }* %v.dbg.spill, i32 0, i32 0, !dbg !2455
  store i8* %v.0, i8** %6, align 8, !dbg !2455
  %7 = getelementptr inbounds { i8*, i64 }, { i8*, i64 }* %v.dbg.spill, i32 0, i32 1, !dbg !2455
  store i64 %v.1, i64* %7, align 8, !dbg !2455
  call void @llvm.dbg.declare(metadata { i8*, i64 }* %v.dbg.spill, metadata !2448, metadata !DIExpression()), !dbg !2456
  %8 = bitcast %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::collections::TryReserveErrorKind>, std::ptr::NonNull<[u8]>>"* %0 to %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::collections::TryReserveErrorKind>, std::ptr::NonNull<[u8]>>::Continue"*, !dbg !2457
  %9 = getelementptr inbounds %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::collections::TryReserveErrorKind>, std::ptr::NonNull<[u8]>>::Continue", %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::collections::TryReserveErrorKind>, std::ptr::NonNull<[u8]>>::Continue"* %8, i32 0, i32 1, !dbg !2457
  %10 = getelementptr inbounds { i8*, i64 }, { i8*, i64 }* %9, i32 0, i32 0, !dbg !2457
  store i8* %v.0, i8** %10, align 8, !dbg !2457
  %11 = getelementptr inbounds { i8*, i64 }, { i8*, i64 }* %9, i32 0, i32 1, !dbg !2457
  store i64 %v.1, i64* %11, align 8, !dbg !2457
  %12 = bitcast %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::collections::TryReserveErrorKind>, std::ptr::NonNull<[u8]>>"* %0 to i64*, !dbg !2457
  store i64 0, i64* %12, align 8, !dbg !2457
  br label %bb4, !dbg !2458

bb1:                                              ; preds = %start
  %13 = bitcast %"std::result::Result<std::ptr::NonNull<[u8]>, std::collections::TryReserveErrorKind>"* %self to %"std::result::Result<std::ptr::NonNull<[u8]>, std::collections::TryReserveErrorKind>::Err"*, !dbg !2459
  %14 = getelementptr inbounds %"std::result::Result<std::ptr::NonNull<[u8]>, std::collections::TryReserveErrorKind>::Err", %"std::result::Result<std::ptr::NonNull<[u8]>, std::collections::TryReserveErrorKind>::Err"* %13, i32 0, i32 1, !dbg !2459
  %15 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %14, i32 0, i32 0, !dbg !2459
  %e.0 = load i64, i64* %15, align 8, !dbg !2459
  %16 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %14, i32 0, i32 1, !dbg !2459
  %e.1 = load i64, i64* %16, align 8, !dbg !2459
  %17 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %e.dbg.spill, i32 0, i32 0, !dbg !2459
  store i64 %e.0, i64* %17, align 8, !dbg !2459
  %18 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %e.dbg.spill, i32 0, i32 1, !dbg !2459
  store i64 %e.1, i64* %18, align 8, !dbg !2459
  call void @llvm.dbg.declare(metadata { i64, i64 }* %e.dbg.spill, metadata !2450, metadata !DIExpression()), !dbg !2460
  %19 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %_6, i32 0, i32 0, !dbg !2461
  store i64 %e.0, i64* %19, align 8, !dbg !2461
  %20 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %_6, i32 0, i32 1, !dbg !2461
  store i64 %e.1, i64* %20, align 8, !dbg !2461
  %21 = bitcast %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::collections::TryReserveErrorKind>, std::ptr::NonNull<[u8]>>"* %0 to %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::collections::TryReserveErrorKind>, std::ptr::NonNull<[u8]>>::Break"*, !dbg !2462
  %22 = getelementptr inbounds %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::collections::TryReserveErrorKind>, std::ptr::NonNull<[u8]>>::Break", %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::collections::TryReserveErrorKind>, std::ptr::NonNull<[u8]>>::Break"* %21, i32 0, i32 1, !dbg !2462
  %23 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %_6, i32 0, i32 0, !dbg !2462
  %24 = load i64, i64* %23, align 8, !dbg !2462
  %25 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %_6, i32 0, i32 1, !dbg !2462
  %26 = load i64, i64* %25, align 8, !dbg !2462
  %27 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %22, i32 0, i32 0, !dbg !2462
  store i64 %24, i64* %27, align 8, !dbg !2462
  %28 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %22, i32 0, i32 1, !dbg !2462
  store i64 %26, i64* %28, align 8, !dbg !2462
  %29 = bitcast %"std::ops::ControlFlow<std::result::Result<std::convert::Infallible, std::collections::TryReserveErrorKind>, std::ptr::NonNull<[u8]>>"* %0 to i64*, !dbg !2462
  store i64 1, i64* %29, align 8, !dbg !2462
...
; Function Attrs: nounwind
define void @"_ZN87_$LT$alloc..vec..Vec$LT$T$GT$$u20$as$u20$core..convert..From$LT$$RF$$u5b$T$u5d$$GT$$GT$4from17h4536af5ff42434e3E"(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %0, [0 x i8]* nonnull align 1 %s.0, i64 %s.1) unnamed_addr #1 !dbg !2535 {
start:
  %s.dbg.spill = alloca { [0 x i8]*, i64 }, align 8
  %1 = getelementptr inbounds { [0 x i8]*, i64 }, { [0 x i8]*, i64 }* %s.dbg.spill, i32 0, i32 0
  store [0 x i8]* %s.0, [0 x i8]** %1, align 8
...
; call alloc::slice::<impl [T]>::to_vec
  call void @"_ZN5alloc5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$6to_vec17he16d27598cce6e04E"(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %0, [0 x i8]* nonnull align 1 %s.0, i64 %s.1), !dbg !2540
...
; Function Attrs: inlinehint nounwind
define void @"_ZN90_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..iter..traits..collect..IntoIterator$GT$9into_iter17hc4fab68336198f29E"(%"std::vec::IntoIter<u8>"* noalias nocapture sret(%"std::vec::IntoIter<u8>") dereferenceable(32) %0, %"std::vec::Vec<u8>"* noalias nocapture dereferenceable(24) %self) unnamed_addr #0 !dbg !2542 {
start:
...
; call alloc::vec::Vec<T,A>::allocator
  %_6 = call nonnull align 1 %"std::alloc::Global"* @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$9allocator17h745e0b6277b12a05E"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %11), !dbg !2585
  br label %bb3, !dbg !2585

bb3:                                              ; preds = %bb2
; call core::ptr::read
  call void @_ZN4core3ptr4read17hffcafd9cac2a9e09E(%"std::alloc::Global"* %_6), !dbg !2586
...
bb5:                                              ; preds = %bb4
; call alloc::vec::Vec<T,A>::as_mut_ptr
  %begin = call i8* @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$10as_mut_ptr17hef8b9e381d6be68aE"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %_3.i), !dbg !2597
...
bb13:                                             ; preds = %bb12
; call alloc::vec::Vec<T,A>::len
  %_26 = call i64 @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$3len17h4ede26e8656e7d6fE"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %14), !dbg !2607
...
bb9:                                              ; preds = %bb8
; call alloc::vec::Vec<T,A>::len
  %_20 = call i64 @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$3len17h4ede26e8656e7d6fE"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %13), !dbg !2603
...
; Function Attrs: nounwind
define void @"_ZN68_$LT$serde_bytes..bytes..Bytes$u20$as$u20$alloc..borrow..ToOwned$GT$8to_owned17hada1357dcbf85eefE"(%"bytebuf::ByteBuf"* noalias nocapture sret(%"bytebuf::ByteBuf") dereferenceable(24) %0, %"bytes::Bytes"* nonnull align 1 %self.0, i64 %self.1) unnamed_addr #1 !dbg !2721 {
start:
  %self.dbg.spill = alloca { %"bytes::Bytes"*, i64 }, align 8
...
; Function Attrs: nounwind
define { %"bytes::Bytes"*, i64 } @"_ZN11serde_bytes5bytes145_$LT$impl$u20$core..convert..From$LT$alloc..boxed..Box$LT$$u5b$u8$u5d$$GT$$GT$$u20$for$u20$alloc..boxed..Box$LT$serde_bytes..bytes..Bytes$GT$$GT$4from17hf9b8a7ff9281f9d3E"([0 x i8]* noalias nonnull align 1 %bytes.0, i64 %bytes.1) unnamed_addr #1 !dbg !2735 {
start:
  %bytes.dbg.spill = alloca { [0 x i8]*, i64 }, align 8
  %0 = getelementptr inbounds { [0 x i8]*, i64 }, { [0 x i8]*, i64 }* %bytes.dbg.spill, i32 0, i32 0
  store [0 x i8]* %bytes.0, [0 x i8]** %0, align 8
...
; call alloc::boxed::Box<T,A>::into_raw
  %2 = call { [0 x i8]*, i64 } @"_ZN5alloc5boxed16Box$LT$T$C$A$GT$8into_raw17hdb3319f8adb27c3eE"([0 x i8]* noalias nonnull align 1 %bytes.0, i64 %bytes.1), !dbg !2740
...
; call alloc::boxed::Box<T>::from_raw
  %3 = call { %"bytes::Bytes"*, i64 } @"_ZN5alloc5boxed12Box$LT$T$GT$8from_raw17hdc50017ec18538c1E"(%"bytes::Bytes"* %_2.0, i64 %_3.1), !dbg !2741
...
; Function Attrs: nounwind
define { %"bytes::Bytes"*, i64 } @"_ZN11serde_bytes5bytes103_$LT$impl$u20$core..default..Default$u20$for$u20$alloc..boxed..Box$LT$serde_bytes..bytes..Bytes$GT$$GT$7default17h7b58ebffddbc3e2bE"() unnamed_addr #1 !dbg !2749 {
start:
...
; call serde_bytes::bytebuf::ByteBuf::into_boxed_bytes
  %0 = call { %"bytes::Bytes"*, i64 } @_ZN11serde_bytes7bytebuf7ByteBuf16into_boxed_bytes17h9e58de886c36c601E(%"bytebuf::ByteBuf"* noalias nocapture dereferenceable(24) %_1), !dbg !2753
...
; call alloc::vec::Vec<T>::new
  call void @"_ZN5alloc3vec12Vec$LT$T$GT$3new17hefe365ed66da8ba5E"(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %_1), !dbg !2816
  br label %bb1, !dbg !2816

bb1:                                              ; preds = %start
; call serde_bytes::bytebuf::ByteBuf::from
  call void @_ZN11serde_bytes7bytebuf7ByteBuf4from17h1e01dc26e8f4f087E(%"bytebuf::ByteBuf"* noalias nocapture sret(%"bytebuf::ByteBuf") dereferenceable(24) %0, %"std::vec::Vec<u8>"* noalias nocapture dereferenceable(24) %_1), !dbg !2817
...
; call alloc::vec::Vec<T>::with_capacity
  call void @"_ZN5alloc3vec12Vec$LT$T$GT$13with_capacity17h3eb10f21229156fdE"(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %_2, i64 %cap), !dbg !2825
  br label %bb1, !dbg !2825

bb1:                                              ; preds = %start
; call serde_bytes::bytebuf::ByteBuf::from
  call void @_ZN11serde_bytes7bytebuf7ByteBuf4from17h1e01dc26e8f4f087E(%"bytebuf::ByteBuf"* noalias nocapture sret(%"bytebuf::ByteBuf") dereferenceable(24) %0, %"std::vec::Vec<u8>"* noalias nocapture dereferenceable(24) %_2), !dbg !2826
...
; Function Attrs: nounwind
define void @_ZN11serde_bytes7bytebuf7ByteBuf4from17h1e01dc26e8f4f087E(%"bytebuf::ByteBuf"* noalias nocapture sret(%"bytebuf::ByteBuf") dereferenceable(24) %0, %"std::vec::Vec<u8>"* noalias nocapture dereferenceable(24) %bytes) unnamed_addr #1 !dbg !2828 {
start:
  %_3 = alloca %"std::vec::Vec<u8>", align 8
  %_2 = alloca %"std::vec::Vec<u8>", align 8
...
; call <T as core::convert::Into<U>>::into
  call void @"_ZN50_$LT$T$u20$as$u20$core..convert..Into$LT$U$GT$$GT$4into17h1e403698c40b47adE"(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %_2, %"std::vec::Vec<u8>"* noalias nocapture dereferenceable(24) %_3), !dbg !2834
...
; serde_bytes::bytebuf::ByteBuf::from
; Function Attrs: nounwind
define void @_ZN11serde_bytes7bytebuf7ByteBuf4from17hb09e2a4d0cb09b4cE(%"bytebuf::ByteBuf"* noalias nocapture sret(%"bytebuf::ByteBuf") dereferenceable(24) %0, [0 x i8]* nonnull align 1 %bytes.0, i64 %bytes.1) unnamed_addr #1 !dbg !2837 {
start:
  %bytes.dbg.spill = alloca { [0 x i8]*, i64 }, align 8
  %_2 = alloca %"std::vec::Vec<u8>", align 8
...
; call <T as core::convert::Into<U>>::into
  call void @"_ZN50_$LT$T$u20$as$u20$core..convert..Into$LT$U$GT$$GT$4into17hd86cd5548db0e1f3E"(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %_2, [0 x i8]* nonnull align 1 %bytes.0, i64 %bytes.1), !dbg !2844
...
; Function Attrs: nounwind
define void @_ZN11serde_bytes7bytebuf7ByteBuf8into_vec17h5a9d435eaa6faebfE(%"std::vec::Vec<u8>"* noalias nocapture sret(%"std::vec::Vec<u8>") dereferenceable(24) %0, %"bytebuf::ByteBuf"* noalias nocapture dereferenceable(24) %self) unnamed_addr #1 !dbg !2847 {
start:
...
; Function Attrs: nounwind
define { %"bytes::Bytes"*, i64 } @_ZN11serde_bytes7bytebuf7ByteBuf16into_boxed_bytes17h9e58de886c36c601E(%"bytebuf::ByteBuf"* noalias nocapture dereferenceable(24) %self) unnamed_addr #1 !dbg !2855 {
start:
  %_3 = alloca %"std::vec::Vec<u8>", align 8
...
; call alloc::vec::Vec<T,A>::into_boxed_slice
  %3 = call { [0 x i8]*, i64 } @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$16into_boxed_slice17h807fed230504c601E"(%"std::vec::Vec<u8>"* noalias nocapture dereferenceable(24) %_3), !dbg !2861
...
bb1:                                              ; preds = %start
; call <T as core::convert::Into<U>>::into
  %4 = call { %"bytes::Bytes"*, i64 } @"_ZN50_$LT$T$u20$as$u20$core..convert..Into$LT$U$GT$$GT$4into17h96277047e4dd8be5E"([0 x i8]* noalias nonnull align 1 %_2.0, i64 %_2.1), !dbg !2861
...
; Function Attrs: nounwind
define { [0 x i8]*, i64 } @_ZN11serde_bytes7bytebuf7ByteBuf16into_boxed_slice17h127efb782d053613E(%"bytebuf::ByteBuf"* noalias nocapture dereferenceable(24) %self) unnamed_addr #1 !dbg !2863 {
start:
  %_2 = alloca %"std::vec::Vec<u8>", align 8
...
; call alloc::vec::Vec<T,A>::into_boxed_slice
  %3 = call { [0 x i8]*, i64 } @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$16into_boxed_slice17h807fed230504c601E"(%"std::vec::Vec<u8>"* noalias nocapture dereferenceable(24) %_2), !dbg !2869
...
; Function Attrs: nounwind
define void @_ZN11serde_bytes7bytebuf7ByteBuf9into_iter17h71c080c331120ea8E(%"std::vec::IntoIter<u8>"* noalias nocapture sret(%"std::vec::IntoIter<u8>") dereferenceable(32) %0, %"bytebuf::ByteBuf"* noalias nocapture dereferenceable(24) %self) unnamed_addr #1 !dbg !2871 {
start:
  %_2 = alloca %"std::vec::Vec<u8>", align 8
...
; call <alloc::vec::Vec<T,A> as core::iter::traits::collect::IntoIterator>::into_iter
  call void @"_ZN90_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..iter..traits..collect..IntoIterator$GT$9into_iter17hc4fab68336198f29E"(%"std::vec::IntoIter<u8>"* noalias nocapture sret(%"std::vec::IntoIter<u8>") dereferenceable(32) %0, %"std::vec::Vec<u8>"* noalias nocapture dereferenceable(24) %_2), !dbg !2877
...
; call <alloc::vec::Vec<T,A> as core::fmt::Debug>::fmt
  %0 = call zeroext i1 @"_ZN65_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..fmt..Debug$GT$3fmt17h14633928a00ad3b9E"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %_4, %"std::fmt::Formatter"* align 8 dereferenceable(64) %f), !dbg !2890
...
; call <alloc::vec::Vec<T,A> as core::ops::deref::Deref>::deref
  %0 = call { [0 x i8]*, i64 } @"_ZN72_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..deref..Deref$GT$5deref17he35364be3e1c0e22E"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %_3), !dbg !2899
...
; call <alloc::vec::Vec<T,A> as core::ops::deref::DerefMut>::deref_mut
  %0 = call { [0 x i8]*, i64 } @"_ZN75_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..deref..DerefMut$GT$9deref_mut17h1c4c309e5028a8e7E"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %_5), !dbg !2909
...
; call <alloc::vec::Vec<T,A> as core::ops::deref::Deref>::deref
  %0 = call { [0 x i8]*, i64 } @"_ZN72_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..deref..Deref$GT$5deref17he35364be3e1c0e22E"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %_5), !dbg !2936
...
; call <alloc::vec::Vec<T,A> as core::ops::deref::DerefMut>::deref_mut
  %0 = call { [0 x i8]*, i64 } @"_ZN75_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..deref..DerefMut$GT$9deref_mut17h1c4c309e5028a8e7E"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %_10), !dbg !2946
...
; call <alloc::vec::Vec<T,A> as core::iter::traits::collect::IntoIterator>::into_iter
  call void @"_ZN90_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..iter..traits..collect..IntoIterator$GT$9into_iter17hc4fab68336198f29E"(%"std::vec::IntoIter<u8>"* noalias nocapture sret(%"std::vec::IntoIter<u8>") dereferenceable(32) %0, %"std::vec::Vec<u8>"* noalias nocapture dereferenceable(24) %_2), !dbg !2954
...
; call <alloc::vec::Vec<T,A> as core::ops::deref::Deref>::deref
  %0 = call { [0 x i8]*, i64 } @"_ZN72_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..deref..Deref$GT$5deref17he35364be3e1c0e22E"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %_4), !dbg !2963
...
; call <alloc::vec::Vec<T,A> as core::ops::deref::DerefMut>::deref_mut
  %0 = call { [0 x i8]*, i64 } @"_ZN75_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..deref..DerefMut$GT$9deref_mut17h1c4c309e5028a8e7E"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %_4), !dbg !2972
...
; Function Attrs: inlinehint nounwind
declare i8* @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$3ptr17hf552780662d2e5faE"({ i8*, i64 }* align 8 dereferenceable(16)) unnamed_addr #0
...
declare void @_ZN5alloc5alloc18handle_alloc_error17hba238f19242600cdE(i64, i64) unnamed_addr #7

; alloc::raw_vec::capacity_overflow
; Function Attrs: noreturn nounwind
declare void @_ZN5alloc7raw_vec17capacity_overflow17he8700ca29a42fb1cE() unnamed_addr #8
...
; Function Attrs: nounwind
declare zeroext i1 @"_ZN65_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..fmt..Debug$GT$3fmt17h14633928a00ad3b9E"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24), %"std::fmt::Formatter"* align 8 dereferenceable(64)) unnamed_addr #1
...
!12 = !DIFile(filename: "/home/osboxes/.cargo/registry/src/github.com-1ecc6299db9ec823/serde_bytes-0.11.5/src/lib.rs", directory: "/home/osboxes/.cargo/registry/src/github.com-1ecc6299db9ec823/serde_bytes-0.11.5")
!13 = !{!14, !21, !27, !32}
...
!47 = !{!48, !51}
!48 = !DICompositeType(tag: DW_TAG_structure_type, name: "TryReserveError", scope: !45, file: !2, size: 128, align: 64, elements: !49, templateParams: !4, identifier: "b5ed00f382f0d5c5cb05f00eb9601f74")
!49 = !{!50}
!50 = !DIDerivedType(tag: DW_TAG_member, name: "kind", scope: !48, file: !2, baseType: !51, size: 128, align: 64)
!51 = !DICompositeType(tag: DW_TAG_structure_type, name: "TryReserveErrorKind", scope: !45, file: !2, size: 128, align: 64, elements: !52, identifier: "bd42b2b23f724657f7f1bd089ff6e025")
!52 = !{!53}
!53 = !DICompositeType(tag: DW_TAG_variant_part, scope: !45, file: !2, size: 128, align: 64, elements: !54, templateParams: !4, identifier: "bd42b2b23f724657f7f1bd089ff6e025_variant_part", discriminator: !73)
!54 = !{!55, !57}
!55 = !DIDerivedType(tag: DW_TAG_member, name: "CapacityOverflow", scope: !53, file: !2, baseType: !56, size: 128, align: 64, extraData: i64 0)
!56 = !DICompositeType(tag: DW_TAG_structure_type, name: "CapacityOverflow", scope: !51, file: !2, size: 128, align: 64, elements: !4, templateParams: !4, identifier: "bd42b2b23f724657f7f1bd089ff6e025::CapacityOverflow")
!57 = !DIDerivedType(tag: DW_TAG_member, name: "AllocError", scope: !53, file: !2, baseType: !58, size: 128, align: 64)
!58 = !DICompositeType(tag: DW_TAG_structure_type, name: "AllocError", scope: !51, file: !2, size: 128, align: 64, elements: !59, templateParams: !4, identifier: "bd42b2b23f724657f7f1bd089ff6e025::AllocError")
!59 = !{!60, !71}
...
!126 = distinct !DISubprogram(name: "from_residual<(), alloc::collections::TryReserveErrorKind, alloc::collections::TryReserveError>", linkageName: "_ZN153_$LT$core..result..Result$LT$T$C$F$GT$$u20$as$u20$core..ops..try_trait..FromResidual$LT$core..result..Result$LT$core..convert..Infallible$C$E$GT$$GT$$GT$13from_residual17h302021b0be684174E", scope: !82, file: !81, line: 1913, type: !127, scopeLine: 1913, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !159, retainedNodes: !155)
!127 = !DISubroutineType(types: !128)
!128 = !{!129, !145}
!129 = !DICompositeType(tag: DW_TAG_structure_type, name: "Result<(), alloc::collections::TryReserveError>", scope: !28, file: !2, size: 192, align: 64, elements: !130, identifier: "440164621559721dd2015f60ca42af45")
!130 = !{!131}
!131 = !DICompositeType(tag: DW_TAG_variant_part, scope: !28, file: !2, size: 192, align: 64, elements: !132, templateParams: !137, identifier: "440164621559721dd2015f60ca42af45_variant_part", discriminator: !144)
!132 = !{!133, !140}
!133 = !DIDerivedType(tag: DW_TAG_member, name: "Ok", scope: !131, file: !2, baseType: !134, size: 192, align: 64, extraData: i64 0)
!134 = !DICompositeType(tag: DW_TAG_structure_type, name: "Ok", scope: !129, file: !2, size: 192, align: 64, elements: !135, templateParams: !137, identifier: "440164621559721dd2015f60ca42af45::Ok")
!135 = !{!136}
!136 = !DIDerivedType(tag: DW_TAG_member, name: "__0", scope: !134, file: !2, baseType: !72, align: 8, offset: 64)
!137 = !{!138, !139}
!138 = !DITemplateTypeParameter(name: "T", type: !72)
!139 = !DITemplateTypeParameter(name: "E", type: !48)
!140 = !DIDerivedType(tag: DW_TAG_member, name: "Err", scope: !131, file: !2, baseType: !141, size: 192, align: 64, extraData: i64 1)
!141 = !DICompositeType(tag: DW_TAG_structure_type, name: "Err", scope: !129, file: !2, size: 192, align: 64, elements: !142, templateParams: !137, identifier: "440164621559721dd2015f60ca42af45::Err")
!142 = !{!143}
!143 = !DIDerivedType(tag: DW_TAG_member, name: "__0", scope: !141, file: !2, baseType: !48, size: 128, align: 64, offset: 64)
!144 = !DIDerivedType(tag: DW_TAG_member, scope: !28, file: !2, baseType: !74, size: 64, align: 64, flags: DIFlagArtificial)
!145 = !DICompositeType(tag: DW_TAG_structure_type, name: "Result<core::convert::Infallible, alloc::collections::TryReserveErrorKind>", scope: !28, file: !2, size: 128, align: 64, elements: !146, identifier: "7dbd706f82187002e83023bc269f03a1")
!146 = !{!147}
!147 = !DICompositeType(tag: DW_TAG_variant_part, scope: !28, file: !2, size: 128, align: 64, elements: !148, templateParams: !153, identifier: "7dbd706f82187002e83023bc269f03a1_variant_part")
!148 = !{!149}
!149 = !DIDerivedType(tag: DW_TAG_member, name: "Err", scope: !147, file: !2, baseType: !150, size: 128, align: 64)
!150 = !DICompositeType(tag: DW_TAG_structure_type, name: "Err", scope: !145, file: !2, size: 128, align: 64, elements: !151, templateParams: !153, identifier: "7dbd706f82187002e83023bc269f03a1::Err")
!151 = !{!152}
!152 = !DIDerivedType(tag: DW_TAG_member, name: "__0", scope: !150, file: !2, baseType: !51, size: 128, align: 64)
!153 = !{!110, !154}
!154 = !DITemplateTypeParameter(name: "E", type: !51)
!155 = !{!156, !157}
!156 = !DILocalVariable(name: "residual", arg: 1, scope: !126, file: !81, line: 1913, type: !145)
!157 = !DILocalVariable(name: "e", scope: !158, file: !81, line: 1915, type: !51, align: 8)
!158 = distinct !DILexicalBlock(scope: !126, file: !81, line: 1915, column: 13)
!159 = !{!138, !154, !160}
!160 = !DITemplateTypeParameter(name: "F", type: !48)
!161 = !DILocation(line: 1913, column: 22, scope: !126)
!162 = !DILocation(line: 1915, column: 17, scope: !126)
!163 = !DILocation(line: 1915, column: 17, scope: !158)
!164 = !DILocation(line: 1915, column: 27, scope: !158)
!165 = !DILocation(line: 1915, column: 23, scope: !158)
!166 = !DILocation(line: 1917, column: 6, scope: !126)
!167 = distinct !DISubprogram(name: "from_residual<(core::alloc::layout::Layout, usize), core::alloc::layout::LayoutError, core::alloc::layout::LayoutError>", linkageName: "_ZN153_$LT$core..result..Result$LT$T$C$F$GT$$u20$as$u20$core..ops..try_trait..FromResidual$LT$core..result..Result$LT$core..convert..Infallible$C$E$GT$$GT$$GT$13from_residual17h5b76572abe90c7acE", scope: !82, file: !81, line: 1913, type: !168, scopeLine: 1913, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !192, retainedNodes: !188)
!168 = !DISubroutineType(types: !169)
!169 = !{!170, !101}
!170 = !DICompositeType(tag: DW_TAG_structure_type, name: "Result<(core::alloc::layout::Layout, usize), core::alloc::layout::LayoutError>", scope: !28, file: !2, size: 192, align: 64, elements: !171, identifier: "f1386a55091ece7d92996439741f9fac")
!171 = !{!172}
!172 = !DICompositeType(tag: DW_TAG_variant_part, scope: !28, file: !2, size: 192, align: 64, elements: !173, templateParams: !182, identifier: "f1386a55091ece7d92996439741f9fac_variant_part", discriminator: !100)
!173 = !{!174, !184}
!174 = !DIDerivedType(tag: DW_TAG_member, name: "Ok", scope: !172, file: !2, baseType: !175, size: 192, align: 64)
!175 = !DICompositeType(tag: DW_TAG_structure_type, name: "Ok", scope: !170, file: !2, size: 192, align: 64, elements: !176, templateParams: !182, identifier: "f1386a55091ece7d92996439741f9fac::Ok")
!176 = !{!177}
!177 = !DIDerivedType(tag: DW_TAG_member, name: "__0", scope: !175, file: !2, baseType: !178, size: 192, align: 64)
!178 = !DICompositeType(tag: DW_TAG_structure_type, name: "(core::alloc::layout::Layout, usize)", file: !2, size: 192, align: 64, elements: !179, templateParams: !4, identifier: "67f85d36b181012f3a00f61c3a83b547")
!179 = !{!180, !181}
!180 = !DIDerivedType(tag: DW_TAG_member, name: "__0", scope: !178, file: !2, baseType: !61, size: 128, align: 64)
!181 = !DIDerivedType(tag: DW_TAG_member, name: "__1", scope: !178, file: !2, baseType: !64, size: 64, align: 64, offset: 128)
!182 = !{!183, !95}
!183 = !DITemplateTypeParameter(name: "T", type: !178)
!184 = !DIDerivedType(tag: DW_TAG_member, name: "Err", scope: !172, file: !2, baseType: !185, size: 192, align: 64, extraData: i64 0)
!185 = !DICompositeType(tag: DW_TAG_structure_type, name: "Err", scope: !170, file: !2, size: 192, align: 64, elements: !186, templateParams: !182, identifier: "f1386a55091ece7d92996439741f9fac::Err")
!186 = !{!187}
!187 = !DIDerivedType(tag: DW_TAG_member, name: "__0", scope: !185, file: !2, baseType: !5, align: 8)
!188 = !{!189, !190}
!189 = !DILocalVariable(name: "residual", arg: 1, scope: !167, file: !81, line: 1913, type: !101)
!190 = !DILocalVariable(name: "e", scope: !191, file: !81, line: 1915, type: !5, align: 1)
!191 = distinct !DILexicalBlock(scope: !167, file: !81, line: 1915, column: 13)
!192 = !{!183, !95, !120}
!193 = !DILocation(line: 1913, column: 22, scope: !167)
!194 = !DILocation(line: 1915, column: 17, scope: !191)
!195 = !DILocation(line: 1915, column: 27, scope: !191)
!196 = !DILocation(line: 1915, column: 23, scope: !191)
!197 = !DILocation(line: 1917, column: 6, scope: !167)
...
!202 = !{!203}
!203 = !DICompositeType(tag: DW_TAG_variant_part, scope: !28, file: !2, size: 128, align: 64, elements: !204, templateParams: !224, identifier: "39e2dadcfc45dc0ea3c81265c9f2367a_variant_part", discriminator: !144)
!204 = !{!205, !228}
...
!378 = distinct !DISubprogram(name: "read<alloc::raw_vec::RawVec<u8, alloc::alloc::Global>>", linkageName: "_ZN4core3ptr4read17ha33ca5a2aadea3f9E", scope: !211, file: !333, line: 683, type: !379, scopeLine: 683, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !409, retainedNodes: !398)
!379 = !DISubroutineType(types: !380)
!380 = !{!381, !397}
!381 = !DICompositeType(tag: DW_TAG_structure_type, name: "RawVec<u8, alloc::alloc::Global>", scope: !22, file: !2, size: 128, align: 64, elements: !382, templateParams: !395, identifier: "5d8bbd1a5ea5acae1c690e544499445a")
!382 = !{!383, !391, !392}
...
!393 = !DICompositeType(tag: DW_TAG_structure_type, name: "Global", scope: !394, file: !2, align: 8, elements: !4, templateParams: !4, identifier: "4ea658df9108d173874181de92fdae66")
...
!402 = !DICompositeType(tag: DW_TAG_union_type, name: "MaybeUninit<alloc::raw_vec::RawVec<u8, alloc::alloc::Global>>", scope: !341, file: !2, size: 128, align: 64, elements: !403, templateParams: !409, identifier: "eee5f9f9c181df9fc1cce243f12dae90")
!403 = !{!404, !405}
...
!406 = !DICompositeType(tag: DW_TAG_structure_type, name: "ManuallyDrop<alloc::raw_vec::RawVec<u8, alloc::alloc::Global>>", scope: !347, file: !2, size: 128, align: 64, elements: !407, templateParams: !409, identifier: "465dde198058b2dcfe93bd6d8f3abfee")
!407 = !{!408}
...
!414 = distinct !DISubprogram(name: "uninit<alloc::raw_vec::RawVec<u8, alloc::alloc::Global>>", linkageName: "_ZN4core3mem12maybe_uninit20MaybeUninit$LT$T$GT$6uninit17he5cae293dbdc117cE", scope: !402, file: !415, line: 317, type: !416, scopeLine: 317, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !409, retainedNodes: !4)
...
!422 = distinct !DISubprogram(name: "as_mut_ptr<alloc::raw_vec::RawVec<u8, alloc::alloc::Global>>", linkageName: "_ZN4core3mem12maybe_uninit20MaybeUninit$LT$T$GT$10as_mut_ptr17h5352134a0fde4e4dE", scope: !402, file: !415, line: 568, type: !423, scopeLine: 568, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !409, retainedNodes: !427)
...
!434 = distinct !DISubprogram(name: "assume_init<alloc::raw_vec::RawVec<u8, alloc::alloc::Global>>", linkageName: "_ZN4core3mem12maybe_uninit20MaybeUninit$LT$T$GT$11assume_init17ha8cebdc2dc355b0aE", scope: !402, file: !415, line: 623, type: !435, scopeLine: 623, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !409, retainedNodes: !450)
...
!464 = distinct !DISubprogram(name: "read<alloc::alloc::Global>", linkageName: "_ZN4core3ptr4read17hffcafd9cac2a9e09E", scope: !211, file: !333, line: 683, type: !465, scopeLine: 683, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !479, retainedNodes: !468)
...
!472 = !DICompositeType(tag: DW_TAG_union_type, name: "MaybeUninit<alloc::alloc::Global>", scope: !341, file: !2, align: 8, elements: !473, templateParams: !479, identifier: "29790439913759e97831518d0d571ce")
!473 = !{!474, !475}
...
!476 = !DICompositeType(tag: DW_TAG_structure_type, name: "ManuallyDrop<alloc::alloc::Global>", scope: !347, file: !2, align: 8, elements: !477, templateParams: !479, identifier: "b4f88aa002430d8a3a2dfb2d8747c4cf")
!477 = !{!478}
...
!484 = distinct !DISubprogram(name: "uninit<alloc::alloc::Global>", linkageName: "_ZN4core3mem12maybe_uninit20MaybeUninit$LT$T$GT$6uninit17hd30d8b9b09efeccbE", scope: !472, file: !415, line: 317, type: !485, scopeLine: 317, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !479, retainedNodes: !4)
...
!490 = distinct !DISubprogram(name: "as_mut_ptr<alloc::alloc::Global>", linkageName: "_ZN4core3mem12maybe_uninit20MaybeUninit$LT$T$GT$10as_mut_ptr17h2765eed76b1a6779E", scope: !472, file: !415, line: 568, type: !491, scopeLine: 568, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !479, retainedNodes: !495)
...
!502 = distinct !DISubprogram(name: "assume_init<alloc::alloc::Global>", linkageName: "_ZN4core3mem12maybe_uninit20MaybeUninit$LT$T$GT$11assume_init17hb95fc7382966c3a6E", scope: !472, file: !415, line: 623, type: !503, scopeLine: 623, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !479, retainedNodes: !505)
...
!826 = !DIFile(filename: "/home/osboxes/.cargo/registry/src/github.com-1ecc6299db9ec823/serde_bytes-0.11.5/src/lib.rs", directory: "/home/osboxes/.cargo/registry/src/github.com-1ecc6299db9ec823/serde_bytes-0.11.5", checksumkind: CSK_MD5, checksum: "dfd9f31f4f1ccbb2bf0b8d0f3354c82b")
...
!926 = !DILocalVariable(name: "val", scope: !927, file: !762, line: 394, type: !178, align: 8)
...
!1114 = !{!1115}
!1115 = !DICompositeType(tag: DW_TAG_variant_part, scope: !28, file: !2, size: 128, align: 64, elements: !1116, templateParams: !1121, identifier: "bcfcb322480b2d26d4da0769e4ceae7b_variant_part", discriminator: !144)
!1116 = !{!1117, !1122}
...
!1148 = !{!1149}
!1149 = !DICompositeType(tag: DW_TAG_variant_part, scope: !28, file: !2, size: 64, align: 64, elements: !1150, templateParams: !1155, identifier: "ae14187b6b914de222cba478783c9cfb_variant_part", discriminator: !144)
!1150 = !{!1151, !1156}
...
!1196 = distinct !DISubprogram(name: "map_err<(), alloc::collections::TryReserveError, alloc::collections::TryReserveErrorKind, alloc::raw_vec::handle_reserve::{closure#0}>", linkageName: "_ZN4core6result19Result$LT$T$C$E$GT$7map_err17hbb7725d7c5e8a039E", scope: !129, file: !81, line: 850, type: !1197, scopeLine: 850, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1221, retainedNodes: !1214)
!1197 = !DISubroutineType(types: !1198)
!1198 = !{!1199, !129, !1212}
!1199 = !DICompositeType(tag: DW_TAG_structure_type, name: "Result<(), alloc::collections::TryReserveErrorKind>", scope: !28, file: !2, size: 192, align: 64, elements: !1200, identifier: "c5234daba5ceedbef9db3c5bfbdbd9dc")
!1200 = !{!1201}
!1201 = !DICompositeType(tag: DW_TAG_variant_part, scope: !28, file: !2, size: 192, align: 64, elements: !1202, templateParams: !1207, identifier: "c5234daba5ceedbef9db3c5bfbdbd9dc_variant_part", discriminator: !144)
!1202 = !{!1203, !1208}
!1203 = !DIDerivedType(tag: DW_TAG_member, name: "Ok", scope: !1201, file: !2, baseType: !1204, size: 192, align: 64, extraData: i64 0)
!1204 = !DICompositeType(tag: DW_TAG_structure_type, name: "Ok", scope: !1199, file: !2, size: 192, align: 64, elements: !1205, templateParams: !1207, identifier: "c5234daba5ceedbef9db3c5bfbdbd9dc::Ok")
!1205 = !{!1206}
...
!1209 = !DICompositeType(tag: DW_TAG_structure_type, name: "Err", scope: !1199, file: !2, size: 192, align: 64, elements: !1210, templateParams: !1207, identifier: "c5234daba5ceedbef9db3c5bfbdbd9dc::Err")
!1210 = !{!1211}
!1211 = !DIDerivedType(tag: DW_TAG_member, name: "__0", scope: !1209, file: !2, baseType: !51, size: 128, align: 64, offset: 64)
!1212 = !DICompositeType(tag: DW_TAG_structure_type, name: "{closure#0}", scope: !1213, file: !2, align: 8, elements: !4, templateParams: !4, identifier: "4c722b013b473e7c60ec7ea8d7106754")
!1213 = !DINamespace(name: "handle_reserve", scope: !22)
!1214 = !{!1215, !1216, !1217, !1219}
!1215 = !DILocalVariable(name: "self", arg: 1, scope: !1196, file: !81, line: 850, type: !129)
...
!1238 = distinct !DISubprogram(name: "map_err<core::ptr::non_null::NonNull<[u8]>, core::alloc::AllocError, alloc::collections::TryReserveErrorKind, alloc::raw_vec::{impl#2}::shrink::{closure#0}>", linkageName: "_ZN4core6result19Result$LT$T$C$E$GT$7map_err17hbe92d7543aa51db9E", scope: !201, file: !81, line: 850, type: !1239, scopeLine: 850, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1266, retainedNodes: !1259)
!1239 = !DISubroutineType(types: !1240)
!1240 = !{!1241, !201, !1254}
!1241 = !DICompositeType(tag: DW_TAG_structure_type, name: "Result<core::ptr::non_null::NonNull<[u8]>, alloc::collections::TryReserveErrorKind>", scope: !28, file: !2, size: 192, align: 64, elements: !1242, identifier: "1c9d2ca57fc99ac8e02f7dd19bc87c13")
!1242 = !{!1243}
!1243 = !DICompositeType(tag: DW_TAG_variant_part, scope: !28, file: !2, size: 192, align: 64, elements: !1244, templateParams: !1249, identifier: "1c9d2ca57fc99ac8e02f7dd19bc87c13_variant_part", discriminator: !144)
!1244 = !{!1245, !1250}
!1245 = !DIDerivedType(tag: DW_TAG_member, name: "Ok", scope: !1243, file: !2, baseType: !1246, size: 192, align: 64, extraData: i64 0)
!1246 = !DICompositeType(tag: DW_TAG_structure_type, name: "Ok", scope: !1241, file: !2, size: 192, align: 64, elements: !1247, templateParams: !1249, identifier: "1c9d2ca57fc99ac8e02f7dd19bc87c13::Ok")
!1247 = !{!1248}
...
!1251 = !DICompositeType(tag: DW_TAG_structure_type, name: "Err", scope: !1241, file: !2, size: 192, align: 64, elements: !1252, templateParams: !1249, identifier: "1c9d2ca57fc99ac8e02f7dd19bc87c13::Err")
!1252 = !{!1253}
!1253 = !DIDerivedType(tag: DW_TAG_member, name: "__0", scope: !1251, file: !2, baseType: !51, size: 128, align: 64, offset: 64)
!1254 = !DICompositeType(tag: DW_TAG_structure_type, name: "{closure#0}", scope: !1255, file: !2, size: 64, align: 64, elements: !1257, templateParams: !4, identifier: "dd514a69dbc3e74e61fe4f14b81cf0bb")
...
!1282 = distinct !DISubprogram(name: "from<alloc::vec::Vec<u8, alloc::alloc::Global>>", linkageName: "_ZN50_$LT$T$u20$as$u20$core..convert..From$LT$T$GT$$GT$4from17h9a39afee859a6c76E", scope: !1284, file: !1283, line: 547, type: !1285, scopeLine: 547, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1294, retainedNodes: !1292)
...
!1286 = !{!1287, !1287}
!1287 = !DICompositeType(tag: DW_TAG_structure_type, name: "Vec<u8, alloc::alloc::Global>", scope: !1288, file: !2, size: 192, align: 64, elements: !1289, templateParams: !395, identifier: "544e509f8e0a7b1cb9be9709b6e26fb")
!1288 = !DINamespace(name: "vec", scope: !23)
!1289 = !{!1290, !1291}
!1290 = !DIDerivedType(tag: DW_TAG_member, name: "buf", scope: !1287, file: !2, baseType: !381, size: 128, align: 64)
!1291 = !DIDerivedType(tag: DW_TAG_member, name: "len", scope: !1287, file: !2, baseType: !64, size: 64, align: 64, offset: 128)
!1292 = !{!1293}
!1293 = !DILocalVariable(name: "t", arg: 1, scope: !1282, file: !1283, line: 547, type: !1287)
!1294 = !{!1295}
!1295 = !DITemplateTypeParameter(name: "T", type: !1287)
!1296 = !DILocation(line: 547, column: 13, scope: !1282)
!1297 = !DILocation(line: 548, column: 9, scope: !1282)
!1298 = !DILocation(line: 549, column: 6, scope: !1282)
!1299 = distinct !DISubprogram(name: "from<core::alloc::AllocError>", linkageName: "_ZN50_$LT$T$u20$as$u20$core..convert..From$LT$T$GT$$GT$4from17hd24db5c6eec3db82E", scope: !1284, file: !1283, line: 547, type: !1300, scopeLine: 547, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1304, retainedNodes: !1302)
!1300 = !DISubroutineType(types: !1301)
!1301 = !{null, !227}
!1302 = !{!1303}
!1303 = !DILocalVariable(name: "t", arg: 1, scope: !1299, file: !1283, line: 547, type: !227)
!1304 = !{!1305}
!1305 = !DITemplateTypeParameter(name: "T", type: !227)
!1306 = !DILocation(line: 547, column: 13, scope: !1299)
!1307 = !DILocation(line: 549, column: 6, scope: !1299)
!1308 = distinct !DISubprogram(name: "from<core::alloc::layout::LayoutError>", linkageName: "_ZN50_$LT$T$u20$as$u20$core..convert..From$LT$T$GT$$GT$4from17he06985843b40aa16E", scope: !1284, file: !1283, line: 547, type: !1309, scopeLine: 547, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !523, retainedNodes: !1311)
!1309 = !DISubroutineType(types: !1310)
!1310 = !{null, !5}
!1311 = !{!1312}
!1312 = !DILocalVariable(name: "t", arg: 1, scope: !1308, file: !1283, line: 547, type: !5)
!1313 = !DILocation(line: 547, column: 13, scope: !1308)
!1314 = !DILocation(line: 549, column: 6, scope: !1308)
!1315 = distinct !DISubprogram(name: "into<alloc::vec::Vec<u8, alloc::alloc::Global>, alloc::vec::Vec<u8, alloc::alloc::Global>>", linkageName: "_ZN50_$LT$T$u20$as$u20$core..convert..Into$LT$U$GT$$GT$4into17h1e403698c40b47adE", scope: !1316, file: !1283, line: 539, type: !1285, scopeLine: 539, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1319, retainedNodes: !1317)
!1316 = !DINamespace(name: "{impl#3}", scope: !112)
!1317 = !{!1318}
!1318 = !DILocalVariable(name: "self", arg: 1, scope: !1315, file: !1283, line: 539, type: !1287)
!1319 = !{!1295, !1320}
!1320 = !DITemplateTypeParameter(name: "U", type: !1287)
...
!1338 = !DICompositeType(tag: DW_TAG_structure_type, name: "alloc::boxed::Box<[u8], alloc::alloc::Global>", file: !2, size: 128, align: 64, elements: !1339, templateParams: !1342, identifier: "90ba79ecd5c9fd068492480a8b7c315e")
!1339 = !{!1340, !1341}
...
!1365 = distinct !DISubprogram(name: "to_vec<u8, alloc::alloc::Global>", linkageName: "_ZN52_$LT$T$u20$as$u20$alloc..slice..hack..ConvertVec$GT$6to_vec17h93636afd59cfe5c0E", scope: !1367, file: !1366, line: 222, type: !1370, scopeLine: 222, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !1372)
...
!1375 = !DILocalVariable(name: "v", scope: !1376, file: !1366, line: 223, type: !1287, align: 8)
...
!1385 = distinct !DISubprogram(name: "kind", linkageName: "_ZN5alloc11collections15TryReserveError4kind17h542610ee98112c92E", scope: !48, file: !43, line: 73, type: !1386, scopeLine: 73, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !4, retainedNodes: !1389)
...
!1394 = distinct !DISubprogram(name: "with_capacity<u8>", linkageName: "_ZN5alloc3vec12Vec$LT$T$GT$13with_capacity17h3eb10f21229156fdE", scope: !1287, file: !1395, line: 465, type: !1396, scopeLine: 465, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !350, retainedNodes: !1398)
...
!1403 = distinct !DISubprogram(name: "new<u8>", linkageName: "_ZN5alloc3vec12Vec$LT$T$GT$3new17hefe365ed66da8ba5E", scope: !1287, file: !1395, line: 421, type: !1404, scopeLine: 421, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !350, retainedNodes: !4)
!1404 = !DISubroutineType(types: !1405)
!1405 = !{!1287}
!1406 = !DILocation(line: 422, column: 9, scope: !1403)
!1407 = !DILocation(line: 423, column: 6, scope: !1403)
!1408 = distinct !DISubprogram(name: "as_mut_ptr<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc3vec16Vec$LT$T$C$A$GT$10as_mut_ptr17hef8b9e381d6be68aE", scope: !1287, file: !1395, line: 1165, type: !1409, scopeLine: 1165, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !1412)
!1409 = !DISubroutineType(types: !1410)
!1410 = !{!665, !1411}
!1411 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "&mut Vec<u8, alloc::alloc::Global>", baseType: !1287, size: 64, align: 64, dwarfAddressSpace: 0)
!1412 = !{!1413, !1414}
...
!1423 = distinct !DISubprogram(name: "shrink_to_fit<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc3vec16Vec$LT$T$C$A$GT$13shrink_to_fit17h55fe6316e478fa83E", scope: !1287, file: !1395, line: 932, type: !1424, scopeLine: 932, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !1426)
...
!1435 = distinct !DISubprogram(name: "into_boxed_slice<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc3vec16Vec$LT$T$C$A$GT$16into_boxed_slice17h807fed230504c601E", scope: !1287, file: !1395, line: 993, type: !1436, scopeLine: 993, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !1438)
!1436 = !DISubroutineType(types: !1437)
!1437 = !{!1338, !1287}
!1438 = !{!1439, !1440, !1445, !1447}
!1439 = !DILocalVariable(name: "self", arg: 1, scope: !1435, file: !1395, line: 993, type: !1287)
...
!1442 = !DICompositeType(tag: DW_TAG_structure_type, name: "ManuallyDrop<alloc::vec::Vec<u8, alloc::alloc::Global>>", scope: !347, file: !2, size: 192, align: 64, elements: !1443, templateParams: !1294, identifier: "da18b6b5ffe0a9683bd147936344c76e")
!1443 = !{!1444}
!1444 = !DIDerivedType(tag: DW_TAG_member, name: "value", scope: !1442, file: !2, baseType: !1287, size: 192, align: 64)
...
!1453 = !{!1454}
!1454 = distinct !{!1454, !1455, !"_ZN4core3mem13manually_drop21ManuallyDrop$LT$T$GT$3new17hbb62344b8ee4f8baE: argument 0"}
!1455 = distinct !{!1455, !"_ZN4core3mem13manually_drop21ManuallyDrop$LT$T$GT$3new17hbb62344b8ee4f8baE"}
!1456 = !DILocation(line: 996, column: 22, scope: !1435)
!1457 = !{!1458}
!1458 = distinct !{!1458, !1455, !"_ZN4core3mem13manually_drop21ManuallyDrop$LT$T$GT$3new17hbb62344b8ee4f8baE: %value"}
!1459 = !DILocalVariable(name: "value", arg: 1, scope: !1460, file: !455, line: 69, type: !1287)
!1460 = distinct !DISubprogram(name: "new<alloc::vec::Vec<u8, alloc::alloc::Global>>", linkageName: "_ZN4core3mem13manually_drop21ManuallyDrop$LT$T$GT$3new17hbb62344b8ee4f8baE", scope: !1442, file: !455, line: 69, type: !1461, scopeLine: 69, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1294, retainedNodes: !1463)
...
!1490 = distinct !DISubprogram(name: "with_capacity_in<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc3vec16Vec$LT$T$C$A$GT$16with_capacity_in17h7cbc81ba001bc760E", scope: !1287, file: !1395, line: 604, type: !1491, scopeLine: 604, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !1493)
...
!1501 = distinct !DISubprogram(name: "len<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc3vec16Vec$LT$T$C$A$GT$3len17h4ede26e8656e7d6fE", scope: !1287, file: !1395, line: 1831, type: !1502, scopeLine: 1831, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !1504)
...
!1509 = distinct !DISubprogram(name: "set_len<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc3vec16Vec$LT$T$C$A$GT$7set_len17h5c5e279753daeffaE", scope: !1287, file: !1395, line: 1262, type: !1510, scopeLine: 1262, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !1512)
...
!1519 = distinct !DISubprogram(name: "capacity<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc3vec16Vec$LT$T$C$A$GT$8capacity17h63af2cbd5fda959cE", scope: !1287, file: !1395, line: 781, type: !1502, scopeLine: 781, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !1520)
!1520 = !{!1521}
...
!1525 = distinct !DISubprogram(name: "capacity<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8capacity17h108ede14ac951a83E", scope: !381, file: !1526, line: 247, type: !1527, scopeLine: 247, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !1530)
...
!1536 = distinct !DISubprogram(name: "allocator<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc3vec16Vec$LT$T$C$A$GT$9allocator17h745e0b6277b12a05E", scope: !1287, file: !1395, line: 1178, type: !1537, scopeLine: 1178, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !1540)
...
!1545 = distinct !DISubprogram(name: "alloc_zeroed", linkageName: "_ZN5alloc5alloc12alloc_zeroed17h163c07586afe7e6cE", scope: !394, file: !1546, line: 154, type: !1547, scopeLine: 154, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !4, retainedNodes: !1549)
...
!1556 = distinct !DISubprogram(name: "alloc", linkageName: "_ZN5alloc5alloc5alloc17h531f34b4e51c75acE", scope: !394, file: !1546, line: 85, type: !1547, scopeLine: 85, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !4, retainedNodes: !1557)
!1557 = !{!1558}
...
!1564 = distinct !DISubprogram(name: "alloc_impl", linkageName: "_ZN5alloc5alloc6Global10alloc_impl17h37506d444022bee7E", scope: !393, file: !1546, line: 161, type: !1565, scopeLine: 161, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !4, retainedNodes: !1567)
...
!1609 = distinct !DISubprogram(name: "dealloc", linkageName: "_ZN5alloc5alloc7dealloc17heb496285ea544346E", scope: !394, file: !1546, line: 103, type: !1610, scopeLine: 103, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !4, retainedNodes: !1612)
...
!1621 = distinct !DISubprogram(name: "realloc", linkageName: "_ZN5alloc5alloc7realloc17hc9bea0e8ca0e73beE", scope: !394, file: !1546, line: 121, type: !1622, scopeLine: 121, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !4, retainedNodes: !1624)
...
!1635 = distinct !DISubprogram(name: "from_raw<serde_bytes::bytes::Bytes>", linkageName: "_ZN5alloc5boxed12Box$LT$T$GT$8from_raw17hdc50017ec18538c1E", scope: !1637, file: !1636, line: 836, type: !1639, scopeLine: 836, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !559, retainedNodes: !1641)
...
!1646 = distinct !DISubprogram(name: "from_raw_in<[core::mem::maybe_uninit::MaybeUninit<u8>], alloc::alloc::Global>", linkageName: "_ZN5alloc5boxed16Box$LT$T$C$A$GT$11from_raw_in17h221854dc1830fb58E", scope: !1647, file: !1636, line: 891, type: !1648, scopeLine: 891, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1654, retainedNodes: !1655)
!1647 = !DINamespace(name: "{impl#7}", scope: !1638)
!1648 = !DISubroutineType(types: !1649)
!1649 = !{!1650, !336, !393}
!1650 = !DICompositeType(tag: DW_TAG_structure_type, name: "alloc::boxed::Box<[core::mem::maybe_uninit::MaybeUninit<u8>], alloc::alloc::Global>", file: !2, size: 128, align: 64, elements: !1651, templateParams: !1654, identifier: "1b3801ec65ae9aa038dba96fd0bbd040")
!1651 = !{!1652, !1653}
...
!1663 = distinct !DISubprogram(name: "from_raw_in<[u8], alloc::alloc::Global>", linkageName: "_ZN5alloc5boxed16Box$LT$T$C$A$GT$11from_raw_in17h71f94a77aa3cf878E", scope: !1647, file: !1636, line: 891, type: !1664, scopeLine: 891, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1342, retainedNodes: !1666)
!1664 = !DISubroutineType(types: !1665)
!1665 = !{!1338, !577, !393}
!1666 = !{!1667, !1668}
!1667 = !DILocalVariable(name: "raw", arg: 1, scope: !1663, file: !1636, line: 891, type: !577)
!1668 = !DILocalVariable(name: "alloc", arg: 2, scope: !1663, file: !1636, line: 891, type: !393)
!1669 = !DILocation(line: 891, column: 31, scope: !1663)
!1670 = !DILocation(line: 891, column: 44, scope: !1663)
!1671 = !DILocation(line: 892, column: 22, scope: !1663)
!1672 = !DILocation(line: 892, column: 9, scope: !1663)
!1673 = !DILocation(line: 893, column: 6, scope: !1663)
!1674 = distinct !DISubprogram(name: "from_raw_in<serde_bytes::bytes::Bytes, alloc::alloc::Global>", linkageName: "_ZN5alloc5boxed16Box$LT$T$C$A$GT$11from_raw_in17heb47f329e2acedd5E", scope: !1647, file: !1636, line: 891, type: !1675, scopeLine: 891, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1680, retainedNodes: !1677)
!1675 = !DISubroutineType(types: !1676)
!1676 = !{!1337, !563, !393}
!1677 = !{!1678, !1679}
!1678 = !DILocalVariable(name: "raw", arg: 1, scope: !1674, file: !1636, line: 891, type: !563)
!1679 = !DILocalVariable(name: "alloc", arg: 2, scope: !1674, file: !1636, line: 891, type: !393)
!1680 = !{!560, !396}
!1681 = !DILocation(line: 891, column: 31, scope: !1674)
!1682 = !DILocation(line: 891, column: 44, scope: !1674)
!1683 = !DILocation(line: 892, column: 22, scope: !1674)
!1684 = !DILocation(line: 892, column: 9, scope: !1674)
!1685 = !DILocation(line: 893, column: 6, scope: !1674)
!1686 = distinct !DISubprogram(name: "into_unique<[u8], alloc::alloc::Global>", linkageName: "_ZN5alloc5boxed16Box$LT$T$C$A$GT$11into_unique17h2b57dcad8b053316E", scope: !1647, file: !1636, line: 1000, type: !1687, scopeLine: 1000, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1342, retainedNodes: !1693)
!1687 = !DISubroutineType(types: !1688)
!1688 = !{!1689, !1338}
!1689 = !DICompositeType(tag: DW_TAG_structure_type, name: "(core::ptr::unique::Unique<[u8]>, alloc::alloc::Global)", file: !2, size: 128, align: 64, elements: !1690, templateParams: !4, identifier: "fa64e253e67a7d25c5d457af2f38e4d")
!1690 = !{!1691, !1692}
...
!1706 = distinct !DISubprogram(name: "into_unique<[core::mem::maybe_uninit::MaybeUninit<u8>], alloc::alloc::Global>", linkageName: "_ZN5alloc5boxed16Box$LT$T$C$A$GT$11into_unique17h4d1f1013a2c139d0E", scope: !1647, file: !1636, line: 1000, type: !1707, scopeLine: 1000, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1654, retainedNodes: !1713)
!1707 = !DISubroutineType(types: !1708)
!1708 = !{!1709, !1650}
!1709 = !DICompositeType(tag: DW_TAG_structure_type, name: "(core::ptr::unique::Unique<[core::mem::maybe_uninit::MaybeUninit<u8>]>, alloc::alloc::Global)", file: !2, size: 128, align: 64, elements: !1710, templateParams: !4, identifier: "356cabba4fe3bf441bf811c9e343f44c")
!1710 = !{!1711, !1712}
...
!1713 = !{!1714, !1715}
!1714 = !DILocalVariable(name: "b", arg: 1, scope: !1706, file: !1636, line: 1000, type: !1650)
...
!1726 = distinct !DISubprogram(name: "into_raw_with_allocator<[u8], alloc::alloc::Global>", linkageName: "_ZN5alloc5boxed16Box$LT$T$C$A$GT$23into_raw_with_allocator17h76f1215e63fb11d6E", scope: !1647, file: !1636, line: 988, type: !1727, scopeLine: 988, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1342, retainedNodes: !1733)
!1727 = !DISubroutineType(types: !1728)
!1728 = !{!1729, !1338}
!1729 = !DICompositeType(tag: DW_TAG_structure_type, name: "(*mut [u8], alloc::alloc::Global)", file: !2, size: 128, align: 64, elements: !1730, templateParams: !4, identifier: "8acdc3229ad23890a71de00c4871aa97")
!1730 = !{!1731, !1732}
...
!1733 = !{!1734, !1735, !1737}
!1734 = !DILocalVariable(name: "b", arg: 1, scope: !1726, file: !1636, line: 988, type: !1338)
...
!1746 = distinct !DISubprogram(name: "into_raw_with_allocator<[core::mem::maybe_uninit::MaybeUninit<u8>], alloc::alloc::Global>", linkageName: "_ZN5alloc5boxed16Box$LT$T$C$A$GT$23into_raw_with_allocator17haed076f07206abe5E", scope: !1647, file: !1636, line: 988, type: !1747, scopeLine: 988, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1654, retainedNodes: !1753)
!1747 = !DISubroutineType(types: !1748)
!1748 = !{!1749, !1650}
!1749 = !DICompositeType(tag: DW_TAG_structure_type, name: "(*mut [core::mem::maybe_uninit::MaybeUninit<u8>], alloc::alloc::Global)", file: !2, size: 128, align: 64, elements: !1750, templateParams: !4, identifier: "44cb63f319d945d1745f2064afcfbe25")
!1750 = !{!1751, !1752}
...
!1755 = !DILocalVariable(name: "leaked", scope: !1756, file: !1636, line: 989, type: !528, align: 8)
...
!1766 = distinct !DISubprogram(name: "leak<[core::mem::maybe_uninit::MaybeUninit<u8>], alloc::alloc::Global>", linkageName: "_ZN5alloc5boxed16Box$LT$T$C$A$GT$4leak17h217d1dddeda8cd9fE", scope: !1647, file: !1636, line: 1058, type: !1767, scopeLine: 1058, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1654, retainedNodes: !1769)
!1767 = !DISubroutineType(types: !1768)
!1768 = !{!1030, !1650}
!1769 = !{!1770}
!1770 = !DILocalVariable(name: "b", arg: 1, scope: !1766, file: !1636, line: 1058, type: !1650)
!1771 = !DILocation(line: 1058, column: 21, scope: !1766)
!1772 = !{!1773}
!1773 = distinct !{!1773, !1774, !"_ZN4core3mem13manually_drop21ManuallyDrop$LT$T$GT$3new17hd58d2c38e00129b1E: %value.0"}
!1774 = distinct !{!1774, !"_ZN4core3mem13manually_drop21ManuallyDrop$LT$T$GT$3new17hd58d2c38e00129b1E"}
!1775 = !DILocation(line: 1062, column: 24, scope: !1766)
!1776 = !DILocalVariable(name: "value", arg: 1, scope: !1777, file: !455, line: 69, type: !1650)
!1777 = distinct !DISubprogram(name: "new<alloc::boxed::Box<[core::mem::maybe_uninit::MaybeUninit<u8>], alloc::alloc::Global>>", linkageName: "_ZN4core3mem13manually_drop21ManuallyDrop$LT$T$GT$3new17hd58d2c38e00129b1E", scope: !1778, file: !455, line: 69, type: !1783, scopeLine: 69, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1781, retainedNodes: !1785)
!1778 = !DICompositeType(tag: DW_TAG_structure_type, name: "ManuallyDrop<alloc::boxed::Box<[core::mem::maybe_uninit::MaybeUninit<u8>], alloc::alloc::Global>>", scope: !347, file: !2, size: 128, align: 64, elements: !1779, templateParams: !1781, identifier: "ea2c666567bdae89cd3f38548656257a")
!1779 = !{!1780}
!1780 = !DIDerivedType(tag: DW_TAG_member, name: "value", scope: !1778, file: !2, baseType: !1650, size: 128, align: 64)
!1781 = !{!1782}
!1782 = !DITemplateTypeParameter(name: "T", type: !1650)
!1783 = !DISubroutineType(types: !1784)
!1784 = !{!1778, !1650}
!1785 = !{!1776}
!1786 = !DILocation(line: 69, column: 22, scope: !1777, inlinedAt: !1787)
!1787 = distinct !DILocation(line: 1062, column: 24, scope: !1766)
!1788 = !DILocation(line: 70, column: 9, scope: !1777, inlinedAt: !1787)
!1789 = !DILocation(line: 71, column: 6, scope: !1777, inlinedAt: !1787)
!1790 = !DILocalVariable(name: "self", arg: 1, scope: !1791, file: !455, line: 151, type: !1795)
!1791 = distinct !DISubprogram(name: "deref<alloc::boxed::Box<[core::mem::maybe_uninit::MaybeUninit<u8>], alloc::alloc::Global>>", linkageName: "_ZN91_$LT$core..mem..manually_drop..ManuallyDrop$LT$T$GT$$u20$as$u20$core..ops..deref..Deref$GT$5deref17hb2542a461456b8baE", scope: !1470, file: !455, line: 151, type: !1792, scopeLine: 151, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1781, retainedNodes: !1796)
!1792 = !DISubroutineType(types: !1793)
!1793 = !{!1794, !1795}
!1794 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "&Box<[core::mem::maybe_uninit::MaybeUninit<u8>], alloc::alloc::Global>", baseType: !1650, size: 64, align: 64, dwarfAddressSpace: 0)
!1795 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "&ManuallyDrop<alloc::boxed::Box<[core::mem::maybe_uninit::MaybeUninit<u8>], alloc::alloc::Global>>", baseType: !1778, size: 64, align: 64, dwarfAddressSpace: 0)
!1796 = !{!1790}
!1797 = !DILocation(line: 151, column: 14, scope: !1791, inlinedAt: !1798)
!1798 = distinct !DILocation(line: 1062, column: 24, scope: !1766)
!1799 = !DILocation(line: 152, column: 9, scope: !1791, inlinedAt: !1798)
!1800 = !DILocation(line: 1063, column: 6, scope: !1766)
!1801 = distinct !DISubprogram(name: "leak<[u8], alloc::alloc::Global>", linkageName: "_ZN5alloc5boxed16Box$LT$T$C$A$GT$4leak17h501aa30dfdbb7e1eE", scope: !1647, file: !1636, line: 1058, type: !1802, scopeLine: 1058, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1342, retainedNodes: !1804)
!1802 = !DISubroutineType(types: !1803)
!1803 = !{!1016, !1338}
!1804 = !{!1805}
!1805 = !DILocalVariable(name: "b", arg: 1, scope: !1801, file: !1636, line: 1058, type: !1338)
!1806 = !DILocation(line: 1058, column: 21, scope: !1801)
!1807 = !{!1808}
!1808 = distinct !{!1808, !1809, !"_ZN4core3mem13manually_drop21ManuallyDrop$LT$T$GT$3new17hb69353551c996d4aE: %value.0"}
!1809 = distinct !{!1809, !"_ZN4core3mem13manually_drop21ManuallyDrop$LT$T$GT$3new17hb69353551c996d4aE"}
!1810 = !DILocation(line: 1062, column: 24, scope: !1801)
!1811 = !DILocalVariable(name: "value", arg: 1, scope: !1812, file: !455, line: 69, type: !1338)
!1812 = distinct !DISubprogram(name: "new<alloc::boxed::Box<[u8], alloc::alloc::Global>>", linkageName: "_ZN4core3mem13manually_drop21ManuallyDrop$LT$T$GT$3new17hb69353551c996d4aE", scope: !1813, file: !455, line: 69, type: !1817, scopeLine: 69, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1816, retainedNodes: !1819)
!1813 = !DICompositeType(tag: DW_TAG_structure_type, name: "ManuallyDrop<alloc::boxed::Box<[u8], alloc::alloc::Global>>", scope: !347, file: !2, size: 128, align: 64, elements: !1814, templateParams: !1816, identifier: "b58ac990a323804bd7866dfac8ba2df9")
!1814 = !{!1815}
!1815 = !DIDerivedType(tag: DW_TAG_member, name: "value", scope: !1813, file: !2, baseType: !1338, size: 128, align: 64)
!1816 = !{!1346}
!1817 = !DISubroutineType(types: !1818)
!1818 = !{!1813, !1338}
!1819 = !{!1811}
!1820 = !DILocation(line: 69, column: 22, scope: !1812, inlinedAt: !1821)
!1821 = distinct !DILocation(line: 1062, column: 24, scope: !1801)
!1822 = !DILocation(line: 70, column: 9, scope: !1812, inlinedAt: !1821)
!1823 = !DILocation(line: 71, column: 6, scope: !1812, inlinedAt: !1821)
!1824 = !DILocalVariable(name: "self", arg: 1, scope: !1825, file: !455, line: 151, type: !1829)
!1825 = distinct !DISubprogram(name: "deref<alloc::boxed::Box<[u8], alloc::alloc::Global>>", linkageName: "_ZN91_$LT$core..mem..manually_drop..ManuallyDrop$LT$T$GT$$u20$as$u20$core..ops..deref..Deref$GT$5deref17h33fec9a4047bb265E", scope: !1470, file: !455, line: 151, type: !1826, scopeLine: 151, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1816, retainedNodes: !1830)
!1826 = !DISubroutineType(types: !1827)
!1827 = !{!1828, !1829}
!1828 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "&Box<[u8], alloc::alloc::Global>", baseType: !1338, size: 64, align: 64, dwarfAddressSpace: 0)
!1829 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "&ManuallyDrop<alloc::boxed::Box<[u8], alloc::alloc::Global>>", baseType: !1813, size: 64, align: 64, dwarfAddressSpace: 0)
!1830 = !{!1824}
!1831 = !DILocation(line: 151, column: 14, scope: !1825, inlinedAt: !1832)
!1832 = distinct !DILocation(line: 1062, column: 24, scope: !1801)
!1833 = !DILocation(line: 152, column: 9, scope: !1825, inlinedAt: !1832)
!1834 = !DILocation(line: 1063, column: 6, scope: !1801)
!1835 = distinct !DISubprogram(name: "into_raw<[u8], alloc::alloc::Global>", linkageName: "_ZN5alloc5boxed16Box$LT$T$C$A$GT$8into_raw17hdb3319f8adb27c3eE", scope: !1647, file: !1636, line: 936, type: !1836, scopeLine: 936, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1342, retainedNodes: !1838)
...
!1860 = distinct !DISubprogram(name: "to_vec<u8>", linkageName: "_ZN5alloc5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$6to_vec17he16d27598cce6e04E", scope: !1861, file: !1366, line: 466, type: !1352, scopeLine: 466, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !350, retainedNodes: !1862)
...
!1867 = distinct !DISubprogram(name: "to_vec_in<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$9to_vec_in17h993bf30210d38008E", scope: !1861, file: !1366, line: 489, type: !1370, scopeLine: 489, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !1868)
!1868 = !{!1869, !1870}
...
!1875 = distinct !DISubprogram(name: "to_vec<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc5slice4hack6to_vec17hbe00f9b67875a45fE", scope: !1368, file: !1366, line: 171, type: !1370, scopeLine: 171, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !1876)
!1876 = !{!1877, !1878}
...
!1883 = distinct !DISubprogram(name: "alloc_guard", linkageName: "_ZN5alloc7raw_vec11alloc_guard17hf3b3afcf1bd07e96E", scope: !22, file: !1526, line: 546, type: !1884, scopeLine: 546, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !4, retainedNodes: !1886)
...
!1895 = distinct !DISubprogram(name: "handle_reserve", linkageName: "_ZN5alloc7raw_vec14handle_reserve17h72b1ffa6ce4371dcE", scope: !22, file: !1526, line: 528, type: !1896, scopeLine: 528, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !4, retainedNodes: !1898)
!1896 = !DISubroutineType(types: !1897)
!1897 = !{null, !129}
!1898 = !{!1899, !1900}
!1899 = !DILocalVariable(name: "result", arg: 1, scope: !1895, file: !1526, line: 528, type: !129)
...
!1910 = distinct !DISubprogram(name: "{closure#0}", linkageName: "_ZN5alloc7raw_vec14handle_reserve28_$u7b$$u7b$closure$u7d$$u7d$17h5225469680ddb458E", scope: !1213, file: !1526, line: 529, type: !1911, scopeLine: 529, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !4, retainedNodes: !1913)
...
!1920 = distinct !DISubprogram(name: "allocate_in<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$11allocate_in17h18cc795a475c4153E", scope: !381, file: !1526, line: 189, type: !1921, scopeLine: 189, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !1923)
...
!1977 = distinct !DISubprogram(name: "shrink_to_fit<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$13shrink_to_fit17h0539a9151bb499d6E", scope: !381, file: !1526, line: 393, type: !1978, scopeLine: 393, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !1981)
...
!1989 = distinct !DISubprogram(name: "current_memory<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$14current_memory17h5e0a1c85a6a17d16E", scope: !381, file: !1526, line: 256, type: !1990, scopeLine: 256, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !2008)
...
!2034 = distinct !DISubprogram(name: "with_capacity_in<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$16with_capacity_in17h056650fc96f1c7d8E", scope: !381, file: !1526, line: 142, type: !2035, scopeLine: 142, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !2037)
...
!2045 = distinct !DISubprogram(name: "capacity_from_bytes<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$19capacity_from_bytes17h8ee1e5bbbd324bdaE", scope: !381, file: !1526, line: 405, type: !2046, scopeLine: 405, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !2048)
...
!2061 = distinct !DISubprogram(name: "new_in<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$6new_in17h80e1e20a4fb8b053E", scope: !381, file: !1526, line: 133, type: !2062, scopeLine: 133, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !2064)
...
!2070 = distinct !DISubprogram(name: "shrink<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$6shrink17hac1a7bc0a4df594dE", scope: !381, file: !1526, line: 467, type: !2071, scopeLine: 467, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !2073)
...
!2087 = !DILocalVariable(name: "residual", scope: !2088, file: !1526, line: 477, type: !145, align: 8)
...
!2130 = distinct !DISubprogram(name: "{closure#0}<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$6shrink28_$u7b$$u7b$closure$u7d$$u7d$17ha961cf18273ce991E", scope: !1255, file: !1526, line: 477, type: !2131, scopeLine: 477, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !2133)
...
!2141 = distinct !DISubprogram(name: "set_ptr<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$7set_ptr17h88133d18b1bea256E", scope: !381, file: !1526, line: 410, type: !2142, scopeLine: 410, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !2144)
...
!2156 = distinct !DISubprogram(name: "into_box<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8into_box17h20474ec24aa43325E", scope: !381, file: !1526, line: 174, type: !2157, scopeLine: 174, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !2159)
...
!2197 = distinct !DISubprogram(name: "allocator<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$9allocator17h4fcc1fc7fad1adefE", scope: !381, file: !1526, line: 252, type: !2198, scopeLine: 252, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !2200)
...
!2205 = distinct !DISubprogram(name: "deallocate", linkageName: "_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h1a2788c0295c25c2E", scope: !2206, file: !1546, line: 235, type: !2207, scopeLine: 235, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !4, retainedNodes: !2209)
...
!2222 = distinct !DISubprogram(name: "allocate_zeroed", linkageName: "_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$15allocate_zeroed17ha2edb85b79b89d6dE", scope: !2206, file: !1546, line: 230, type: !2223, scopeLine: 230, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !4, retainedNodes: !2225)
...
!2322 = distinct !DISubprogram(name: "deref_mut<u8, alloc::alloc::Global>", linkageName: "_ZN75_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..deref..DerefMut$GT$9deref_mut17h1c4c309e5028a8e7E", scope: !2323, file: !1395, line: 2377, type: !2324, scopeLine: 2377, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !2326)
!2323 = !DINamespace(name: "{impl#11}", scope: !1288)
...
!2333 = distinct !DISubprogram(name: "clone", linkageName: "_ZN78_$LT$alloc..collections..TryReserveErrorKind$u20$as$u20$core..clone..Clone$GT$5clone17h9383e4cb9cc74d24E", scope: !2334, file: !43, line: 79, type: !2335, scopeLine: 79, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !4, retainedNodes: !2338)
...
!2351 = distinct !DISubprogram(name: "branch<(core::alloc::layout::Layout, usize), core::alloc::layout::LayoutError>", linkageName: "_ZN79_$LT$core..result..Result$LT$T$C$E$GT$$u20$as$u20$core..ops..try_trait..Try$GT$6branch17h411038a10082808eE", scope: !2352, file: !81, line: 1902, type: !2353, scopeLine: 1902, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !182, retainedNodes: !2373)
!2352 = !DINamespace(name: "{impl#36}", scope: !28)
!2353 = !DISubroutineType(types: !2354)
!2354 = !{!2355, !170}
!2355 = !DICompositeType(tag: DW_TAG_structure_type, name: "ControlFlow<core::result::Result<core::convert::Infallible, core::alloc::layout::LayoutError>, (core::alloc::layout::Layout, usize)>", scope: !2356, file: !2, size: 192, align: 64, elements: !2358, identifier: "c4d497dd31886320b9bdf21802754aec")
!2356 = !DINamespace(name: "control_flow", scope: !2357)
!2357 = !DINamespace(name: "ops", scope: !8)
!2358 = !{!2359}
!2359 = !DICompositeType(tag: DW_TAG_variant_part, scope: !2356, file: !2, size: 192, align: 64, elements: !2360, templateParams: !2365, identifier: "c4d497dd31886320b9bdf21802754aec_variant_part", discriminator: !2372)
!2360 = !{!2361, !2368}
!2361 = !DIDerivedType(tag: DW_TAG_member, name: "Continue", scope: !2359, file: !2, baseType: !2362, size: 192, align: 64)
!2362 = !DICompositeType(tag: DW_TAG_structure_type, name: "Continue", scope: !2355, file: !2, size: 192, align: 64, elements: !2363, templateParams: !2365, identifier: "c4d497dd31886320b9bdf21802754aec::Continue")
!2363 = !{!2364}
!2364 = !DIDerivedType(tag: DW_TAG_member, name: "__0", scope: !2362, file: !2, baseType: !178, size: 192, align: 64)
!2365 = !{!2366, !2367}
!2366 = !DITemplateTypeParameter(name: "B", type: !101)
!2367 = !DITemplateTypeParameter(name: "C", type: !178)
!2368 = !DIDerivedType(tag: DW_TAG_member, name: "Break", scope: !2359, file: !2, baseType: !2369, size: 192, align: 64, extraData: i64 0)
!2369 = !DICompositeType(tag: DW_TAG_structure_type, name: "Break", scope: !2355, file: !2, size: 192, align: 64, elements: !2370, templateParams: !2365, identifier: "c4d497dd31886320b9bdf21802754aec::Break")
!2370 = !{!2371}
!2371 = !DIDerivedType(tag: DW_TAG_member, name: "__0", scope: !2369, file: !2, baseType: !101, align: 8)
!2372 = !DIDerivedType(tag: DW_TAG_member, scope: !2356, file: !2, baseType: !74, size: 64, align: 64, offset: 64, flags: DIFlagArtificial)
!2373 = !{!2374, !2375, !2377}
!2374 = !DILocalVariable(name: "self", arg: 1, scope: !2351, file: !81, line: 1902, type: !170)
!2375 = !DILocalVariable(name: "v", scope: !2376, file: !81, line: 1904, type: !178, align: 8)
...
!2380 = !DILocation(line: 1904, column: 16, scope: !2376)
!2381 = !DILocation(line: 1905, column: 17, scope: !2378)
!2382 = !DILocation(line: 1903, column: 15, scope: !2351)
!2383 = !DILocation(line: 1903, column: 9, scope: !2351)
!2384 = !DILocation(line: 1904, column: 16, scope: !2351)
!2385 = !DILocation(line: 1904, column: 44, scope: !2376)
!2386 = !DILocation(line: 1904, column: 22, scope: !2376)
!2387 = !DILocation(line: 1904, column: 45, scope: !2351)
...
!2392 = distinct !DISubprogram(name: "branch<usize, core::alloc::layout::LayoutError>", linkageName: "_ZN79_$LT$core..result..Result$LT$T$C$E$GT$$u20$as$u20$core..ops..try_trait..Try$GT$6branch17h74f3caba8a20a7f4E", scope: !2352, file: !81, line: 1902, type: !2393, scopeLine: 1902, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1121, retainedNodes: !2410)
!2393 = !DISubroutineType(types: !2394)
!2394 = !{!2395, !1113}
!2395 = !DICompositeType(tag: DW_TAG_structure_type, name: "ControlFlow<core::result::Result<core::convert::Infallible, core::alloc::layout::LayoutError>, usize>", scope: !2356, file: !2, size: 128, align: 64, elements: !2396, identifier: "9684fe477d2dc57caff34cda2f8fb57b")
!2396 = !{!2397}
!2397 = !DICompositeType(tag: DW_TAG_variant_part, scope: !2356, file: !2, size: 128, align: 64, elements: !2398, templateParams: !2403, identifier: "9684fe477d2dc57caff34cda2f8fb57b_variant_part", discriminator: !2409)
!2398 = !{!2399, !2405}
!2399 = !DIDerivedType(tag: DW_TAG_member, name: "Continue", scope: !2397, file: !2, baseType: !2400, size: 128, align: 64, extraData: i64 0)
!2400 = !DICompositeType(tag: DW_TAG_structure_type, name: "Continue", scope: !2395, file: !2, size: 128, align: 64, elements: !2401, templateParams: !2403, identifier: "9684fe477d2dc57caff34cda2f8fb57b::Continue")
!2401 = !{!2402}
!2402 = !DIDerivedType(tag: DW_TAG_member, name: "__0", scope: !2400, file: !2, baseType: !64, size: 64, align: 64, offset: 64)
!2403 = !{!2366, !2404}
!2404 = !DITemplateTypeParameter(name: "C", type: !64)
!2405 = !DIDerivedType(tag: DW_TAG_member, name: "Break", scope: !2397, file: !2, baseType: !2406, size: 128, align: 64, extraData: i64 1)
!2406 = !DICompositeType(tag: DW_TAG_structure_type, name: "Break", scope: !2395, file: !2, size: 128, align: 64, elements: !2407, templateParams: !2403, identifier: "9684fe477d2dc57caff34cda2f8fb57b::Break")
!2407 = !{!2408}
!2408 = !DIDerivedType(tag: DW_TAG_member, name: "__0", scope: !2406, file: !2, baseType: !101, align: 8, offset: 64)
!2409 = !DIDerivedType(tag: DW_TAG_member, scope: !2356, file: !2, baseType: !74, size: 64, align: 64, flags: DIFlagArtificial)
!2410 = !{!2411, !2412, !2414}
!2411 = !DILocalVariable(name: "self", arg: 1, scope: !2392, file: !81, line: 1902, type: !1113)
!2412 = !DILocalVariable(name: "v", scope: !2413, file: !81, line: 1904, type: !64, align: 8)
!2413 = distinct !DILexicalBlock(scope: !2392, file: !81, line: 1904, column: 13)
!2414 = !DILocalVariable(name: "e", scope: !2415, file: !81, line: 1905, type: !5, align: 1)
!2415 = distinct !DILexicalBlock(scope: !2392, file: !81, line: 1905, column: 13)
!2416 = !DILocation(line: 1902, column: 15, scope: !2392)
!2417 = !DILocation(line: 1905, column: 17, scope: !2415)
!2418 = !DILocation(line: 1903, column: 15, scope: !2392)
!2419 = !DILocation(line: 1903, column: 9, scope: !2392)
!2420 = !DILocation(line: 1904, column: 16, scope: !2392)
!2421 = !DILocation(line: 1904, column: 16, scope: !2413)
!2422 = !DILocation(line: 1904, column: 22, scope: !2413)
!2423 = !DILocation(line: 1904, column: 45, scope: !2392)
!2424 = !DILocation(line: 1905, column: 42, scope: !2415)
!2425 = !DILocation(line: 1905, column: 23, scope: !2415)
!2426 = !DILocation(line: 1905, column: 48, scope: !2392)
!2427 = !DILocation(line: 1907, column: 6, scope: !2392)
!2428 = distinct !DISubprogram(name: "branch<core::ptr::non_null::NonNull<[u8]>, alloc::collections::TryReserveErrorKind>", linkageName: "_ZN79_$LT$core..result..Result$LT$T$C$E$GT$$u20$as$u20$core..ops..try_trait..Try$GT$6branch17h923cf208a5a576b6E", scope: !2352, file: !81, line: 1902, type: !2429, scopeLine: 1902, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1249, retainedNodes: !2446)
!2429 = !DISubroutineType(types: !2430)
!2430 = !{!2431, !1241}
!2431 = !DICompositeType(tag: DW_TAG_structure_type, name: "ControlFlow<core::result::Result<core::convert::Infallible, alloc::collections::TryReserveErrorKind>, core::ptr::non_null::NonNull<[u8]>>", scope: !2356, file: !2, size: 192, align: 64, elements: !2432, identifier: "54d0fa518e9acf4e7afe29b5d0d70220")
!2432 = !{!2433}
!2433 = !DICompositeType(tag: DW_TAG_variant_part, scope: !2356, file: !2, size: 192, align: 64, elements: !2434, templateParams: !2439, identifier: "54d0fa518e9acf4e7afe29b5d0d70220_variant_part", discriminator: !2409)
!2434 = !{!2435, !2442}
!2435 = !DIDerivedType(tag: DW_TAG_member, name: "Continue", scope: !2433, file: !2, baseType: !2436, size: 192, align: 64, extraData: i64 0)
!2436 = !DICompositeType(tag: DW_TAG_structure_type, name: "Continue", scope: !2431, file: !2, size: 192, align: 64, elements: !2437, templateParams: !2439, identifier: "54d0fa518e9acf4e7afe29b5d0d70220::Continue")
!2437 = !{!2438}
!2438 = !DIDerivedType(tag: DW_TAG_member, name: "__0", scope: !2436, file: !2, baseType: !209, size: 128, align: 64, offset: 64)
!2439 = !{!2440, !2441}
!2440 = !DITemplateTypeParameter(name: "B", type: !145)
!2441 = !DITemplateTypeParameter(name: "C", type: !209)
!2442 = !DIDerivedType(tag: DW_TAG_member, name: "Break", scope: !2433, file: !2, baseType: !2443, size: 192, align: 64, extraData: i64 1)
!2443 = !DICompositeType(tag: DW_TAG_structure_type, name: "Break", scope: !2431, file: !2, size: 192, align: 64, elements: !2444, templateParams: !2439, identifier: "54d0fa518e9acf4e7afe29b5d0d70220::Break")
!2444 = !{!2445}
!2445 = !DIDerivedType(tag: DW_TAG_member, name: "__0", scope: !2443, file: !2, baseType: !145, size: 128, align: 64, offset: 64)
!2446 = !{!2447, !2448, !2450}
!2447 = !DILocalVariable(name: "self", arg: 1, scope: !2428, file: !81, line: 1902, type: !1241)
!2448 = !DILocalVariable(name: "v", scope: !2449, file: !81, line: 1904, type: !209, align: 8)
!2449 = distinct !DILexicalBlock(scope: !2428, file: !81, line: 1904, column: 13)
!2450 = !DILocalVariable(name: "e", scope: !2451, file: !81, line: 1905, type: !51, align: 8)
!2451 = distinct !DILexicalBlock(scope: !2428, file: !81, line: 1905, column: 13)
!2452 = !DILocation(line: 1902, column: 15, scope: !2428)
!2453 = !DILocation(line: 1903, column: 15, scope: !2428)
!2454 = !DILocation(line: 1903, column: 9, scope: !2428)
!2455 = !DILocation(line: 1904, column: 16, scope: !2428)
!2456 = !DILocation(line: 1904, column: 16, scope: !2449)
!2457 = !DILocation(line: 1904, column: 22, scope: !2449)
!2458 = !DILocation(line: 1904, column: 45, scope: !2428)
!2459 = !DILocation(line: 1905, column: 17, scope: !2428)
!2460 = !DILocation(line: 1905, column: 17, scope: !2451)
!2461 = !DILocation(line: 1905, column: 42, scope: !2451)
!2462 = !DILocation(line: 1905, column: 23, scope: !2451)
!2463 = !DILocation(line: 1905, column: 48, scope: !2428)
!2464 = !DILocation(line: 1907, column: 6, scope: !2428)
...
!2469 = !{!2470}
!2470 = !DICompositeType(tag: DW_TAG_variant_part, scope: !2356, file: !2, size: 128, align: 64, elements: !2471, templateParams: !2476, identifier: "d2d133e2ff29a67bdebbee54f9f5e8c7_variant_part", discriminator: !2409)
!2471 = !{!2472, !2478}
...
!2504 = !{!2505}
!2505 = !DICompositeType(tag: DW_TAG_variant_part, scope: !2356, file: !2, size: 64, align: 64, elements: !2506, templateParams: !2511, identifier: "aba8f8de5c30a5a713a7e2dd6a715755_variant_part", discriminator: !2409)
!2506 = !{!2507, !2513}
...
!2542 = distinct !DISubprogram(name: "into_iter<u8, alloc::alloc::Global>", linkageName: "_ZN90_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..iter..traits..collect..IntoIterator$GT$9into_iter17hc4fab68336198f29E", scope: !2543, file: !1395, line: 2509, type: !2544, scopeLine: 2509, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !395, retainedNodes: !2555)
!2543 = !DINamespace(name: "{impl#19}", scope: !1288)
!2544 = !DISubroutineType(types: !2545)
!2545 = !{!2546, !1287}
!2546 = !DICompositeType(tag: DW_TAG_structure_type, name: "IntoIter<u8, alloc::alloc::Global>", scope: !2547, file: !2, size: 256, align: 64, elements: !2548, templateParams: !395, identifier: "ab1789ebf3f77320d26a136641cfa7f8")
!2547 = !DINamespace(name: "into_iter", scope: !1288)
...
!2556 = !DILocalVariable(name: "self", arg: 1, scope: !2542, file: !1395, line: 2509, type: !1287)
...
!2572 = !{!2573}
!2573 = distinct !{!2573, !2574, !"_ZN4core3mem13manually_drop21ManuallyDrop$LT$T$GT$3new17hbb62344b8ee4f8baE: argument 0"}
!2574 = distinct !{!2574, !"_ZN4core3mem13manually_drop21ManuallyDrop$LT$T$GT$3new17hbb62344b8ee4f8baE"}
!2575 = !DILocation(line: 2511, column: 26, scope: !2542)
!2576 = !{!2577}
!2577 = distinct !{!2577, !2574, !"_ZN4core3mem13manually_drop21ManuallyDrop$LT$T$GT$3new17hbb62344b8ee4f8baE: %value"}
...
!2588 = distinct !DISubprogram(name: "deref_mut<alloc::vec::Vec<u8, alloc::alloc::Global>>", linkageName: "_ZN94_$LT$core..mem..manually_drop..ManuallyDrop$LT$T$GT$$u20$as$u20$core..ops..deref..DerefMut$GT$9deref_mut17h26bc559a3071638bE", scope: !2589, file: !455, line: 159, type: !2590, scopeLine: 159, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1294, retainedNodes: !2593)
...
!2649 = !DIFile(filename: "/home/osboxes/.cargo/registry/src/github.com-1ecc6299db9ec823/serde_bytes-0.11.5/src/bytes.rs", directory: "/home/osboxes/.cargo/registry/src/github.com-1ecc6299db9ec823/serde_bytes-0.11.5", checksumkind: CSK_MD5, checksum: "3625867db0480e0682d171fc52013d2f")
...
!2721 = distinct !DISubprogram(name: "to_owned", linkageName: "_ZN68_$LT$serde_bytes..bytes..Bytes$u20$as$u20$alloc..borrow..ToOwned$GT$8to_owned17hada1357dcbf85eefE", scope: !2722, file: !2649, line: 88, type: !2723, scopeLine: 88, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !11, templateParams: !4, retainedNodes: !2729)
...
!2727 = !{!2728}
!2728 = !DIDerivedType(tag: DW_TAG_member, name: "bytes", scope: !2725, file: !2, baseType: !1287, size: 192, align: 64)
!2729 = !{!2730}
...
!2735 = distinct !DISubprogram(name: "from", linkageName: "_ZN11serde_bytes5bytes145_$LT$impl$u20$core..convert..From$LT$alloc..boxed..Box$LT$$u5b$u8$u5d$$GT$$GT$$u20$for$u20$alloc..boxed..Box$LT$serde_bytes..bytes..Bytes$GT$$GT$4from17hf9b8a7ff9281f9d3E", scope: !2736, file: !2649, line: 95, type: !1335, scopeLine: 95, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !11, templateParams: !4, retainedNodes: !2737)
...
!2749 = distinct !DISubprogram(name: "default", linkageName: "_ZN11serde_bytes5bytes103_$LT$impl$u20$core..default..Default$u20$for$u20$alloc..boxed..Box$LT$serde_bytes..bytes..Bytes$GT$$GT$7default17h7b58ebffddbc3e2bE", scope: !2750, file: !2649, line: 108, type: !2751, scopeLine: 108, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !11, templateParams: !4, retainedNodes: !4)
...
!2796 = !DIFile(filename: "/home/osboxes/.cargo/registry/src/github.com-1ecc6299db9ec823/serde_bytes-0.11.5/src/de.rs", directory: "/home/osboxes/.cargo/registry/src/github.com-1ecc6299db9ec823/serde_bytes-0.11.5", checksumkind: CSK_MD5, checksum: "0cf4963a5cc2a38e254fce3287af79f6")
...
!2813 = !DIFile(filename: "/home/osboxes/.cargo/registry/src/github.com-1ecc6299db9ec823/serde_bytes-0.11.5/src/bytebuf.rs", directory: "/home/osboxes/.cargo/registry/src/github.com-1ecc6299db9ec823/serde_bytes-0.11.5", checksumkind: CSK_MD5, checksum: "8f9846521da299cd517d0203548fb7de")
...
!2828 = distinct !DISubprogram(name: "from<alloc::vec::Vec<u8, alloc::alloc::Global>>", linkageName: "_ZN11serde_bytes7bytebuf7ByteBuf4from17h1e01dc26e8f4f087E", scope: !2725, file: !2813, line: 60, type: !2829, scopeLine: 60, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !1294, retainedNodes: !2831)
!2829 = !DISubroutineType(types: !2830)
!2830 = !{!2725, !1287}
!2831 = !{!2832}
!2832 = !DILocalVariable(name: "bytes", arg: 1, scope: !2828, file: !2813, line: 60, type: !1287)
...
!2837 = distinct !DISubprogram(name: "from<&[u8]>", linkageName: "_ZN11serde_bytes7bytebuf7ByteBuf4from17hb09e2a4d0cb09b4cE", scope: !2725, file: !2813, line: 60, type: !2838, scopeLine: 60, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !11, templateParams: !2842, retainedNodes: !2840)
!2838 = !DISubroutineType(types: !2839)
!2839 = !{!2725, !1354}
!2840 = !{!2841}
!2841 = !DILocalVariable(name: "bytes", arg: 1, scope: !2837, file: !2813, line: 60, type: !1354)
!2842 = !{!1361}
...
!2847 = distinct !DISubprogram(name: "into_vec", linkageName: "_ZN11serde_bytes7bytebuf7ByteBuf8into_vec17h5a9d435eaa6faebfE", scope: !2725, file: !2813, line: 67, type: !2848, scopeLine: 67, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !11, templateParams: !4, retainedNodes: !2850)
...
!2855 = distinct !DISubprogram(name: "into_boxed_bytes", linkageName: "_ZN11serde_bytes7bytebuf7ByteBuf16into_boxed_bytes17h9e58de886c36c601E", scope: !2725, file: !2813, line: 72, type: !2856, scopeLine: 72, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !11, templateParams: !4, retainedNodes: !2858)
...
!2863 = distinct !DISubprogram(name: "into_boxed_slice", linkageName: "_ZN11serde_bytes7bytebuf7ByteBuf16into_boxed_slice17h127efb782d053613E", scope: !2725, file: !2813, line: 79, type: !2864, scopeLine: 79, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !11, templateParams: !4, retainedNodes: !2866)
...
!2871 = distinct !DISubprogram(name: "into_iter", linkageName: "_ZN11serde_bytes7bytebuf7ByteBuf9into_iter17h71c080c331120ea8E", scope: !2725, file: !2813, line: 85, type: !2872, scopeLine: 85, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !11, templateParams: !4, retainedNodes: !2874)
