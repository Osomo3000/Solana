; ModuleID = 'bytemuck.4929c2fb-cgu.0'
source_filename = "bytemuck.4929c2fb-cgu.0"
...
@alloc169 = private unnamed_addr constant <{ [12 x i8] }> <{ [12 x i8] c"invalid args" }>, align 1
@alloc170 = private unnamed_addr constant <{ [74 x i8] }> <{ [74 x i8] c"/home/runner/work/bpf-tools/bpf-tools/out/rust/library/core/src/fmt/mod.rs" }>, align 1
@alloc171 = private unnamed_addr constant <{ i8*, [16 x i8] }> <{ i8* getelementptr inbounds (<{ [74 x i8] }>, <{ [74 x i8] }>* @alloc170, i32 0, i32 0, i32 0), [16 x i8] c"J\00\00\00\00\00\00\00c\01\00\00\0D\00\00\00" }>, align 8
@alloc167 = private unnamed_addr constant <{ [0 x i8] }> zeroinitializer, align 1
@alloc152 = private unnamed_addr constant <{ [1 x i8] }> <{ [1 x i8] c">" }>, align 1
@alloc151 = private unnamed_addr constant <{ i8*, [8 x i8], i8*, [8 x i8] }> <{ i8* getelementptr inbounds (<{ [0 x i8] }>, <{ [0 x i8] }>* @alloc167, i32 0, i32 0, i32 0), [8 x i8] zeroinitializer, i8* getelementptr inbounds (<{ [1 x i8] }>, <{ [1 x i8] }>* @alloc152, i32 0, i32 0, i32 0), [8 x i8] c"\01\00\00\00\00\00\00\00" }>, align 8
@alloc172 = private unnamed_addr constant <{ [79 x i8] }> <{ [79 x i8] c"/root/.cargo/registry/src/github.com-1ecc6299db9ec823/bytemuck-1.8.0/src/lib.rs" }>, align 1
@alloc173 = private unnamed_addr constant <{ i8*, [16 x i8] }> <{ i8* getelementptr inbounds (<{ [79 x i8] }>, <{ [79 x i8] }>* @alloc172, i32 0, i32 0, i32 0), [16 x i8] c"O\00\00\00\00\00\00\00y\00\00\00\03\00\00\00" }>, align 8
@alloc168 = private unnamed_addr constant <{ i8*, [8 x i8] }> <{ i8* getelementptr inbounds (<{ [0 x i8] }>, <{ [0 x i8] }>* @alloc167, i32 0, i32 0, i32 0), [8 x i8] zeroinitializer }>, align 8
@alloc174 = private unnamed_addr constant <{ [17 x i8] }> <{ [17 x i8] c"AlignmentMismatch" }>, align 1
@alloc175 = private unnamed_addr constant <{ [12 x i8] }> <{ [12 x i8] c"SizeMismatch" }>, align 1
@alloc176 = private unnamed_addr constant <{ [24 x i8] }> <{ [24 x i8] c"OutputSliceWouldHaveSlop" }>, align 1
@alloc177 = private unnamed_addr constant <{ [40 x i8] }> <{ [40 x i8] c"TargetAlignmentGreaterAndInputNotAligned" }>, align 1

; <&T as core::fmt::Debug>::fmt
; Function Attrs: nounwind
define zeroext i1 @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17ha5b095f03ae037f0E"(i8** align 8 dereferenceable(8) %self, %"core::fmt::Formatter"* align 8 dereferenceable(64) %f) unnamed_addr #0 !dbg !29 {
start:
...
; call <bytemuck::PodCastError as core::fmt::Debug>::fmt
  %0 = call zeroext i1 @"_ZN59_$LT$bytemuck..PodCastError$u20$as$u20$core..fmt..Debug$GT$3fmt17h4d3a0af3cefe676aE"(i8* align 1 dereferenceable(1) %_4, %"core::fmt::Formatter"* align 8 dereferenceable(64) %f), !dbg !81
  br label %bb1, !dbg !81
...
; Function Attrs: nounwind
define zeroext i1 @"_ZN44_$LT$$RF$T$u20$as$u20$core..fmt..Display$GT$3fmt17hc15fce607efa4bfcE"({ [0 x i8]*, i64 }* align 8 dereferenceable(16) %self, %"core::fmt::Formatter"* align 8 dereferenceable(64) %f) unnamed_addr #0 !dbg !83 {
start:
  %f.dbg.spill = alloca %"core::fmt::Formatter"*, align 8
...
; Function Attrs: nounwind
define { i8*, i64* } @_ZN4core3fmt10ArgumentV13new17h77c67463c2dcfbbaE(i8* align 1 dereferenceable(1) %x, i1 (i8*, %"core::fmt::Formatter"*)* nonnull %f) unnamed_addr #0 !dbg !107 {
start:
...
; core::fmt::ArgumentV1::new
; Function Attrs: nounwind
define { i8*, i64* } @_ZN4core3fmt10ArgumentV13new17hb1c24beec224ea46E({ [0 x i8]*, i64 }* align 8 dereferenceable(16) %x, i1 ({ [0 x i8]*, i64 }*, %"core::fmt::Formatter"*)* nonnull %f) unnamed_addr #0 !dbg !131 {
start:
  %0 = alloca %"core::fmt::Opaque"*, align 8
  %1 = alloca i1 (%"core::fmt::Opaque"*, %"core::fmt::Formatter"*)*, align 8
...
; core::fmt::ArgumentV1::new
; Function Attrs: nounwind
define { i8*, i64* } @_ZN4core3fmt10ArgumentV13new17hbac1524de3b3ccbcE(i8** align 8 dereferenceable(8) %x, i1 (i8**, %"core::fmt::Formatter"*)* nonnull %f) unnamed_addr #0 !dbg !146 {
start:
  %0 = alloca %"core::fmt::Opaque"*, align 8
  %1 = alloca i1 (%"core::fmt::Opaque"*, %"core::fmt::Formatter"*)*, align 8
  %f.dbg.spill = alloca i1 (i8**, %"core::fmt::Formatter"*)*, align 8
...
define internal void @_ZN4core3fmt9Arguments6new_v117h1e71beabbc4f2165E(%"core::fmt::Arguments"* noalias nocapture sret(%"core::fmt::Arguments") dereferenceable(48) %0, [0 x { [0 x i8]*, i64 }]* nonnull align 8 %pieces.0, i64 %pieces.1, [0 x { i8*, i64* }]* nonnull align 8 %args.0, i64 %args.1) unnamed_addr #1 !dbg !161 {
start:
...
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17h560e3e4b7752857aE([0 x i8]* nonnull align 1 bitcast (<{ [12 x i8] }>* @alloc169 to [0 x i8]*), i64 12, %"core::panic::Location"* align 8 dereferenceable(24) bitcast (<{ i8*, [16 x i8] }>* @alloc171 to %"core::panic::Location"*)), !dbg !234
  unreachable, !dbg !234
}

; bytemuck::something_went_wrong
; Function Attrs: cold noinline noreturn nounwind
define void @_ZN8bytemuck20something_went_wrong17h75cf8b247161c8c4E([0 x i8]* nonnull align 1 %0, i64 %1, i8 %2) unnamed_addr #2 !dbg !235 {
start:
...
; call core::fmt::ArgumentV1::new
  %9 = call { i8*, i64* } @_ZN4core3fmt10ArgumentV13new17hb1c24beec224ea46E({ [0 x i8]*, i64 }* align 8 dereferenceable(16) %arg0, i1 ({ [0 x i8]*, i64 }*, %"core::fmt::Formatter"*)* nonnull @"_ZN44_$LT$$RF$T$u20$as$u20$core..fmt..Display$GT$3fmt17hc15fce607efa4bfcE"), !dbg !257
...
bb1:                                              ; preds = %start
; call core::fmt::ArgumentV1::new
  %10 = call { i8*, i64* } @_ZN4core3fmt10ArgumentV13new17h77c67463c2dcfbbaE(i8* align 1 dereferenceable(1) %arg1, i1 (i8*, %"core::fmt::Formatter"*)* nonnull @"_ZN59_$LT$bytemuck..PodCastError$u20$as$u20$core..fmt..Debug$GT$3fmt17h4d3a0af3cefe676aE"), !dbg !257
...
; call core::fmt::Arguments::new_v1
  call void @_ZN4core3fmt9Arguments6new_v117h1e71beabbc4f2165E(%"core::fmt::Arguments"* noalias nocapture sret(%"core::fmt::Arguments") dereferenceable(48) %_3, [0 x { [0 x i8]*, i64 }]* nonnull align 8 bitcast (<{ i8*, [8 x i8], i8*, [8 x i8] }>* @alloc151 to [0 x { [0 x i8]*, i64 }]*), i64 2, [0 x { i8*, i64* }]* nonnull align 8 %_20.0, i64 2), !dbg !258
  br label %bb3, !dbg !258

bb3:                                              ; preds = %bb2
; call core::panicking::panic_fmt
  call void @_ZN4core9panicking9panic_fmt17hce311da8346422ccE(%"core::fmt::Arguments"* noalias nocapture dereferenceable(48) %_3, %"core::panic::Location"* align 8 dereferenceable(24) bitcast (<{ i8*, [16 x i8] }>* @alloc173 to %"core::panic::Location"*)), !dbg !256
  unreachable, !dbg !256
}

; <bytemuck::PodCastError as core::fmt::Display>::fmt
; Function Attrs: nounwind
define zeroext i1 @"_ZN61_$LT$bytemuck..PodCastError$u20$as$u20$core..fmt..Display$GT$3fmt17h0cf16895c8d8a37aE"(i8* align 1 dereferenceable(1) %0, %"core::fmt::Formatter"* align 8 dereferenceable(64) %f) unnamed_addr #0 !dbg !259 {
start:
...
; call core::fmt::ArgumentV1::new
  %3 = call { i8*, i64* } @_ZN4core3fmt10ArgumentV13new17hbac1524de3b3ccbcE(i8** align 8 dereferenceable(8) %arg0, i1 (i8**, %"core::fmt::Formatter"*)* nonnull @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17ha5b095f03ae037f0E"), !dbg !278
...
; call core::fmt::Arguments::new_v1
  call void @_ZN4core3fmt9Arguments6new_v117h1e71beabbc4f2165E(%"core::fmt::Arguments"* noalias nocapture sret(%"core::fmt::Arguments") dereferenceable(48) %_4, [0 x { [0 x i8]*, i64 }]* nonnull align 8 bitcast (<{ i8*, [8 x i8] }>* @alloc168 to [0 x { [0 x i8]*, i64 }]*), i64 1, [0 x { i8*, i64* }]* nonnull align 8 %_16.0, i64 1), !dbg !279
...
; Function Attrs: nounwind
define zeroext i1 @"_ZN59_$LT$bytemuck..PodCastError$u20$as$u20$core..fmt..Debug$GT$3fmt17h4d3a0af3cefe676aE"(i8* align 1 dereferenceable(1) %self, %"core::fmt::Formatter"* align 8 dereferenceable(64) %f) unnamed_addr #0 !dbg !281 {
start:
...
; call core::fmt::Formatter::debug_tuple
  call void @_ZN4core3fmt9Formatter11debug_tuple17h8b0c4b037c736595E(%"core::fmt::DebugTuple"* noalias nocapture sret(%"core::fmt::DebugTuple") dereferenceable(24) %_7, %"core::fmt::Formatter"* align 8 dereferenceable(64) %f, [0 x i8]* nonnull align 1 bitcast (<{ [40 x i8] }>* @alloc177 to [0 x i8]*), i64 40), !dbg !303
  br label %bb4, !dbg !303

bb5:                                              ; preds = %start
; call core::fmt::Formatter::debug_tuple
  call void @_ZN4core3fmt9Formatter11debug_tuple17h8b0c4b037c736595E(%"core::fmt::DebugTuple"* noalias nocapture sret(%"core::fmt::DebugTuple") dereferenceable(24) %_13, %"core::fmt::Formatter"* align 8 dereferenceable(64) %f, [0 x i8]* nonnull align 1 bitcast (<{ [24 x i8] }>* @alloc176 to [0 x i8]*), i64 24), !dbg !303
  br label %bb6, !dbg !303

bb7:                                              ; preds = %start
; call core::fmt::Formatter::debug_tuple
  call void @_ZN4core3fmt9Formatter11debug_tuple17h8b0c4b037c736595E(%"core::fmt::DebugTuple"* noalias nocapture sret(%"core::fmt::DebugTuple") dereferenceable(24) %_19, %"core::fmt::Formatter"* align 8 dereferenceable(64) %f, [0 x i8]* nonnull align 1 bitcast (<{ [12 x i8] }>* @alloc175 to [0 x i8]*), i64 12), !dbg !303
  br label %bb8, !dbg !303

bb1:                                              ; preds = %start
; call core::fmt::Formatter::debug_tuple
  call void @_ZN4core3fmt9Formatter11debug_tuple17h8b0c4b037c736595E(%"core::fmt::DebugTuple"* noalias nocapture sret(%"core::fmt::DebugTuple") dereferenceable(24) %_25, %"core::fmt::Formatter"* align 8 dereferenceable(64) %f, [0 x i8]* nonnull align 1 bitcast (<{ [17 x i8] }>* @alloc174 to [0 x i8]*), i64 17), !dbg !303
...
!3 = !DIFile(filename: "/root/.cargo/registry/src/github.com-1ecc6299db9ec823/bytemuck-1.8.0/src/lib.rs", directory: "/root/.cargo/registry/src/github.com-1ecc6299db9ec823/bytemuck-1.8.0")
!4 = !{!5, !13, !20}
...
!29 = distinct !DISubprogram(name: "fmt<bytemuck::PodCastError>", linkageName: "_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17ha5b095f03ae037f0E", scope: !31, file: !30, line: 2088, type: !32, scopeLine: 2088, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !76, retainedNodes: !73)
...
!83 = distinct !DISubprogram(name: "fmt<str>", linkageName: "_ZN44_$LT$$RF$T$u20$as$u20$core..fmt..Display$GT$3fmt17hc15fce607efa4bfcE", scope: !84, file: !30, line: 2088, type: !85, scopeLine: 2088, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !96, retainedNodes: !93)
...
!107 = distinct !DISubprogram(name: "new<bytemuck::PodCastError>", linkageName: "_ZN4core3fmt10ArgumentV13new17h77c67463c2dcfbbaE", scope: !108, file: !30, line: 302, type: !117, scopeLine: 302, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !76, retainedNodes: !122)
...
!131 = distinct !DISubprogram(name: "new<&str>", linkageName: "_ZN4core3fmt10ArgumentV13new17hb1c24beec224ea46E", scope: !108, file: !30, line: 302, type: !132, scopeLine: 302, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !138, retainedNodes: !135)
...
!146 = distinct !DISubprogram(name: "new<&bytemuck::PodCastError>", linkageName: "_ZN4core3fmt10ArgumentV13new17hbac1524de3b3ccbcE", scope: !108, file: !30, line: 302, type: !147, scopeLine: 302, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !153, retainedNodes: !150)
...
!161 = distinct !DISubprogram(name: "new_v1", linkageName: "_ZN4core3fmt9Arguments6new_v117h1e71beabbc4f2165E", scope: !162, file: !30, line: 350, type: !220, scopeLine: 350, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !52, retainedNodes: !222)
...
!235 = distinct !DISubprogram(name: "something_went_wrong", linkageName: "_ZN8bytemuck20something_went_wrong17h75cf8b247161c8c4E", scope: !14, file: !236, line: 116, type: !237, scopeLine: 116, flags: DIFlagPrototyped | DIFlagNoReturn, spFlags: DISPFlagDefinition, unit: !2, templateParams: !52, retainedNodes: !239)
!236 = !DIFile(filename: "/root/.cargo/registry/src/github.com-1ecc6299db9ec823/bytemuck-1.8.0/src/lib.rs", directory: "/root/.cargo/registry/src/github.com-1ecc6299db9ec823/bytemuck-1.8.0", checksumkind: CSK_MD5, checksum: "7ddf3e1dd41eb4f0802ad8b5c3073c1f")
!237 = !DISubroutineType(types: !238)
!238 = !{null, !88, !13}
!239 = !{!240, !241, !242, !246, !247}
!240 = !DILocalVariable(name: "_src", arg: 1, scope: !235, file: !236, line: 116, type: !88)
!241 = !DILocalVariable(name: "_err", arg: 2, scope: !235, file: !236, line: 116, type: !13)
!242 = !DILocalVariable(name: "arg0", scope: !243, file: !236, line: 121, type: !87, align: 8)
...
!246 = !DILocalVariable(name: "arg1", scope: !243, file: !236, line: 121, type: !35, align: 8)
!247 = !DILocalVariable(name: "args", scope: !248, file: !236, line: 121, type: !250, align: 8)
...
!254 = !DILocation(line: 116, column: 25, scope: !235)
!255 = !DILocation(line: 116, column: 37, scope: !235)
!256 = !DILocation(line: 121, column: 3, scope: !235)
!257 = !DILocation(line: 121, column: 3, scope: !243)
!258 = !DILocation(line: 121, column: 3, scope: !248)
!259 = distinct !DISubprogram(name: "fmt", linkageName: "_ZN61_$LT$bytemuck..PodCastError$u20$as$u20$core..fmt..Display$GT$3fmt17h0cf16895c8d8a37aE", scope: !260, file: !236, line: 274, type: !120, scopeLine: 274, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, templateParams: !52, retainedNodes: !261)
!260 = !DINamespace(name: "{impl#0}", scope: !14)
!261 = !{!262, !263, !264, !268}
!262 = !DILocalVariable(name: "self", arg: 1, scope: !259, file: !236, line: 274, type: !35)
!263 = !DILocalVariable(name: "f", arg: 2, scope: !259, file: !236, line: 274, type: !36)
!264 = !DILocalVariable(name: "arg0", scope: !265, file: !236, line: 275, type: !34, align: 8)
...
!268 = !DILocalVariable(name: "args", scope: !269, file: !236, line: 275, type: !271, align: 8)
...
!275 = !DILocation(line: 274, column: 10, scope: !259)
!276 = !DILocation(line: 274, column: 17, scope: !259)
!277 = !DILocation(line: 275, column: 5, scope: !259)
!278 = !DILocation(line: 275, column: 5, scope: !265)
!279 = !DILocation(line: 275, column: 5, scope: !269)
!280 = !DILocation(line: 276, column: 4, scope: !259)
!281 = distinct !DISubprogram(name: "fmt", linkageName: "_ZN59_$LT$bytemuck..PodCastError$u20$as$u20$core..fmt..Debug$GT$3fmt17h4d3a0af3cefe676aE", scope: !282, file: !236, line: 251, type: !120, scopeLine: 251, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, templateParams: !52, retainedNodes: !283)
!282 = !DINamespace(name: "{impl#1}", scope: !14)
!283 = !{!284, !285, !286, !297, !299, !301}
!284 = !DILocalVariable(name: "self", arg: 1, scope: !281, file: !236, line: 251, type: !35)
!285 = !DILocalVariable(name: "f", arg: 2, scope: !281, file: !236, line: 251, type: !36)
!286 = !DILocalVariable(name: "debug_trait_builder", scope: !287, file: !236, line: 251, type: !288, align: 8)
!287 = distinct !DILexicalBlock(scope: !281, file: !236, line: 251, column: 10)
...
!297 = !DILocalVariable(name: "debug_trait_builder", scope: !298, file: !236, line: 251, type: !288, align: 8)
!298 = distinct !DILexicalBlock(scope: !281, file: !236, line: 251, column: 10)
!299 = !DILocalVariable(name: "debug_trait_builder", scope: !300, file: !236, line: 251, type: !288, align: 8)
!300 = distinct !DILexicalBlock(scope: !281, file: !236, line: 251, column: 10)
!301 = !DILocalVariable(name: "debug_trait_builder", scope: !302, file: !236, line: 251, type: !288, align: 8)
!302 = distinct !DILexicalBlock(scope: !281, file: !236, line: 251, column: 10)
!303 = !DILocation(line: 251, column: 10, scope: !281)
!304 = !{i8 0, i8 4}
!305 = !DILocation(line: 251, column: 10, scope: !302)
!306 = !DILocation(line: 251, column: 15, scope: !281)
!307 = !DILocation(line: 251, column: 10, scope: !300)
!308 = !DILocation(line: 251, column: 10, scope: !298)
!309 = !DILocation(line: 251, column: 10, scope: !287)
