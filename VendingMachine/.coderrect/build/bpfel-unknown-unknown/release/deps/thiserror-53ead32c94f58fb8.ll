...
define internal { %"std::ffi::OsStr"*, i64 } @"_ZN105_$LT$std..ffi..os_str..OsString$u20$as$u20$core..ops..index..Index$LT$core..ops..range..RangeFull$GT$$GT$5index17h1c5371bcc1602adfE"(%"std::ffi::OsString"* align 8 dereferenceable(24) %self, %"std::panic::Location"* align 8 dereferenceable(24) %0) unnamed_addr #0 !dbg !5 {
start:
...
; call std::sys::sbf::os_str::Buf::as_slice
  %1 = call { %"std::sys::sbf::os_str::Slice"*, i64 } @_ZN3std3sys3sbf6os_str3Buf8as_slice17h2299a3a2537c3360E(%"std::sys::sbf::os_str::Buf"* align 8 dereferenceable(24) %_5), !dbg !85
...
; call std::ffi::os_str::OsStr::from_inner
  %2 = call { %"std::ffi::OsStr"*, i64 } @_ZN3std3ffi6os_str5OsStr10from_inner17hd90ae3f3f63e951bE(%"std::sys::sbf::os_str::Slice"* nonnull align 1 %_4.0, i64 %_4.1), !dbg !86
...
; Function Attrs: inlinehint nounwind
define internal { %"std::ffi::OsStr"*, i64 } @_ZN3std3ffi6os_str5OsStr10from_inner17hd90ae3f3f63e951bE(%"std::sys::sbf::os_str::Slice"* nonnull align 1 %inner.0, i64 %inner.1) unnamed_addr #0 !dbg !88 {
start:
...
; Function Attrs: inlinehint nounwind
define internal { %"std::sys::sbf::os_str::Slice"*, i64 } @_ZN3std3sys3sbf6os_str3Buf8as_slice17h2299a3a2537c3360E(%"std::sys::sbf::os_str::Buf"* align 8 dereferenceable(24) %self) unnamed_addr #0 !dbg !97 {
start:
...
; call <alloc::vec::Vec<T,A> as core::ops::deref::Deref>::deref
  %1 = call { [0 x i8]*, i64 } @"_ZN72_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..deref..Deref$GT$5deref17h9df7ebd62c557c87E"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %_4), !dbg !106
...
define { %"std::path::Path"*, i64 } @_ZN3std4path4Path3new17h0ade4a1b1dd03d2eE(%"std::ffi::OsString"* align 8 dereferenceable(24) %s) unnamed_addr #1 !dbg !109 {
start:
...
; call <std::ffi::os_str::OsString as core::convert::AsRef<std::ffi::os_str::OsStr>>::as_ref
  %0 = call { %"std::ffi::OsStr"*, i64 } @"_ZN98_$LT$std..ffi..os_str..OsString$u20$as$u20$core..convert..AsRef$LT$std..ffi..os_str..OsStr$GT$$GT$6as_ref17h9b1da461846fe2c9E"(%"std::ffi::OsString"* align 8 dereferenceable(24) %s), !dbg !123
...
; Function Attrs: inlinehint nounwind
define internal { i8*, i64 } @_ZN3std4path4Path7display17h4cc1afef3e12470cE(%"std::path::Path"* nonnull align 1 %self.0, i64 %self.1) unnamed_addr #0 !dbg !126 {
start:
...
; Function Attrs: inlinehint nounwind
define i8* @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$6as_ptr17he9b3a20e0f95069aE"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %self) unnamed_addr #0 !dbg !233 {
start:
...
; call alloc::raw_vec::RawVec<T,A>::ptr
  %ptr = call i8* @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$3ptr17h4edb68d66ee576aeE"({ i8*, i64 }* align 8 dereferenceable(16) %_3), !dbg !243
...
; Function Attrs: inlinehint nounwind
define i8* @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$3ptr17h4edb68d66ee576aeE"({ i8*, i64 }* align 8 dereferenceable(16) %self) unnamed_addr #0 !dbg !249 {
start:
...
; Function Attrs: inlinehint nounwind
define internal { %"std::path::Path"*, i64 } @"_ZN62_$LT$std..path..PathBuf$u20$as$u20$core..ops..deref..Deref$GT$5deref17hbf3689741b486a24E"(%"std::path::PathBuf"* align 8 dereferenceable(24) %self) unnamed_addr #0 !dbg !259 {
start:
...
; call std::path::Path::new
  %0 = call { %"std::path::Path"*, i64 } @_ZN3std4path4Path3new17h0ade4a1b1dd03d2eE(%"std::ffi::OsString"* align 8 dereferenceable(24) %_3), !dbg !271
...
; Function Attrs: inlinehint nounwind
define internal { %"std::ffi::OsStr"*, i64 } @"_ZN70_$LT$std..ffi..os_str..OsString$u20$as$u20$core..ops..deref..Deref$GT$5deref17hc0c76cab2586732eE"(%"std::ffi::OsString"* align 8 dereferenceable(24) %self) unnamed_addr #0 !dbg !273 {
start:
  %self.dbg.spill = alloca %"std::ffi::OsString"*, align 8
  store %"std::ffi::OsString"* %self, %"std::ffi::OsString"** %self.dbg.spill, align 8
...
; Function Attrs: nounwind
define { [0 x i8]*, i64 } @"_ZN72_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..deref..Deref$GT$5deref17h9df7ebd62c557c87E"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %self) unnamed_addr #1 !dbg !282 {
start:
  %self.dbg.spill = alloca %"std::vec::Vec<u8>"*, align 8
  store %"std::vec::Vec<u8>"* %self, %"std::vec::Vec<u8>"** %self.dbg.spill, align 8
...
; call alloc::vec::Vec<T,A>::as_ptr
  %_2 = call i8* @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$6as_ptr17he9b3a20e0f95069aE"(%"std::vec::Vec<u8>"* align 8 dereferenceable(24) %self), !dbg !289
...
; Function Attrs: inlinehint nounwind
define internal { %"std::ffi::OsStr"*, i64 } @"_ZN98_$LT$std..ffi..os_str..OsString$u20$as$u20$core..convert..AsRef$LT$std..ffi..os_str..OsStr$GT$$GT$6as_ref17h9b1da461846fe2c9E"(%"std::ffi::OsString"* align 8 dereferenceable(24) %self) unnamed_addr #0 !dbg !293 {
start:
  %self.dbg.spill = alloca %"std::ffi::OsString"*, align 8
  store %"std::ffi::OsString"* %self, %"std::ffi::OsString"** %self.dbg.spill, align 8
...
; call <std::ffi::os_str::OsString as core::ops::deref::Deref>::deref
  %0 = call { %"std::ffi::OsStr"*, i64 } @"_ZN70_$LT$std..ffi..os_str..OsString$u20$as$u20$core..ops..deref..Deref$GT$5deref17hc0c76cab2586732eE"(%"std::ffi::OsString"* align 8 dereferenceable(24) %self), !dbg !298
...
; Function Attrs: nounwind
define { i8*, i64 } @"_ZN69_$LT$std..path..Path$u20$as$u20$thiserror..display..PathAsDisplay$GT$10as_display17h305a71233bdbdf87E"(%"std::path::Path"* nonnull align 1 %self.0, i64 %self.1) unnamed_addr #1 !dbg !300 {
start:
  %self.dbg.spill = alloca { %"std::path::Path"*, i64 }, align 8
...
; call std::path::Path::display
  %2 = call { i8*, i64 } @_ZN3std4path4Path7display17h4cc1afef3e12470cE(%"std::path::Path"* nonnull align 1 %self.0, i64 %self.1), !dbg !308
...
; Function Attrs: nounwind
define { i8*, i64 } @"_ZN72_$LT$std..path..PathBuf$u20$as$u20$thiserror..display..PathAsDisplay$GT$10as_display17h921771998611579dE"(%"std::path::PathBuf"* align 8 dereferenceable(24) %self) unnamed_addr #1 !dbg !310 {
start:
  %self.dbg.spill = alloca %"std::path::PathBuf"*, align 8
  store %"std::path::PathBuf"* %self, %"std::path::PathBuf"** %self.dbg.spill, align 8
...
; call <std::path::PathBuf as core::ops::deref::Deref>::deref
  %0 = call { %"std::path::Path"*, i64 } @"_ZN62_$LT$std..path..PathBuf$u20$as$u20$core..ops..deref..Deref$GT$5deref17hbf3689741b486a24E"(%"std::path::PathBuf"* align 8 dereferenceable(24) %self), !dbg !317
...
bb1:                                              ; preds = %start
; call std::path::Path::display
  %1 = call { i8*, i64 } @_ZN3std4path4Path7display17h4cc1afef3e12470cE(%"std::path::Path"* nonnull align 1 %_3.0, i64 %_3.1), !dbg !317
...
!3 = !DIFile(filename: "/root/.cargo/registry/src/github.com-1ecc6299db9ec823/thiserror-1.0.30/src/lib.rs", directory: "/root/.cargo/registry/src/github.com-1ecc6299db9ec823/thiserror-1.0.30")
!4 = !{}
...
!14 = !DICompositeType(tag: DW_TAG_structure_type, name: "OsStr", scope: !8, file: !15, align: 8, elements: !16, templateParams: !4, identifier: "da7a1516645672788c0972cd67820093")
!15 = !DIFile(filename: "<unknown>", directory: "")
!16 = !{!17}
!17 = !DIDerivedType(tag: DW_TAG_member, name: "inner", scope: !14, file: !15, baseType: !18, align: 8)
!18 = !DICompositeType(tag: DW_TAG_structure_type, name: "Slice", scope: !19, file: !15, align: 8, elements: !22, templateParams: !4, identifier: "2b97089b15c73047b3a43fd766f10e7c")
...
!29 = !DICompositeType(tag: DW_TAG_structure_type, name: "OsString", scope: !8, file: !15, size: 192, align: 64, elements: !30, templateParams: !4, identifier: "73cff18dcc3c9288d780a600b7a5f56a")
!30 = !{!31}
!31 = !DIDerivedType(tag: DW_TAG_member, name: "inner", scope: !29, file: !15, baseType: !32, size: 192, align: 64)
!32 = !DICompositeType(tag: DW_TAG_structure_type, name: "Buf", scope: !19, file: !15, size: 192, align: 64, elements: !33, templateParams: !4, identifier: "1bda841c6a2adb33919898a4e58d124d")
!33 = !{!34}
!34 = !DIDerivedType(tag: DW_TAG_member, name: "inner", scope: !32, file: !15, baseType: !35, size: 192, align: 64)
!35 = !DICompositeType(tag: DW_TAG_structure_type, name: "Vec<u8, alloc::alloc::Global>", scope: !36, file: !15, size: 192, align: 64, elements: !38, templateParams: !61, identifier: "ca400f85b78e93ba5bca8a9ad1767585")
...
!40 = !DICompositeType(tag: DW_TAG_structure_type, name: "RawVec<u8, alloc::alloc::Global>", scope: !41, file: !15, size: 128, align: 64, elements: !42, templateParams: !61, identifier: "991210d0a52bfaad42f8b613238cdb8")
...
!59 = !DICompositeType(tag: DW_TAG_structure_type, name: "Global", scope: !60, file: !15, align: 8, elements: !4, templateParams: !4, identifier: "82a28e8ea0dcac18287e7b3f6b37e370")
...
!88 = distinct !DISubprogram(name: "from_inner", linkageName: "_ZN3std3ffi6os_str5OsStr10from_inner17hd90ae3f3f63e951bE", scope: !14, file: !6, line: 551, type: !89, scopeLine: 551, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !4, retainedNodes: !92)
...
!97 = distinct !DISubprogram(name: "as_slice", linkageName: "_ZN3std3sys3sbf6os_str3Buf8as_slice17h2299a3a2537c3360E", scope: !32, file: !98, line: 131, type: !99, scopeLine: 131, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !4, retainedNodes: !102)
...
!109 = distinct !DISubprogram(name: "new<std::ffi::os_str::OsString>", linkageName: "_ZN3std4path4Path3new17h0ade4a1b1dd03d2eE", scope: !111, file: !110, line: 1867, type: !115, scopeLine: 1867, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !120, retainedNodes: !118)
...
!111 = !DICompositeType(tag: DW_TAG_structure_type, name: "Path", scope: !112, file: !15, align: 8, elements: !113, templateParams: !4, identifier: "938ed20b755455056372cf3ac4df8d42")
...
!126 = distinct !DISubprogram(name: "display", linkageName: "_ZN3std4path4Path7display17h4cc1afef3e12470cE", scope: !111, file: !110, line: 2471, type: !127, scopeLine: 2471, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !4, retainedNodes: !132)
!127 = !DISubroutineType(types: !128)
!128 = !{!129, !117}
!129 = !DICompositeType(tag: DW_TAG_structure_type, name: "Display", scope: !112, file: !15, size: 128, align: 64, elements: !130, templateParams: !4, identifier: "501523be440ef2d5d98132c11ff49852")
!130 = !{!131}
...
!233 = distinct !DISubprogram(name: "as_ptr<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc3vec16Vec$LT$T$C$A$GT$6as_ptr17he9b3a20e0f95069aE", scope: !35, file: !234, line: 1129, type: !235, scopeLine: 1129, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !61, retainedNodes: !238)
...
!249 = distinct !DISubprogram(name: "ptr<u8, alloc::alloc::Global>", linkageName: "_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$3ptr17h4edb68d66ee576aeE", scope: !40, file: !250, line: 239, type: !251, scopeLine: 239, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !61, retainedNodes: !254)
...
!259 = distinct !DISubprogram(name: "deref", linkageName: "_ZN62_$LT$std..path..PathBuf$u20$as$u20$core..ops..deref..Deref$GT$5deref17hbf3689741b486a24E", scope: !260, file: !110, line: 1616, type: !261, scopeLine: 1616, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !4, retainedNodes: !267)
...
!264 = !DICompositeType(tag: DW_TAG_structure_type, name: "PathBuf", scope: !112, file: !15, size: 192, align: 64, elements: !265, templateParams: !4, identifier: "8ab38e1582f88ee6ca6fd4ff3d28560b")
!265 = !{!266}
...
!273 = distinct !DISubprogram(name: "deref", linkageName: "_ZN70_$LT$std..ffi..os_str..OsString$u20$as$u20$core..ops..deref..Deref$GT$5deref17hc0c76cab2586732eE", scope: !274, file: !6, line: 401, type: !275, scopeLine: 401, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !4, retainedNodes: !277)
...
!293 = distinct !DISubprogram(name: "as_ref", linkageName: "_ZN98_$LT$std..ffi..os_str..OsString$u20$as$u20$core..convert..AsRef$LT$std..ffi..os_str..OsStr$GT$$GT$6as_ref17h9b1da461846fe2c9E", scope: !294, file: !6, line: 1151, type: !275, scopeLine: 1151, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, templateParams: !4, retainedNodes: !295)
...
!300 = distinct !DISubprogram(name: "as_display", linkageName: "_ZN69_$LT$std..path..Path$u20$as$u20$thiserror..display..PathAsDisplay$GT$10as_display17h305a71233bdbdf87E", scope: !302, file: !301, line: 19, type: !127, scopeLine: 19, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, templateParams: !4, retainedNodes: !305)
!301 = !DIFile(filename: "/root/.cargo/registry/src/github.com-1ecc6299db9ec823/thiserror-1.0.30/src/display.rs", directory: "/root/.cargo/registry/src/github.com-1ecc6299db9ec823/thiserror-1.0.30", checksumkind: CSK_MD5, checksum: "adc085f99662fa50187113a5cb19ab0c")
...
!310 = distinct !DISubprogram(name: "as_display", linkageName: "_ZN72_$LT$std..path..PathBuf$u20$as$u20$thiserror..display..PathAsDisplay$GT$10as_display17h921771998611579dE", scope: !311, file: !301, line: 25, type: !312, scopeLine: 25, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, templateParams: !4, retainedNodes: !314)
